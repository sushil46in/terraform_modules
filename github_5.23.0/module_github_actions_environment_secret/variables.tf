...
/*variable "actions_environment_secret_encrypted_value" {
  description = "(Optional)" #Encrypted value of the secret using the GitHub public key in Base64 format.
  type = string
}*/

variable "actions_environment_secret_environment" {
  description = "(Required)" #Name of the environment.
  type = string
}

/*variable "actions_environment_secret_plaintext_value" {
  description = "(Optional)" #Plaintext value of the secret to be encrypted.
  type = string
}*/

variable "actions_environment_secret_repository" {
  description = "(Required)" #Name of the repository.
  type = string
}

variable "actions_environment_secret_secret_name" {
