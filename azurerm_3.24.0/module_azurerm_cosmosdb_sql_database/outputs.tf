...
output "cosmosdb_sql_database_autoscale_settings_max_throughput" {
  value = azurerm_cosmosdb_sql_database.resname.max_throughput
}

output "cosmosdb_sql_database_autoscale_settings" {
  value = azurerm_cosmosdb_sql_database.resname.autoscale_settings
}
