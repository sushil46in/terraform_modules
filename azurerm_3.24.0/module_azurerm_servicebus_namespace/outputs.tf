...
output "servicebus_namespace_customer_managed_key_identity_id" {
  value = azurerm_servicebus_namespace.resname.customer_managed_key_identity_id
}

output "servicebus_namespace_customer_managed_key_key_vault_key_id" {
  value = azurerm_servicebus_namespace.resname.customer_managed_key_key_vault_key_id
}

output "servicebus_namespace_identity_principal_id" {
  value = azurerm_servicebus_namespace.resname.identity_principal_id
}

output "servicebus_namespace_identity_tenant_id" {
  value = azurerm_servicebus_namespace.resname.identity_tenant_id
}

output "servicebus_namespace_identity_type" {
  value = azurerm_servicebus_namespace.resname.identity_type
}
