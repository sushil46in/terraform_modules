...
output "sql_failover_group_partner_servers_id" {
  value = azurerm_sql_failover_group.resname.partner_servers_id
}

output "sql_failover_group_partner_servers_location" {
  value = azurerm_sql_failover_group.resname.partner_servers_location
}

output "sql_failover_group_partner_servers_role" {
  value = azurerm_sql_failover_group.resname.partner_servers_role
}

output "sql_failover_group_read_write_endpoint_failover_policy_mode" {
  value = azurerm_sql_failover_group.resname.read_write_endpoint_failover_policy_mode
}

output "sql_failover_group_readonly_endpoint_failover_policy_mode" {
  value = azurerm_sql_failover_group.resname.readonly_endpoint_failover_policy_mode
}
