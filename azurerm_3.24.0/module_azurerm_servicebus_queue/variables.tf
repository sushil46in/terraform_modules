...
/*variable "servicebus_queue_enable_batched_operations" {
  description = "(Optional) 'The value for enable_batched_operations'"
  type = bool
}*/

/*variable "servicebus_queue_enable_express" {
  description = "(Optional) 'The value for enable_express'"
  type = bool
}*/

/*variable "servicebus_queue_enable_partitioning" {
  description = "(Optional) 'The value for enable_partitioning'"
  type = bool
}*/
...
/*variable "servicebus_queue_max_delivery_count" {
  description = "(Optional) 'The value for max_delivery_count'"
  type = number
}*/
...
variable "servicebus_queue_namespace_id" {
  description = "(Required) 'The value for namespace_id'"
  type = string
}

/*variable "servicebus_queue_requires_duplicate_detection" {
  description = "(Optional) 'The value for requires_duplicate_detection'"
  type = bool
}*/
...
/*variable "servicebus_queue_timeouts_create" {
  description = "(Optional) 'The value for timeouts_create'"
  type = string
}*/

/*variable "servicebus_queue_timeouts_delete" {
  description = "(Optional) 'The value for timeouts_delete'"
  type = string
}*/

/*variable "servicebus_queue_timeouts_read" {
  description = "(Optional) 'The value for timeouts_read'"
  type = string
}*/

/*variable "servicebus_queue_timeouts_update" {
