...
/*variable "windows_function_app_slot_application_stack_use_custom_runtime" {
  description = "(Optional)" #Does the Function App use a custom Application Stack?
  type = bool
}*/

/*variable "windows_function_app_slot_application_stack_use_dotnet_isolated_runtime" {
