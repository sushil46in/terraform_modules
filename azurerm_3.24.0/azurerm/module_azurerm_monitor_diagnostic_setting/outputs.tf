...
output "monitor_diagnostic_setting_retention_policy_enabled" {
  value = azurerm_monitor_diagnostic_setting.resname.retention_policy_enabled
}

output "monitor_diagnostic_setting_metric_category" {
  value = azurerm_monitor_diagnostic_setting.resname.metric_category
}
