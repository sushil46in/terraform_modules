...
resource "azurerm_virtual_machine" "resname" {
  ...
  additional_capabilities {
    ultra_ssd_enabled = var.virtual_machine_additional_capabilities_ultra_ssd_enabled
  }
  ...
  identity {
    #identity_ids = var.virtual_machine_identity_identity_ids
