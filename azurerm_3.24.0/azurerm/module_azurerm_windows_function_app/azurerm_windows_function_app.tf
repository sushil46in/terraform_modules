...
resource "azurerm_windows_function_app" "resname" {
  ...
  site_config {
    ...
    application_stack {
      ...
      #use_custom_runtime = var.windows_function_app_application_stack_use_custom_runtime
      #use_dotnet_isolated_runtime = var.windows_function_app_application_stack_use_dotnet_isolated_runtime
    cors {
