...
/*variable "mysql_server_threat_detection_policy_disabled_alerts" {
  description = "(Optional) The value for threat_detection_policy_disabled_alerts"
  type = set
}*/

/*variable "mysql_server_threat_detection_policy_email_account_admins" {
  description = "(Optional) The value for threat_detection_policy_email_account_admins"
  type = bool
}*/

/*variable "mysql_server_threat_detection_policy_email_addresses" {
  description = "(Optional) The value for threat_detection_policy_email_addresses"
  type = set
}*/

/*variable "mysql_server_threat_detection_policy_enabled" {
  description = "(Optional) The value for threat_detection_policy_enabled"
  type = bool
}*/

/*variable "mysql_server_threat_detection_policy_retention_days" {
  description = "(Optional) The value for threat_detection_policy_retention_days"
  type = number
}*/

/*variable "mysql_server_threat_detection_policy_storage_account_access_key" {
  description = "(Optional) The value for threat_detection_policy_storage_account_access_key"
  type = string
}*/

/*variable "mysql_server_threat_detection_policy_storage_endpoint" {
  description = "(Optional) The value for threat_detection_policy_storage_endpoint"
  type = string
}*/

/*variable "mysql_server_timeouts_create" {
  description = "(Optional) The value for timeouts_create"
  type = string
}*/

/*variable "mysql_server_timeouts_delete" {
  description = "(Optional) The value for timeouts_delete"
  type = string
}*/

/*variable "mysql_server_timeouts_read" {
  description = "(Optional) The value for timeouts_read"
  type = string
}*/

/*variable "mysql_server_timeouts_update" {
