...
output "purview_account_identity_principal_id" {
  value = azurerm_purview_account.resname.identity_principal_id
}

output "purview_account_identity_tenant_id" {
  value = azurerm_purview_account.resname.identity_tenant_id
}

output "purview_account_identity_type" {
  value = azurerm_purview_account.resname.identity_type
}
