...
variable "app_service_app_service_plan_id" {
...
/*variable "app_service_client_cert_enabled" {
  description = "(Optional)" #The value for client_cert_enabled
  type = bool
}*/
...
/*variable "app_service_auth_settings_additional_login_params" {
  description = "(Optional)" #The value for auth_settings_additional_login_params
  type = map
}*/

/*variable "app_service_auth_settings_allowed_external_redirect_urls" {
  description = "(Optional)" #The value for auth_settings_allowed_external_redirect_urls
  type = list
}*/

/*variable "app_service_auth_settings_default_provider" {
  description = "(Optional)" #The value for auth_settings_default_provider
  type = string
}*/

variable "app_service_auth_settings_enabled" {
  description = "(Required)" #The value for auth_settings_enabled
  type = bool
}

/*variable "app_service_auth_settings_issuer" {
  description = "(Optional)" #The value for auth_settings_issuer
  type = string
}*/

/*variable "app_service_auth_settings_runtime_version" {
  description = "(Optional)" #The value for auth_settings_runtime_version
  type = string
}*/

/*variable "app_service_auth_settings_token_refresh_extension_hours" {
  description = "(Optional)" #The value for auth_settings_token_refresh_extension_hours
  type = number
}*/

/*variable "app_service_auth_settings_token_store_enabled" {
  description = "(Optional)" #The value for auth_settings_token_store_enabled
  type = bool
}*/

/*variable "app_service_auth_settings_unauthenticated_client_action" {
  description = "(Optional)" #The value for auth_settings_unauthenticated_client_action
  type = string
}*/

/*variable "app_service_active_directory_allowed_audiences" {
  description = "(Optional)" #The value for active_directory_allowed_audiences
  type = list
}*/

variable "app_service_active_directory_client_id" {
  description = "(Required)" #The value for active_directory_client_id
  type = string
}

/*variable "app_service_active_directory_client_secret" {
  description = "(Optional)" #The value for active_directory_client_secret
  type = string
}*/

variable "app_service_facebook_app_id" {
  description = "(Required)" #The value for facebook_app_id
  type = string
}

variable "app_service_facebook_app_secret" {
  description = "(Required)" #The value for facebook_app_secret
  type = string
}

/*variable "app_service_facebook_oauth_scopes" {
  description = "(Optional)" #The value for facebook_oauth_scopes
  type = list
}*/

variable "app_service_google_client_id" {
  description = "(Required)" #The value for google_client_id
  type = string
}

variable "app_service_google_client_secret" {
  description = "(Required)" #The value for google_client_secret
  type = string
}

/*variable "app_service_google_oauth_scopes" {
  description = "(Optional)" #The value for google_oauth_scopes
  type = list
}*/

variable "app_service_microsoft_client_id" {
  description = "(Required)" #The value for microsoft_client_id
  type = string
}

variable "app_service_microsoft_client_secret" {
  description = "(Required)" #The value for microsoft_client_secret
  type = string
}

/*variable "app_service_microsoft_oauth_scopes" {
  description = "(Optional)" #The value for microsoft_oauth_scopes
  type = list
}*/

variable "app_service_twitter_consumer_key" {
  description = "(Required)" #The value for twitter_consumer_key
  type = string
}

variable "app_service_twitter_consumer_secret" {
  description = "(Required)" #The value for twitter_consumer_secret
  type = string
}

/*variable "app_service_backup_enabled" {
  description = "(Optional)" #The value for backup_enabled
  type = bool
}*/

variable "app_service_backup_name" {
  description = "(Required)" #The value for backup_name
  type = string
}

variable "app_service_backup_storage_account_url" {
  description = "(Required)" #The value for backup_storage_account_url
  type = string
}

variable "app_service_schedule_frequency_interval" {
  description = "(Required)" #The value for schedule_frequency_interval
  type = number
}

variable "app_service_schedule_frequency_unit" {
  description = "(Required)" #The value for schedule_frequency_unit
  type = string
}

/*variable "app_service_schedule_keep_at_least_one_backup" {
  description = "(Optional)" #The value for schedule_keep_at_least_one_backup
  type = bool
}*/

/*variable "app_service_schedule_retention_period_in_days" {
  description = "(Optional)" #The value for schedule_retention_period_in_days
  type = number
}*/

/*variable "app_service_schedule_start_time" {
...
/*variable "app_service_identity_identity_ids" {
...
/*variable "app_service_logs_detailed_error_messages_enabled" {
  description = "(Optional)" #The value for logs_detailed_error_messages_enabled
  type = bool
}*/

/*variable "app_service_logs_failed_request_tracing_enabled" {
...
variable "app_service_azure_blob_storage_level" {
  description = "(Required)" #The value for azure_blob_storage_level
  type = string
}

variable "app_service_azure_blob_storage_retention_in_days" {
  description = "(Required)" #The value for azure_blob_storage_retention_in_days
  type = number
}

variable "app_service_azure_blob_storage_sas_url" {
...
variable "app_service_file_system_retention_in_days" {
  description = "(Required)" #The value for file_system_retention_in_days
  type = number
}

variable "app_service_file_system_retention_in_mb" {
  description = "(Required)" #The value for file_system_retention_in_mb
  type = number
}

/*variable "app_service_site_config_acr_use_managed_identity_credentials" {
  description = "(Optional)" #The value for site_config_acr_use_managed_identity_credentials
  type = bool
}*/

/*variable "app_service_site_config_acr_user_managed_identity_client_id" {
...
/*variable "app_service_site_config_app_command_line" {
  description = "(Optional)" #The value for site_config_app_command_line
  type = string
}*/

/*variable "app_service_site_config_auto_swap_slot_name" {
  description = "(Optional)" #The value for site_config_auto_swap_slot_name
  type = string
}*/

/*variable "app_service_site_config_default_documents" {
...
/*variable "app_service_site_config_health_check_path" {
...
/*variable "app_service_site_config_remote_debugging_enabled" {
  description = "(Optional)" #The value for site_config_remote_debugging_enabled
  type = bool
}*/

/*variable "app_service_site_config_scm_use_main_ip_restriction" {
...
variable "app_service_storage_account_access_key" {
  description = "(Required)" #The value for storage_account_access_key
  type = string
}

variable "app_service_storage_account_account_name" {
  description = "(Required)" #The value for storage_account_account_name
  type = string
}

/*variable "app_service_storage_account_mount_path" {
  description = "(Optional)" #The value for storage_account_mount_path
  type = string
}*/

variable "app_service_storage_account_name" {
  description = "(Required)" #The value for storage_account_name
  type = string
}

variable "app_service_storage_account_share_name" {
  description = "(Required)" #The value for storage_account_share_name
  type = string
}

variable "app_service_storage_account_type" {
  description = "(Required)" #The value for storage_account_type
  type = string
}

/*variable "app_service_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "app_service_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "app_service_timeouts_read" {
  description = "(Optional)" #The value for timeouts_read
  type = string
}*/

/*variable "app_service_timeouts_update" {
