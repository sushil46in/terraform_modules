...
/*variable "windows_web_app_slot_application_stack_current_stack" {
...
/*variable "windows_web_app_slot_application_stack_dotnet_version" {
...
/*variable "windows_web_app_slot_application_stack_php_version" {
  description = "(Optional) 'The value for application_stack_php_version'"
  type = string
}*/

/*variable "windows_web_app_slot_application_stack_python_version" {
