...
output "sql_server_identity_principal_id" {
  value = azurerm_sql_server.resname.identity_principal_id
}

output "sql_server_identity_tenant_id" {
  value = azurerm_sql_server.resname.identity_tenant_id
}

output "sql_server_identity_type" {
  value = azurerm_sql_server.resname.identity_type
}

output "sql_server_threat_detection_policy_email_account_admins" {
  value = azurerm_sql_server.resname.threat_detection_policy_email_account_admins
}

output "sql_server_threat_detection_policy_email_addresses" {
  value = azurerm_sql_server.resname.threat_detection_policy_email_addresses
}
