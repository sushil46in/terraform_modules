...
variable "stream_analytics_stream_input_blob_name" {
...
variable "stream_analytics_stream_input_blob_resource_group_name" {
...
variable "stream_analytics_stream_input_blob_stream_analytics_job_name" {
...
/*variable "stream_analytics_stream_input_blob_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "stream_analytics_stream_input_blob_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "stream_analytics_stream_input_blob_timeouts_read" {
  description = "(Optional)" #The value for timeouts_read
  type = string
}*/

/*variable "stream_analytics_stream_input_blob_timeouts_update" {
