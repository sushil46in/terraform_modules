...
/*variable "storage_account_customer_managed_key_user_assigned_identity_id" {
  description = "(Optional)" #The value for user_assigned_identity_id
  type = string
}*/

/*variable "storage_account_customer_managed_key_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "storage_account_customer_managed_key_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "storage_account_customer_managed_key_timeouts_read" {
  description = "(Optional)" #The value for timeouts_read
  type = string
}*/

/*variable "storage_account_customer_managed_key_timeouts_update" {
