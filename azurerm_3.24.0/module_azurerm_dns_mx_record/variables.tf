...
variable "dns_mx_record_record_exchange" {
  description = "(Required) 'The value for record_exchange'"
  type = string
}

variable "dns_mx_record_record_preference" {
  description = "(Required) 'The value for record_preference'"
  type = string
}

/*variable "dns_mx_record_timeouts_create" {
  description = "(Optional) 'The value for timeouts_create'"
  type = string
}*/

/*variable "dns_mx_record_timeouts_delete" {
  description = "(Optional) 'The value for timeouts_delete'"
  type = string
}*/

/*variable "dns_mx_record_timeouts_read" {
  description = "(Optional) 'The value for timeouts_read'"
  type = string
}*/

/*variable "dns_mx_record_timeouts_update" {
