...
variable "private_dns_cname_record_record" {
  description = "(Required)" #The value for record
  type = string
}
...
/*variable "private_dns_cname_record_tags" {
...
/*variable "private_dns_cname_record_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "private_dns_cname_record_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "private_dns_cname_record_timeouts_read" {
  description = "(Optional)" #The value for timeouts_read
  type = string
}*/

/*variable "private_dns_cname_record_timeouts_update" {
