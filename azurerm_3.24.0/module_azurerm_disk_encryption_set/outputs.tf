...
output "disk_encryption_set_identity_principal_id" {
  value = azurerm_disk_encryption_set.resname.identity_principal_id
}

output "disk_encryption_set_identity_tenant_id" {
  value = azurerm_disk_encryption_set.resname.identity_tenant_id
}

output "disk_encryption_set_identity_type" {
  value = azurerm_disk_encryption_set.resname.identity_type
}
