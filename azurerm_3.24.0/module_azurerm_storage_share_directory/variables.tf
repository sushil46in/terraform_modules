...
variable "storage_share_directory_share_name" {
  description = "(Required)" #The value for share_name
  type = string
}
...
/*variable "storage_share_directory_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "storage_share_directory_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "storage_share_directory_timeouts_read" {
  description = "(Optional)" #The value for timeouts_read
  type = string
}*/

/*variable "storage_share_directory_timeouts_update" {
