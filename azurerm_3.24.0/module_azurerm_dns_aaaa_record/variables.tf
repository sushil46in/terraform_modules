...
/*variable "dns_aaaa_record_tags" {
  description = "(Optional) 'The value for tags'"
  type = map
}*/

/*variable "dns_aaaa_record_target_resource_id" {
...
/*variable "dns_aaaa_record_timeouts_create" {
  description = "(Optional) 'The value for timeouts_create'"
  type = string
}*/

/*variable "dns_aaaa_record_timeouts_delete" {
  description = "(Optional) 'The value for timeouts_delete'"
  type = string
}*/

/*variable "dns_aaaa_record_timeouts_read" {
  description = "(Optional) 'The value for timeouts_read'"
  type = string
}*/

/*variable "dns_aaaa_record_timeouts_update" {
