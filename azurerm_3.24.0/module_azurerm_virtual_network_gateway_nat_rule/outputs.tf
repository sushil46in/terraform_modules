...
output "virtual_network_gateway_nat_rule_external_mapping_address_space" {
  value = azurerm_virtual_network_gateway_nat_rule.resname.external_mapping_address_space
}

output "virtual_network_gateway_nat_rule_internal_mapping_address_space" {
  value = azurerm_virtual_network_gateway_nat_rule.resname.internal_mapping_address_space
}
