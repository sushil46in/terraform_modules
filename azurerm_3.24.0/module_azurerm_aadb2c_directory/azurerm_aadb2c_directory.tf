...
resource "azurerm_aadb2c_directory" "resname" {
  ...
  timeouts {
    #create = var.aadb2c_directory_timeouts_create
    #delete = var.aadb2c_directory_timeouts_delete
    #read = var.aadb2c_directory_timeouts_read
    #update = var.aadb2c_directory_timeouts_update
  }
