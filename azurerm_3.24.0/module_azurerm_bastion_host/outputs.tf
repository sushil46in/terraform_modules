...
output "bastion_host_ip_configuration_name" {
  value = azurerm_bastion_host.resname.ip_configuration_name
}

output "bastion_host_ip_configuration_public_ip_address_id" {
  value = azurerm_bastion_host.resname.ip_configuration_public_ip_address_id
}

output "bastion_host_ip_configuration_subnet_id" {
  value = azurerm_bastion_host.resname.ip_configuration_subnet_id
}
