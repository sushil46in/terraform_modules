...
output "mssql_server_azuread_administrator_azuread_authentication_only" {
  value = azurerm_mssql_server.resname.azuread_administrator_azuread_authentication_only
}

output "mssql_server_azuread_administrator_login_username" {
  value = azurerm_mssql_server.resname.azuread_administrator_login_username
}

output "mssql_server_azuread_administrator_object_id" {
  value = azurerm_mssql_server.resname.azuread_administrator_object_id
}

output "mssql_server_azuread_administrator_tenant_id" {
  value = azurerm_mssql_server.resname.azuread_administrator_tenant_id
}

output "mssql_server_identity_principal_id" {
  value = azurerm_mssql_server.resname.identity_principal_id
}

output "mssql_server_identity_tenant_id" {
  value = azurerm_mssql_server.resname.identity_tenant_id
}

output "mssql_server_identity_type" {
  value = azurerm_mssql_server.resname.identity_type
}
