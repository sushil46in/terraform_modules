...
variable "key_vault_key_key_opts" {
  description = "(Required)" #The value for key_opts
  type = list
}
...
variable "key_vault_key_key_vault_id" {
...
/*variable "key_vault_key_not_before_date" {
  description = "(Optional)" #The value for not_before_date
  type = string
}*/
...
/*variable "key_vault_key_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "key_vault_key_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "key_vault_key_timeouts_read" {
  description = "(Optional)" #The value for timeouts_read
  type = string
}*/

/*variable "key_vault_key_timeouts_update" {
