...
output "virtual_network_ddos_protection_plan_enable" {
  value = azurerm_virtual_network.resname.ddos_protection_plan_enable
}

output "virtual_network_ddos_protection_plan_id" {
  value = azurerm_virtual_network.resname.ddos_protection_plan_id
}
