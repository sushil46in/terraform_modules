...
output "virtual_network_peering_allow_forwarded_traffic" {
  value = azurerm_virtual_network_peering.resname.allow_forwarded_traffic
}

output "virtual_network_peering_allow_gateway_transit" {
  value = azurerm_virtual_network_peering.resname.allow_gateway_transit
}
...
output "virtual_network_peering_use_remote_gateways" {
  value = azurerm_virtual_network_peering.resname.use_remote_gateways
}
