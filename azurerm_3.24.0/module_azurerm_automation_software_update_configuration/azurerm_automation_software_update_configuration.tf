...
resource "azurerm_automation_software_update_configuration" "resname" {
  ...
  schedule {
    ...
    #expiry_time = var.automation_software_update_configuration_schedule_expiry_time
  ...
  target {
    azure_query {
      ...
      #tag_filter = var.automation_software_update_configuration_azure_query_tag_filter
      tags {
  ...
  windows {
    #classification_included = var.automation_software_update_configuration_windows_classification_included
