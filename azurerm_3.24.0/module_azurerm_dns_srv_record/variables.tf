...
variable "dns_srv_record_record_port" {
  description = "(Required) 'The value for record_port'"
  type = number
}

variable "dns_srv_record_record_priority" {
  description = "(Required) 'The value for record_priority'"
  type = number
}

variable "dns_srv_record_record_target" {
  description = "(Required) 'The value for record_target'"
  type = string
}

variable "dns_srv_record_record_weight" {
  description = "(Required) 'The value for record_weight'"
  type = number
}

/*variable "dns_srv_record_timeouts_create" {
  description = "(Optional) 'The value for timeouts_create'"
  type = string
}*/

/*variable "dns_srv_record_timeouts_delete" {
  description = "(Optional) 'The value for timeouts_delete'"
  type = string
}*/

/*variable "dns_srv_record_timeouts_read" {
  description = "(Optional) 'The value for timeouts_read'"
  type = string
}*/

/*variable "dns_srv_record_timeouts_update" {
