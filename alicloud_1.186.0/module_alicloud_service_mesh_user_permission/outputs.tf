...
output "service_mesh_user_permission_permissions_is_custom" {
  value = alicloud_service_mesh_user_permission.resname.is_custom
}

output "service_mesh_user_permission_permissions_is_ram_role" {
  value = alicloud_service_mesh_user_permission.resname.is_ram_role
}

output "service_mesh_user_permission_permissions_role_name" {
  value = alicloud_service_mesh_user_permission.resname.role_name
}

output "service_mesh_user_permission_permissions_role_type" {
  value = alicloud_service_mesh_user_permission.resname.role_type
}

output "service_mesh_user_permission_permissions_service_mesh_id" {
  value = alicloud_service_mesh_user_permission.resname.service_mesh_id
}

output "service_mesh_user_permission_permissions" {
  value = alicloud_service_mesh_user_permission.resname.permissions
}
