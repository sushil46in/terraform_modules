...
output "pvtz_zone_attachment_vpcs_region_id" {
  value = alicloud_pvtz_zone_attachment.resname.vpcs_region_id
}

output "pvtz_zone_attachment_vpcs_vpc_id" {
  value = alicloud_pvtz_zone_attachment.resname.vpcs_vpc_id
}
