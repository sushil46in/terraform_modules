...
/*variable "slb_address_ip_version" {
  description = "(Optional)" #The value for address_ip_version
  type = string
}*/
...
/*variable "slb_modification_protection_reason" {
  description = "(Optional)" #The value for modification_protection_reason
  type = string
}*/
...
/*variable "slb_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "slb_timeouts_delete" {
