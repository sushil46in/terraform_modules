...
output "image_disk_device_mapping_device" {
  value = alicloud_image.resname.disk_device_mapping_device
}

output "image_disk_device_mapping_disk_type" {
  value = alicloud_image.resname.disk_device_mapping_disk_type
}

output "image_disk_device_mapping_size" {
  value = alicloud_image.resname.disk_device_mapping_size
}

output "image_disk_device_mapping_snapshot_id" {
  value = alicloud_image.resname.disk_device_mapping_snapshot_id
}
