...
output "cloud_sso_directory_saml_identity_provider_configuration_encoded_metadata_document" {
  value = alicloud_cloud_sso_directory.resname.saml_identity_provider_configuration_encoded_metadata_document
}

output "cloud_sso_directory_saml_identity_provider_configuration_sso_status" {
  value = alicloud_cloud_sso_directory.resname.saml_identity_provider_configuration_sso_status
}
