...
output "vpc_dhcp_options_set_associate_vpcs_associate_status" {
  value = alicloud_vpc_dhcp_options_set.resname.associate_status
}

output "vpc_dhcp_options_set_associate_vpcs" {
  value = alicloud_vpc_dhcp_options_set.resname.associate_vpcs
}
