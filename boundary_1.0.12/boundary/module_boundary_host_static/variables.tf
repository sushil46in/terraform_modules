...
/*variable "host_static_description" {
  description = "(Optional)" #The host description.
  type = string
}*/

variable "host_static_host_catalog_id" {
  description = "(Required)" #The value for host_catalog_id
  type = string
}

/*variable "host_static_name" {
  description = "(Optional)" #The host name. Defaults to the resource name.
  type = string
}*/

/*variable "host_static_type" {
  description = "(Optional)" #The type of host
  type = string
}*/
