...
output "prepared_query_template_regexp" {
  value = consul_prepared_query.resname.template_regexp
}

output "prepared_query_template_type" {
  value = consul_prepared_query.resname.template_type
}
