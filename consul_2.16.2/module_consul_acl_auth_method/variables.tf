...
variable "acl_auth_method_namespace_rule_bind_namespace" {
  description = "(Required)" #The value for namespace_rule_bind_namespace
  type = string
}

/*variable "acl_auth_method_namespace_rule_selector" {
  description = "(Optional)" #The value for namespace_rule_selector
  type = string
}*/
