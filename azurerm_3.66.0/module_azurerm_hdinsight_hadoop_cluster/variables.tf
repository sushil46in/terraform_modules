...
/*variable "hdinsight_hadoop_cluster_compute_isolation_compute_isolation_enabled" {
  description = "(Optional)" #The value for compute_isolation_compute_isolation_enabled
  type = bool
}*/

/*variable "hdinsight_hadoop_cluster_compute_isolation_host_sku" {
...
variable "hdinsight_hadoop_cluster_script_actions_name" {
  description = "(Required)" #The value for script_actions_name
  type = string
}

/*variable "hdinsight_hadoop_cluster_script_actions_parameters" {
  description = "(Optional)" #The value for script_actions_parameters
  type = string
}*/

variable "hdinsight_hadoop_cluster_script_actions_uri" {
