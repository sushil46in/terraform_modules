...
/*variable "storage_management_policy_base_blob_auto_tier_to_hot_from_cool_enabled" {
  description = "(Optional)" #The value for base_blob_auto_tier_to_hot_from_cool_enabled
  type = bool
}*/

/*variable "storage_management_policy_base_blob_delete_after_days_since_creation_greater_than" {
  description = "(Optional)" #The value for base_blob_delete_after_days_since_creation_greater_than
  type = number
}*/
...
/*variable "storage_management_policy_base_blob_tier_to_archive_after_days_since_creation_greater_than" {
  description = "(Optional)" #The value for base_blob_tier_to_archive_after_days_since_creation_greater_than
  type = number
}*/
...
/*variable "storage_management_policy_base_blob_tier_to_archive_after_days_since_last_tier_change_greater_than" {
  description = "(Optional)" #The value for base_blob_tier_to_archive_after_days_since_last_tier_change_greater_than
  type = number
}*/
...
/*variable "storage_management_policy_base_blob_tier_to_cool_after_days_since_creation_greater_than" {
  description = "(Optional)" #The value for base_blob_tier_to_cool_after_days_since_creation_greater_than
  type = number
}*/
...
/*variable "storage_management_policy_snapshot_tier_to_archive_after_days_since_last_tier_change_greater_than" {
  description = "(Optional)" #The value for snapshot_tier_to_archive_after_days_since_last_tier_change_greater_than
  type = number
}*/
...
/*variable "storage_management_policy_version_tier_to_archive_after_days_since_last_tier_change_greater_than" {
  description = "(Optional)" #The value for version_tier_to_archive_after_days_since_last_tier_change_greater_than
  type = number
}*/
