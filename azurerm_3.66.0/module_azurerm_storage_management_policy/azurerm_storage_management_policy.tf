...
resource "azurerm_storage_management_policy" "resname" {
  ...
  rule {
    ...
    actions {
      base_blob {
        #auto_tier_to_hot_from_cool_enabled = var.storage_management_policy_base_blob_auto_tier_to_hot_from_cool_enabled
        #delete_after_days_since_creation_greater_than = var.storage_management_policy_base_blob_delete_after_days_since_creation_greater_than
        ...
        #tier_to_archive_after_days_since_creation_greater_than = var.storage_management_policy_base_blob_tier_to_archive_after_days_since_creation_greater_than
        ...
        #tier_to_archive_after_days_since_last_tier_change_greater_than = var.storage_management_policy_base_blob_tier_to_archive_after_days_since_last_tier_change_greater_than
        ...
        #tier_to_cool_after_days_since_creation_greater_than = var.storage_management_policy_base_blob_tier_to_cool_after_days_since_creation_greater_than
      ...
      snapshot {
        ...
        #tier_to_archive_after_days_since_last_tier_change_greater_than = var.storage_management_policy_snapshot_tier_to_archive_after_days_since_last_tier_change_greater_than
      }
      version {
        ...
        #tier_to_archive_after_days_since_last_tier_change_greater_than = var.storage_management_policy_version_tier_to_archive_after_days_since_last_tier_change_greater_than
      }
    }
    filters {
