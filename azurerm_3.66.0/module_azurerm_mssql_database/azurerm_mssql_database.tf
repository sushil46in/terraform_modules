...
resource "azurerm_mssql_database" "resname" {
  ...
  import {
    administrator_login = var.mssql_database_import_administrator_login
    administrator_login_password = var.mssql_database_import_administrator_login_password
    authentication_type = var.mssql_database_import_authentication_type
    #storage_account_id = var.mssql_database_import_storage_account_id
    storage_key = var.mssql_database_import_storage_key
    storage_key_type = var.mssql_database_import_storage_key_type
    storage_uri = var.mssql_database_import_storage_uri
  }
