...
variable "linux_virtual_machine_scale_set_protected_settings_from_key_vault_secret_url" {
  description = "(Required)" #The value for protected_settings_from_key_vault_secret_url
  type = string
}

variable "linux_virtual_machine_scale_set_protected_settings_from_key_vault_source_vault_id" {
  description = "(Required)" #The value for protected_settings_from_key_vault_source_vault_id
  type = string
}

/*variable "linux_virtual_machine_scale_set_gallery_application_configuration_blob_uri" {
  description = "(Optional)" #The value for gallery_application_configuration_blob_uri
  type = string
}*/

/*variable "linux_virtual_machine_scale_set_gallery_application_order" {
  description = "(Optional)" #The value for gallery_application_order
  type = number
}*/

/*variable "linux_virtual_machine_scale_set_gallery_application_tag" {
  description = "(Optional)" #The value for gallery_application_tag
  type = string
}*/

variable "linux_virtual_machine_scale_set_gallery_application_version_id" {
