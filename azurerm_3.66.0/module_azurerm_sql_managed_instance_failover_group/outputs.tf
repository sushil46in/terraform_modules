...
output "sql_managed_instance_failover_group_read_write_endpoint_failover_policy" {
  value = azurerm_sql_managed_instance_failover_group.resname.read_write_endpoint_failover_policy
}
