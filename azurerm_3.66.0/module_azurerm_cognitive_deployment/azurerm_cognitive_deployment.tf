...
resource "azurerm_cognitive_deployment" "resname" {
  ...
  scale {
    #capacity = var.cognitive_deployment_scale_capacity
    #family = var.cognitive_deployment_scale_family
    #size = var.cognitive_deployment_scale_size
    #tier = var.cognitive_deployment_scale_tier
