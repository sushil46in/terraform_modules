...
resource "azurerm_postgresql_flexible_server" "resname" {
  ...
  customer_managed_key {
    #geo_backup_key_vault_key_id = var.postgresql_flexible_server_customer_managed_key_geo_backup_key_vault_key_id
    #geo_backup_user_assigned_identity_id = var.postgresql_flexible_server_customer_managed_key_geo_backup_user_assigned_identity_id
