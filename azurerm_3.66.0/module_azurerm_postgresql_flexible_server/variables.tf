...
/*variable "postgresql_flexible_server_replication_role" {
  description = "(Optional)" #The value for replication_role
  type = string
}*/
...
/*variable "postgresql_flexible_server_authentication_active_directory_auth_enabled" {
  description = "(Optional)" #The value for authentication_active_directory_auth_enabled
  type = bool
}*/

/*variable "postgresql_flexible_server_authentication_password_auth_enabled" {
  description = "(Optional)" #The value for authentication_password_auth_enabled
  type = bool
}*/

/*variable "postgresql_flexible_server_authentication_tenant_id" {
  description = "(Optional)" #The value for authentication_tenant_id
  type = string
}*/

/*variable "postgresql_flexible_server_customer_managed_key_geo_backup_key_vault_key_id" {
  description = "(Optional)" #The value for customer_managed_key_geo_backup_key_vault_key_id
  type = string
}*/

/*variable "postgresql_flexible_server_customer_managed_key_geo_backup_user_assigned_identity_id" {
  description = "(Optional)" #The value for customer_managed_key_geo_backup_user_assigned_identity_id
  type = string
}*/

/*variable "postgresql_flexible_server_customer_managed_key_key_vault_key_id" {
  description = "(Optional)" #The value for customer_managed_key_key_vault_key_id
  type = string
}*/

/*variable "postgresql_flexible_server_customer_managed_key_primary_user_assigned_identity_id" {
...
variable "postgresql_flexible_server_identity_identity_ids" {
  description = "(Required)" #The value for identity_identity_ids
  type = set
}

variable "postgresql_flexible_server_identity_type" {
