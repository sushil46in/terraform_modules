...
/*variable "sentinel_automation_rule_triggers_on" {
  description = "(Optional)" #The value for triggers_on
  type = string
}*/

/*variable "sentinel_automation_rule_triggers_when" {
  description = "(Optional)" #The value for triggers_when
  type = string
}*/
