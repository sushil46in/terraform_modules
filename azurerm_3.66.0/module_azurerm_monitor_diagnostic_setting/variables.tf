...
/*variable "monitor_diagnostic_setting_partner_solution_id" {
  description = "(Optional)" #The value for partner_solution_id
  type = string
}*/
...
/*variable "monitor_diagnostic_setting_enabled_log_category" {
  description = "(Optional)" #The value for enabled_log_category
  type = string
}*/

/*variable "monitor_diagnostic_setting_enabled_log_category_group" {
  description = "(Optional)" #The value for enabled_log_category_group
  type = string
}*/
