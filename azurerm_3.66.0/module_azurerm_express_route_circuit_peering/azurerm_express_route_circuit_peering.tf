...
resource "azurerm_express_route_circuit_peering" "resname" {
  ...
  ipv6 {
    ...
    microsoft_peering {
      #advertised_communities = var.express_route_circuit_peering_microsoft_peering_advertised_communities
  ...
  microsoft_peering_config {
    #advertised_communities = var.express_route_circuit_peering_microsoft_peering_config_advertised_communities
