...
/*variable "disk_encryption_set_federated_client_id" {
  description = "(Optional)" #The value for federated_client_id
  type = string
}*/
...
/*variable "disk_encryption_set_identity_identity_ids" {
