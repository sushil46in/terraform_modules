...
/*variable "stream_analytics_job_content_storage_policy" {
  description = "(Optional)" #The value for content_storage_policy
  type = string
}*/
...
variable "stream_analytics_job_job_storage_account_account_key" {
  description = "(Required)" #The value for job_storage_account_account_key
  type = string
}

variable "stream_analytics_job_job_storage_account_account_name" {
  description = "(Required)" #The value for job_storage_account_account_name
  type = string
}

/*variable "stream_analytics_job_job_storage_account_authentication_mode" {
  description = "(Optional)" #The value for job_storage_account_authentication_mode
  type = string
}*/
