...
resource "azurerm_backup_policy_vm" "resname" {
  ...
  instant_restore_resource_group {
    prefix = var.backup_policy_vm_instant_restore_resource_group_prefix
    #suffix = var.backup_policy_vm_instant_restore_resource_group_suffix
  }
  ...
  retention_monthly {
    ...
    #days = var.backup_policy_vm_retention_monthly_days
    #include_last_days = var.backup_policy_vm_retention_monthly_include_last_days
  ...
  retention_yearly {
    ...
    #days = var.backup_policy_vm_retention_yearly_days
    #include_last_days = var.backup_policy_vm_retention_yearly_include_last_days
