...
resource "azurerm_resource_group_policy_assignment" "resname" {
  ...
  overrides {
    value = var.resource_group_policy_assignment_overrides_value
    selectors {
      #in = var.resource_group_policy_assignment_selectors_in
      #not_in = var.resource_group_policy_assignment_selectors_not_in
    }
  }

  resource_selectors {
    #name = var.resource_group_policy_assignment_resource_selectors_name
    selectors {
      #in = var.resource_group_policy_assignment_selectors_in
      kind = var.resource_group_policy_assignment_selectors_kind
      #not_in = var.resource_group_policy_assignment_selectors_not_in
    }
  }
