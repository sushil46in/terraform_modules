...
variable "sentinel_alert_rule_scheduled_dynamic_property_name" {
  description = "(Required)" #The value for dynamic_property_name
  type = string
}

variable "sentinel_alert_rule_scheduled_dynamic_property_value" {
...
variable "sentinel_alert_rule_scheduled_sentinel_entity_mapping_column_name" {
