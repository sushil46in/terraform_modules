...
/*variable "linux_function_app_slot_client_certificate_exclusion_paths" {
...
/*variable "linux_function_app_slot_public_network_access_enabled" {
  description = "(Optional)" #The value for public_network_access_enabled
  type = bool
}*/

/*variable "linux_function_app_slot_service_plan_id" {
...
/*variable "linux_function_app_slot_auth_settings_v2_auth_enabled" {
  description = "(Optional)" #Should the AuthV2 Settings be enabled. Defaults to `false`
  type = bool
}*/

/*variable "linux_function_app_slot_auth_settings_v2_config_file_path" {
  description = "(Optional)" #The path to the App Auth settings. Note: Relative Paths are evaluated from the Site Root directory.
  type = string
}*/

/*variable "linux_function_app_slot_auth_settings_v2_default_provider" {
...
/*variable "linux_function_app_slot_auth_settings_v2_excluded_paths" {
...
/*variable "linux_function_app_slot_auth_settings_v2_forward_proxy_convention" {
...
/*variable "linux_function_app_slot_active_directory_v2_allowed_applications" {
  description = "(Optional)" #The list of allowed Applications for the Default Authorisation Policy.
  type = list
}*/

/*variable "linux_function_app_slot_active_directory_v2_allowed_audiences" {
  description = "(Optional)" #Specifies a list of Allowed audience values to consider when validating JWTs issued by Azure Active Directory.
  type = list
}*/

/*variable "linux_function_app_slot_active_directory_v2_allowed_groups" {
  description = "(Optional)" #The list of allowed Group Names for the Default Authorisation Policy.
  type = list
}*/

/*variable "linux_function_app_slot_active_directory_v2_allowed_identities" {
  description = "(Optional)" #The list of allowed Identities for the Default Authorisation Policy.
  type = list
}*/

variable "linux_function_app_slot_active_directory_v2_client_id" {
  description = "(Required)" #The ID of the Client to use to authenticate with Azure Active Directory.
  type = string
}

/*variable "linux_function_app_slot_active_directory_v2_client_secret_certificate_thumbprint" {
  description = "(Optional)" #The thumbprint of the certificate used for signing purposes.
  type = string
}*/

/*variable "linux_function_app_slot_active_directory_v2_client_secret_setting_name" {
  description = "(Optional)" #The App Setting name that contains the client secret of the Client.
  type = string
}*/

/*variable "linux_function_app_slot_active_directory_v2_jwt_allowed_client_applications" {
  description = "(Optional)" #A list of Allowed Client Applications in the JWT Claim.
  type = list
}*/

/*variable "linux_function_app_slot_active_directory_v2_jwt_allowed_groups" {
  description = "(Optional)" #A list of Allowed Groups in the JWT Claim.
  type = list
}*/

/*variable "linux_function_app_slot_active_directory_v2_login_parameters" {
  description = "(Optional)" #A map of key-value pairs to send to the Authorisation Endpoint when a user logs in.
  type = map
}*/

variable "linux_function_app_slot_active_directory_v2_tenant_auth_endpoint" {
...
variable "linux_function_app_slot_google_v2_client_id" {
  description = "(Required)" #The OpenID Connect Client ID for the Google web application.
  type = string
}

variable "linux_function_app_slot_google_v2_client_secret_setting_name" {
  description = "(Required)" #The app setting name that contains the `client_secret` value used for Google Login.
  type = string
}

/*variable "linux_function_app_slot_google_v2_login_scopes" {
  description = "(Optional)" #Specifies a list of Login scopes that will be requested as part of Google Sign-In authentication.
  type = list
}*/

/*variable "linux_function_app_slot_login_allowed_external_redirect_urls" {
...
/*variable "linux_function_app_slot_login_cookie_expiration_convention" {
...
variable "linux_function_app_slot_microsoft_v2_client_id" {
  description = "(Required)" #The OAuth 2.0 client ID that was created for the app used for authentication.
  type = string
}

variable "linux_function_app_slot_microsoft_v2_client_secret_setting_name" {
...
/*variable "linux_function_app_slot_microsoft_v2_login_scopes" {
  description = "(Optional)" #The list of Login scopes that will be requested as part of Microsoft Account authentication.
  type = list
}*/

variable "linux_function_app_slot_twitter_v2_consumer_key" {
  description = "(Required)" #The OAuth 1.0a consumer key of the Twitter application used for sign-in.
  type = string
}

variable "linux_function_app_slot_twitter_v2_consumer_secret_setting_name" {
...
/*variable "linux_function_app_slot_site_config_health_check_eviction_time_in_min" {
...
/*variable "linux_function_app_slot_application_stack_python_version" {
  description = "(Optional)" #The version of Python to use. Possible values include `3.11`, `3.10`, `3.9`, `3.8`, and `3.7`.
  type = string
}*/
...
/*variable "linux_function_app_slot_ip_restriction_action" {
  description = "(Optional)" #The action to take. Possible values are `Allow` or `Deny`.
  type = string
}*/

/*variable "linux_function_app_slot_ip_restriction_headers" {
  description = "(Optional)" #The value for ip_restriction_headers
  type = list
}*/

/*variable "linux_function_app_slot_ip_restriction_ip_address" {
...
/*variable "linux_function_app_slot_ip_restriction_priority" {
  description = "(Optional)" #The priority value of this `ip_restriction`.
  type = number
}*/

/*variable "linux_function_app_slot_ip_restriction_service_tag" {
  description = "(Optional)" #The Service Tag used for this IP Restriction.
  type = string
}*/

/*variable "linux_function_app_slot_ip_restriction_virtual_network_subnet_id" {
  description = "(Optional)" #The Virtual Network Subnet ID used for this IP Restriction.
  type = string
}*/

/*variable "linux_function_app_slot_scm_ip_restriction_action" {
  description = "(Optional)" #The action to take. Possible values are `Allow` or `Deny`.
  type = string
}*/

/*variable "linux_function_app_slot_scm_ip_restriction_headers" {
  description = "(Optional)" #The value for scm_ip_restriction_headers
  type = list
}*/

/*variable "linux_function_app_slot_scm_ip_restriction_ip_address" {
  description = "(Optional)" #The CIDR notation of the IP or IP Range to match. For example: `10.0.0.0/24` or `192.168.10.1/32` or `fe80::/64` or `13.107.6.152/31,13.107.128.0/22`
  type = string
}*/

/*variable "linux_function_app_slot_scm_ip_restriction_priority" {
  description = "(Optional)" #The priority value of this `ip_restriction`.
  type = number
}*/

/*variable "linux_function_app_slot_scm_ip_restriction_service_tag" {
  description = "(Optional)" #The Service Tag used for this IP Restriction.
  type = string
}*/

/*variable "linux_function_app_slot_scm_ip_restriction_virtual_network_subnet_id" {
  description = "(Optional)" #The Virtual Network Subnet ID used for this IP Restriction.
  type = string
}*/
...
variable "linux_function_app_slot_storage_account_account_name" {
  description = "(Required)" #The value for storage_account_account_name
  type = string
}

/*variable "linux_function_app_slot_storage_account_mount_path" {
...
variable "linux_function_app_slot_storage_account_share_name" {
  description = "(Required)" #The value for storage_account_share_name
  type = string
}

variable "linux_function_app_slot_storage_account_type" {
