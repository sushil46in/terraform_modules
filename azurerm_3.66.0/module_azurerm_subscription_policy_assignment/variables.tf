...
variable "subscription_policy_assignment_overrides_value" {
  description = "(Required)" #The value for overrides_value
  type = string
}

/*variable "subscription_policy_assignment_selectors_in" {
  description = "(Optional)" #The value for selectors_in
  type = list
}*/

/*variable "subscription_policy_assignment_selectors_not_in" {
  description = "(Optional)" #The value for selectors_not_in
  type = list
}*/

/*variable "subscription_policy_assignment_resource_selectors_name" {
...
variable "subscription_policy_assignment_selectors_kind" {
