...
/*variable "kubernetes_cluster_node_pool_custom_ca_trust_enabled" {
  description = "(Optional)" #The value for custom_ca_trust_enabled
  type = bool
}*/
...
/*variable "kubernetes_cluster_node_pool_message_of_the_day" {
  description = "(Optional)" #The value for message_of_the_day
  type = string
}*/
...
/*variable "kubernetes_cluster_node_pool_snapshot_id" {
...
/*variable "kubernetes_cluster_node_pool_node_network_profile_node_public_ip_tags" {
...
/*variable "kubernetes_cluster_node_pool_windows_profile_outbound_nat_enabled" {
  description = "(Optional)" #The value for windows_profile_outbound_nat_enabled
  type = bool
}*/
