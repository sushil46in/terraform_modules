...
resource "azurerm_hdinsight_kafka_cluster" "resname" {
  ...
  compute_isolation {
    #compute_isolation_enabled = var.hdinsight_kafka_cluster_compute_isolation_compute_isolation_enabled
    #host_sku = var.hdinsight_kafka_cluster_compute_isolation_host_sku
  }
  ...
  roles {
    head_node {
      ...
      script_actions {
        name = var.hdinsight_kafka_cluster_script_actions_name
        #parameters = var.hdinsight_kafka_cluster_script_actions_parameters
        uri = var.hdinsight_kafka_cluster_script_actions_uri
      }
    }
