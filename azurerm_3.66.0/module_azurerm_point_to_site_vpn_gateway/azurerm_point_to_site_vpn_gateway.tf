...
resource "azurerm_point_to_site_vpn_gateway" "resname" {
  ...
  #routing_preference_internet_enabled = var.point_to_site_vpn_gateway_routing_preference_internet_enabled
  ...
  connection_configuration {
    ...
    route {
      ...
      #inbound_route_map_id = var.point_to_site_vpn_gateway_route_inbound_route_map_id
      #outbound_route_map_id = var.point_to_site_vpn_gateway_route_outbound_route_map_id
