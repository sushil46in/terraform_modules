...
/*variable "batch_pool_target_node_communication_mode" {
  description = "(Optional)" #The value for target_node_communication_mode
  type = string
}*/
...
/*variable "batch_pool_fixed_scale_node_deallocation_method" {
  description = "(Optional)" #The value for fixed_scale_node_deallocation_method
  type = string
}*/
...
/*variable "batch_pool_network_configuration_dynamic_vnet_assignment_scope" {
  description = "(Optional)" #The value for network_configuration_dynamic_vnet_assignment_scope
  type = string
}*/
...
variable "batch_pool_container_image_name" {
  description = "(Required)" #The value for container_image_name
  type = string
}

/*variable "batch_pool_container_run_options" {
  description = "(Optional)" #The value for container_run_options
  type = string
}*/

/*variable "batch_pool_container_working_directory" {
  description = "(Optional)" #The value for container_working_directory
  type = string
}*/

/*variable "batch_pool_registry_password" {
  description = "(Optional)" #The value for registry_password
  type = string
}*/

variable "batch_pool_registry_registry_server" {
  description = "(Required)" #The value for registry_registry_server
  type = string
}

/*variable "batch_pool_registry_user_assigned_identity_id" {
  description = "(Optional)" #The User Assigned Identity to use for Container Registry access.
  type = string
}*/

/*variable "batch_pool_registry_user_name" {
  description = "(Optional)" #The value for registry_user_name
  type = string
}*/
