...
resource "azurerm_key_vault_managed_hardware_security_module" "resname" {
  ...
  #security_domain_key_vault_certificate_ids = var.key_vault_managed_hardware_security_module_security_domain_key_vault_certificate_ids
  #security_domain_quorum = var.key_vault_managed_hardware_security_module_security_domain_quorum
  ...
  timeouts {
    ...
    #update = var.key_vault_managed_hardware_security_module_timeouts_update
  }
