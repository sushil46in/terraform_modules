...
output "vpn_gateway_bgp_settings_bgp_peering_address" {
  value = azurerm_vpn_gateway.resname.bgp_peering_address
}

output "vpn_gateway_bgp_settings" {
  value = azurerm_vpn_gateway.resname.bgp_settings
}

output "vpn_gateway_instance_0_bgp_peering_address_default_ips" {
  value = azurerm_vpn_gateway.resname.default_ips
}

output "vpn_gateway_instance_0_bgp_peering_address_ip_configuration_id" {
  value = azurerm_vpn_gateway.resname.ip_configuration_id
}

output "vpn_gateway_instance_0_bgp_peering_address_tunnel_ips" {
  value = azurerm_vpn_gateway.resname.tunnel_ips
}
