...
output "virtual_machine_scale_set_boot_diagnostics" {
  value = azurerm_virtual_machine_scale_set.resname.boot_diagnostics
}

output "virtual_machine_scale_set_extension" {
  value = azurerm_virtual_machine_scale_set.resname.extension
}

output "virtual_machine_scale_set_identity_principal_id" {
  value = azurerm_virtual_machine_scale_set.resname.principal_id
}

output "virtual_machine_scale_set_identity" {
  value = azurerm_virtual_machine_scale_set.resname.identity
}

output "virtual_machine_scale_set_network_profile" {
  value = azurerm_virtual_machine_scale_set.resname.network_profile
}

output "virtual_machine_scale_set_ip_configuration_load_balancer_inbound_nat_rules_ids" {
  value = azurerm_virtual_machine_scale_set.resname.load_balancer_inbound_nat_rules_ids
}

output "virtual_machine_scale_set_os_profile" {
  value = azurerm_virtual_machine_scale_set.resname.os_profile
}

output "virtual_machine_scale_set_os_profile_secrets" {
  value = azurerm_virtual_machine_scale_set.resname.os_profile_secrets
}

output "virtual_machine_scale_set_plan" {
  value = azurerm_virtual_machine_scale_set.resname.plan
}

output "virtual_machine_scale_set_sku_tier" {
  value = azurerm_virtual_machine_scale_set.resname.tier
}

output "virtual_machine_scale_set_sku" {
  value = azurerm_virtual_machine_scale_set.resname.sku
}

output "virtual_machine_scale_set_storage_profile_data_disk_caching" {
  value = azurerm_virtual_machine_scale_set.resname.caching
}

output "virtual_machine_scale_set_storage_profile_data_disk_disk_size_gb" {
  value = azurerm_virtual_machine_scale_set.resname.disk_size_gb
}

output "virtual_machine_scale_set_storage_profile_data_disk_managed_disk_type" {
  value = azurerm_virtual_machine_scale_set.resname.managed_disk_type
}

output "virtual_machine_scale_set_storage_profile_data_disk" {
  value = azurerm_virtual_machine_scale_set.resname.storage_profile_data_disk
}
...
output "virtual_machine_scale_set_storage_profile_os_disk" {
  value = azurerm_virtual_machine_scale_set.resname.storage_profile_os_disk
}
