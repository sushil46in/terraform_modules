...
output "virtual_hub_connection_routing_associated_route_table_id" {
  value = azurerm_virtual_hub_connection.resname.associated_route_table_id
}

output "virtual_hub_connection_routing" {
  value = azurerm_virtual_hub_connection.resname.routing
}

output "virtual_hub_connection_propagated_route_table_labels" {
  value = azurerm_virtual_hub_connection.resname.labels
}

output "virtual_hub_connection_propagated_route_table_route_table_ids" {
  value = azurerm_virtual_hub_connection.resname.route_table_ids
}
