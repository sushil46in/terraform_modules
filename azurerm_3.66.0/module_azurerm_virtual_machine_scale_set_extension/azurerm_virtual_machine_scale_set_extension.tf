...
resource "azurerm_virtual_machine_scale_set_extension" "resname" {
  ...
  protected_settings_from_key_vault {
    secret_url = var.virtual_machine_scale_set_extension_protected_settings_from_key_vault_secret_url
    source_vault_id = var.virtual_machine_scale_set_extension_protected_settings_from_key_vault_source_vault_id
  }
