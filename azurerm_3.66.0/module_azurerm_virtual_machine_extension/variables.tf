...
variable "virtual_machine_extension_protected_settings_from_key_vault_secret_url" {
  description = "(Required)" #The value for protected_settings_from_key_vault_secret_url
  type = string
}

variable "virtual_machine_extension_protected_settings_from_key_vault_source_vault_id" {
  description = "(Required)" #The value for protected_settings_from_key_vault_source_vault_id
  type = string
}

/*variable "virtual_machine_extension_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "virtual_machine_extension_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "virtual_machine_extension_timeouts_read" {
  description = "(Optional)" #The value for timeouts_read
  type = string
}*/

/*variable "virtual_machine_extension_timeouts_update" {
