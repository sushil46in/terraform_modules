...
output "globalaccelerator_endpoint_group_endpoint_configuration_client_ip_preservation_enabled" {
  value = aws_globalaccelerator_endpoint_group.resname.client_ip_preservation_enabled
}

output "globalaccelerator_endpoint_group_endpoint_configuration" {
  value = aws_globalaccelerator_endpoint_group.resname.endpoint_configuration
}

output "globalaccelerator_endpoint_group_port_override" {
  value = aws_globalaccelerator_endpoint_group.resname.port_override
}
