...
output "xray_group_insights_configuration_insights_enabled" {
  value = aws_xray_group.resname.insights_configuration_insights_enabled
}

output "xray_group_insights_configuration_notifications_enabled" {
  value = aws_xray_group.resname.insights_configuration_notifications_enabled
}
