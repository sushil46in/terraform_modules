...
output "acmpca_certificate_validity_type" {
  value = aws_acmpca_certificate.resname.validity_type
}

output "acmpca_certificate_validity_value" {
  value = aws_acmpca_certificate.resname.validity_value
}
