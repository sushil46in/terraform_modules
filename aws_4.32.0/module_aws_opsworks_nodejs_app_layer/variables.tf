...
/*variable "opsworks_nodejs_app_layer_nodejs_version" {
  description = "(Optional)" #The value for nodejs_version
  type = string
}*/
...
/*variable "opsworks_nodejs_app_layer_tags" {
...
/*variable "opsworks_nodejs_app_layer_cloudwatch_configuration_enabled" {
  description = "(Optional)" #The value for cloudwatch_configuration_enabled
  type = bool
}*/

/*variable "opsworks_nodejs_app_layer_log_streams_batch_count" {
  description = "(Optional)" #The value for log_streams_batch_count
  type = number
}*/

/*variable "opsworks_nodejs_app_layer_log_streams_batch_size" {
  description = "(Optional)" #The value for log_streams_batch_size
  type = number
}*/

/*variable "opsworks_nodejs_app_layer_log_streams_buffer_duration" {
  description = "(Optional)" #The value for log_streams_buffer_duration
  type = number
}*/

/*variable "opsworks_nodejs_app_layer_log_streams_datetime_format" {
  description = "(Optional)" #The value for log_streams_datetime_format
  type = string
}*/

/*variable "opsworks_nodejs_app_layer_log_streams_encoding" {
  description = "(Optional)" #The value for log_streams_encoding
  type = string
}*/

variable "opsworks_nodejs_app_layer_log_streams_file" {
  description = "(Required)" #The value for log_streams_file
  type = string
}

/*variable "opsworks_nodejs_app_layer_log_streams_file_fingerprint_lines" {
  description = "(Optional)" #The value for log_streams_file_fingerprint_lines
  type = string
}*/

/*variable "opsworks_nodejs_app_layer_log_streams_initial_position" {
  description = "(Optional)" #The value for log_streams_initial_position
  type = string
}*/

variable "opsworks_nodejs_app_layer_log_streams_log_group_name" {
  description = "(Required)" #The value for log_streams_log_group_name
  type = string
}

/*variable "opsworks_nodejs_app_layer_log_streams_multiline_start_pattern" {
  description = "(Optional)" #The value for log_streams_multiline_start_pattern
  type = string
}*/

/*variable "opsworks_nodejs_app_layer_log_streams_time_zone" {
  description = "(Optional)" #The value for log_streams_time_zone
  type = string
}*/

/*variable "opsworks_nodejs_app_layer_ebs_volume_encrypted" {
  description = "(Optional)" #The value for ebs_volume_encrypted
  type = bool
}*/

/*variable "opsworks_nodejs_app_layer_ebs_volume_iops" {
  description = "(Optional)" #The value for ebs_volume_iops
  type = number
}*/

variable "opsworks_nodejs_app_layer_ebs_volume_mount_point" {
  description = "(Required)" #The value for ebs_volume_mount_point
  type = string
}

variable "opsworks_nodejs_app_layer_ebs_volume_number_of_disks" {
  description = "(Required)" #The value for ebs_volume_number_of_disks
  type = number
}

/*variable "opsworks_nodejs_app_layer_ebs_volume_raid_level" {
  description = "(Optional)" #The value for ebs_volume_raid_level
  type = string
}*/

variable "opsworks_nodejs_app_layer_ebs_volume_size" {
  description = "(Required)" #The value for ebs_volume_size
  type = number
}

/*variable "opsworks_nodejs_app_layer_ebs_volume_type" {
