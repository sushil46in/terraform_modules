...
output "lb_target_group_health_check_matcher" {
  value = aws_lb_target_group.resname.health_check_matcher
}

output "lb_target_group_health_check_path" {
  value = aws_lb_target_group.resname.health_check_path
}

output "lb_target_group_health_check_timeout" {
  value = aws_lb_target_group.resname.health_check_timeout
}

output "lb_target_group_stickiness_type" {
  value = aws_lb_target_group.resname.stickiness_type
}
