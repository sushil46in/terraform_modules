...
/*variable "lb_target_group_stickiness_cookie_duration" {
  description = "(Optional)" #The value for stickiness_cookie_duration
  type = number
}*/

/*variable "lb_target_group_stickiness_cookie_name" {
  description = "(Optional)" #The value for stickiness_cookie_name
  type = string
}*/

/*variable "lb_target_group_stickiness_enabled" {
  description = "(Optional)" #The value for stickiness_enabled
  type = bool
}*/

variable "lb_target_group_stickiness_type" {
