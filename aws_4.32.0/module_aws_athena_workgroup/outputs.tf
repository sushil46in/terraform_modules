...
output "athena_workgroup_engine_version_effective_engine_version" {
  value = aws_athena_workgroup.resname.engine_version_effective_engine_version
}

output "athena_workgroup_acl_configuration_s3_acl_option" {
  value = aws_athena_workgroup.resname.acl_configuration_s3_acl_option
}
