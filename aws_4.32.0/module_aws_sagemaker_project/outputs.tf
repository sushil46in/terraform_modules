...
output "sagemaker_project_service_catalog_provisioning_details_provisioning_artifact_id" {
  value = aws_sagemaker_project.resname.provisioning_artifact_id
}

output "sagemaker_project_service_catalog_provisioning_details" {
  value = aws_sagemaker_project.resname.service_catalog_provisioning_details
}
