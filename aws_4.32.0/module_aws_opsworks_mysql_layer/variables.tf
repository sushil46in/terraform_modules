...
/*variable "opsworks_mysql_layer_root_password" {
  description = "(Optional) 'The value for root_password'"
  type = string
}*/

/*variable "opsworks_mysql_layer_root_password_on_all_instances" {
  description = "(Optional) 'The value for root_password_on_all_instances'"
  type = bool
}*/
...
/*variable "opsworks_mysql_layer_tags" {
