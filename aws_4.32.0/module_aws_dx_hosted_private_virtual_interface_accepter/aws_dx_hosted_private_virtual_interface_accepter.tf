...
resource "aws_dx_hosted_private_virtual_interface_accepter" "resname" {
  ...
  timeouts {
    #create = var.dx_hosted_private_virtual_interface_accepter_timeouts_create
    #delete = var.dx_hosted_private_virtual_interface_accepter_timeouts_delete
  }
