...
output "ecs_capacity_provider_auto_scaling_group_provider_managed_termination_protection" {
  value = aws_ecs_capacity_provider.resname.managed_termination_protection
}

output "ecs_capacity_provider_auto_scaling_group_provider" {
  value = aws_ecs_capacity_provider.resname.auto_scaling_group_provider
}

output "ecs_capacity_provider_managed_scaling_instance_warmup_period" {
  value = aws_ecs_capacity_provider.resname.instance_warmup_period
}

output "ecs_capacity_provider_managed_scaling_maximum_scaling_step_size" {
  value = aws_ecs_capacity_provider.resname.maximum_scaling_step_size
}

output "ecs_capacity_provider_managed_scaling_minimum_scaling_step_size" {
  value = aws_ecs_capacity_provider.resname.minimum_scaling_step_size
}

output "ecs_capacity_provider_managed_scaling_status" {
  value = aws_ecs_capacity_provider.resname.status
}

output "ecs_capacity_provider_managed_scaling_target_capacity" {
  value = aws_ecs_capacity_provider.resname.target_capacity
}
