...
output "wafregional_rule_group_activated_rule_priority" {
  value = aws_wafregional_rule_group.resname.activated_rule_priority
}

output "wafregional_rule_group_activated_rule_rule_id" {
  value = aws_wafregional_rule_group.resname.activated_rule_rule_id
}

output "wafregional_rule_group_action_type" {
  value = aws_wafregional_rule_group.resname.action_type
}
