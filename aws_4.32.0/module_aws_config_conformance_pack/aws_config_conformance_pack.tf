...
resource "aws_config_conformance_pack" "resname" {
  ...
  name = var.config_conformance_pack_name
  #template_body = var.config_conformance_pack_template_body
  #template_s3_uri = var.config_conformance_pack_template_s3_uri

  input_parameter {
    parameter_name = var.config_conformance_pack_input_parameter_parameter_name
    parameter_value = var.config_conformance_pack_input_parameter_parameter_value
  }
