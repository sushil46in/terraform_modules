...
/*variable "opsworks_haproxy_layer_healthcheck_method" {
  description = "(Optional) 'The value for healthcheck_method'"
  type = string
}*/

/*variable "opsworks_haproxy_layer_healthcheck_url" {
  description = "(Optional) 'The value for healthcheck_url'"
  type = string
}*/
...
/*variable "opsworks_haproxy_layer_stats_enabled" {
  description = "(Optional) 'The value for stats_enabled'"
  type = bool
}*/

variable "opsworks_haproxy_layer_stats_password" {
  description = "(Required) 'The value for stats_password'"
  type = string
}

/*variable "opsworks_haproxy_layer_stats_url" {
  description = "(Optional) 'The value for stats_url'"
  type = string
}*/

/*variable "opsworks_haproxy_layer_stats_user" {
  description = "(Optional) 'The value for stats_user'"
  type = string
}*/
...
/*variable "opsworks_haproxy_layer_tags" {
