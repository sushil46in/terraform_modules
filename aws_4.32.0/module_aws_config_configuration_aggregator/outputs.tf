...
output "config_configuration_aggregator_account_aggregation_source" {
  value = aws_config_configuration_aggregator.resname.account_aggregation_source
}

output "config_configuration_aggregator_organization_aggregation_source" {
  value = aws_config_configuration_aggregator.resname.organization_aggregation_source
}
