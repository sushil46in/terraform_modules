...
output "cloudfront_realtime_log_config_endpoint_stream_type" {
  value = aws_cloudfront_realtime_log_config.resname.endpoint_stream_type
}

output "cloudfront_realtime_log_config_kinesis_stream_config_role_arn" {
  value = aws_cloudfront_realtime_log_config.resname.kinesis_stream_config_role_arn
}

output "cloudfront_realtime_log_config_kinesis_stream_config_stream_arn" {
  value = aws_cloudfront_realtime_log_config.resname.kinesis_stream_config_stream_arn
}
