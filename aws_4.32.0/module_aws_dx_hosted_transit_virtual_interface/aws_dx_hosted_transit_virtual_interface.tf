...
resource "aws_dx_hosted_transit_virtual_interface" "resname" {
  ...
  timeouts {
    #create = var.dx_hosted_transit_virtual_interface_timeouts_create
    #delete = var.dx_hosted_transit_virtual_interface_timeouts_delete
  }
