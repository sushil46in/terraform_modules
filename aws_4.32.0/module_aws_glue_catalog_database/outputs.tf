...
output "glue_catalog_database_target_database_catalog_id" {
  value = aws_glue_catalog_database.resname.target_database_catalog_id
}

output "glue_catalog_database_target_database_database_name" {
  value = aws_glue_catalog_database.resname.target_database_database_name
}
