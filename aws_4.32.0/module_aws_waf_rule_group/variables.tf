...
/*variable "waf_rule_group_tags" {
  description = "(Optional)" #The value for tags
  type = map
}*/

variable "waf_rule_group_activated_rule_priority" {
  description = "(Required)" #The value for activated_rule_priority
  type = number
}

variable "waf_rule_group_activated_rule_rule_id" {
  description = "(Required)" #The value for activated_rule_rule_id
  type = string
}

/*variable "waf_rule_group_activated_rule_type" {
  description = "(Optional)" #The value for activated_rule_type
  type = string
}*/

variable "waf_rule_group_action_type" {
