...
output "ec2_client_vpn_endpoint_authentication_options" {
  value = aws_ec2_client_vpn_endpoint.resname.authentication_options
}

output "ec2_client_vpn_endpoint_client_connect_options_enabled" {
  value = aws_ec2_client_vpn_endpoint.resname.enabled
}

output "ec2_client_vpn_endpoint_client_connect_options_lambda_function_arn" {
  value = aws_ec2_client_vpn_endpoint.resname.lambda_function_arn
}

output "ec2_client_vpn_endpoint_client_connect_options" {
  value = aws_ec2_client_vpn_endpoint.resname.client_connect_options
}

output "ec2_client_vpn_endpoint_client_login_banner_options_banner_text" {
  value = aws_ec2_client_vpn_endpoint.resname.banner_text
}
...
output "ec2_client_vpn_endpoint_client_login_banner_options" {
  value = aws_ec2_client_vpn_endpoint.resname.client_login_banner_options
}

output "ec2_client_vpn_endpoint_connection_log_options_cloudwatch_log_stream" {
  value = aws_ec2_client_vpn_endpoint.resname.cloudwatch_log_stream
}

output "ec2_client_vpn_endpoint_connection_log_options" {
  value = aws_ec2_client_vpn_endpoint.resname.connection_log_options
}
