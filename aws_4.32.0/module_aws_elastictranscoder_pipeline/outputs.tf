...
output "elastictranscoder_pipeline_content_config_bucket" {
  value = aws_elastictranscoder_pipeline.resname.bucket
}

output "elastictranscoder_pipeline_content_config" {
  value = aws_elastictranscoder_pipeline.resname.content_config
}
...
output "elastictranscoder_pipeline_thumbnail_config" {
  value = aws_elastictranscoder_pipeline.resname.thumbnail_config
}
