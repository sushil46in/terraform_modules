...
/*variable "instance_capacity_reservation_specification_capacity_reservation_preference" {
...
/*variable "instance_network_interface_network_card_index" {
  description = "(Optional) 'The value for network_interface_network_card_index'"
  type = number
}*/

variable "instance_network_interface_network_interface_id" {
