...
output "instance_ebs_block_device_encrypted" {
  value = aws_instance.resname.encrypted
}

output "instance_ebs_block_device_iops" {
  value = aws_instance.resname.iops
}

output "instance_ebs_block_device_kms_key_id" {
  value = aws_instance.resname.kms_key_id
}

output "instance_ebs_block_device_snapshot_id" {
  value = aws_instance.resname.snapshot_id
}

output "instance_ebs_block_device_throughput" {
  value = aws_instance.resname.throughput
}

output "instance_ebs_block_device_volume_id" {
  value = aws_instance.resname.volume_id
}

output "instance_ebs_block_device_volume_size" {
  value = aws_instance.resname.volume_size
}

output "instance_ebs_block_device_volume_type" {
  value = aws_instance.resname.volume_type
}

output "instance_ebs_block_device" {
  value = aws_instance.resname.ebs_block_device
}

output "instance_enclave_options_enabled" {
  value = aws_instance.resname.enabled
}

output "instance_enclave_options" {
  value = aws_instance.resname.enclave_options
}

output "instance_ephemeral_block_device" {
  value = aws_instance.resname.ephemeral_block_device
}
...
output "instance_launch_template_name" {
  value = aws_instance.resname.name
}

output "instance_launch_template" {
  value = aws_instance.resname.launch_template
}

output "instance_maintenance_options_auto_recovery" {
  value = aws_instance.resname.auto_recovery
}

output "instance_maintenance_options" {
  value = aws_instance.resname.maintenance_options
}

output "instance_metadata_options_http_endpoint" {
  value = aws_instance.resname.http_endpoint
}

output "instance_metadata_options_http_put_response_hop_limit" {
  value = aws_instance.resname.http_put_response_hop_limit
}

output "instance_metadata_options_http_tokens" {
  value = aws_instance.resname.http_tokens
}

output "instance_metadata_options_instance_metadata_tags" {
  value = aws_instance.resname.instance_metadata_tags
}

output "instance_metadata_options" {
  value = aws_instance.resname.metadata_options
}

output "instance_network_interface" {
  value = aws_instance.resname.network_interface
}

output "instance_private_dns_name_options_enable_resource_name_dns_a_record" {
  value = aws_instance.resname.enable_resource_name_dns_a_record
}

output "instance_private_dns_name_options_enable_resource_name_dns_aaaa_record" {
  value = aws_instance.resname.enable_resource_name_dns_aaaa_record
}

output "instance_private_dns_name_options_hostname_type" {
  value = aws_instance.resname.hostname_type
}

output "instance_private_dns_name_options" {
  value = aws_instance.resname.private_dns_name_options
}

output "instance_root_block_device_device_name" {
  value = aws_instance.resname.device_name
}
...
output "instance_root_block_device" {
  value = aws_instance.resname.root_block_device
}
