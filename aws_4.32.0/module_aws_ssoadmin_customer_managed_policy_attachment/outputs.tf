...
output "ssoadmin_customer_managed_policy_attachment_customer_managed_policy_reference" {
  value = aws_ssoadmin_customer_managed_policy_attachment.resname.customer_managed_policy_reference
}
