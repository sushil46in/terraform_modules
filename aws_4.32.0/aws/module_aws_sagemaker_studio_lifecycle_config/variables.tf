...
variable "sagemaker_studio_lifecycle_config_studio_lifecycle_config_app_type" {
  description = "(Required) The value for studio_lifecycle_config_app_type"
  type = string
}

variable "sagemaker_studio_lifecycle_config_studio_lifecycle_config_content" {
  description = "(Required) The value for studio_lifecycle_config_content"
  type = string
}

variable "sagemaker_studio_lifecycle_config_studio_lifecycle_config_name" {
  description = "(Required) The value for studio_lifecycle_config_name"
  type = string
}
