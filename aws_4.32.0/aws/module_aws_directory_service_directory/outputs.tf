...
output "directory_service_directory_connect_settings_availability_zones" {
  value = aws_directory_service_directory.resname.connect_settings_availability_zones
}

output "directory_service_directory_connect_settings_connect_ips" {
  value = aws_directory_service_directory.resname.connect_settings_connect_ips
}

output "directory_service_directory_connect_settings_customer_dns_ips" {
  value = aws_directory_service_directory.resname.connect_settings_customer_dns_ips
}

output "directory_service_directory_connect_settings_customer_username" {
  value = aws_directory_service_directory.resname.connect_settings_customer_username
}

output "directory_service_directory_connect_settings_subnet_ids" {
  value = aws_directory_service_directory.resname.connect_settings_subnet_ids
}

output "directory_service_directory_connect_settings_vpc_id" {
  value = aws_directory_service_directory.resname.connect_settings_vpc_id
}

output "directory_service_directory_vpc_settings_availability_zones" {
  value = aws_directory_service_directory.resname.vpc_settings_availability_zones
}

output "directory_service_directory_vpc_settings_subnet_ids" {
  value = aws_directory_service_directory.resname.vpc_settings_subnet_ids
}

output "directory_service_directory_vpc_settings_vpc_id" {
  value = aws_directory_service_directory.resname.vpc_settings_vpc_id
}
