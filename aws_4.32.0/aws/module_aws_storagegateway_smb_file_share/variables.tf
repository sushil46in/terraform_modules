...
/*variable "storagegateway_smb_file_share_access_based_enumeration" {
  description = "(Optional) The value for access_based_enumeration"
  type = bool
}*/

/*variable "storagegateway_smb_file_share_admin_user_list" {
  description = "(Optional) The value for admin_user_list"
  type = set
}*/
...
/*variable "storagegateway_smb_file_share_authentication" {
  description = "(Optional) The value for authentication"
  type = string
}*/

/*variable "storagegateway_smb_file_share_bucket_region" {
  description = "(Optional) The value for bucket_region"
  type = string
}*/

/*variable "storagegateway_smb_file_share_case_sensitivity" {
  description = "(Optional) The value for case_sensitivity"
  type = string
}*/
...
/*variable "storagegateway_smb_file_share_invalid_user_list" {
  description = "(Optional) The value for invalid_user_list"
  type = set
}*/
...
/*variable "storagegateway_smb_file_share_smb_acl_enabled" {
  description = "(Optional) The value for smb_acl_enabled"
  type = bool
}*/

/*variable "storagegateway_smb_file_share_tags" {
  description = "(Optional) The value for tags"
  type = map
}*/

/*variable "storagegateway_smb_file_share_valid_user_list" {
  description = "(Optional) The value for valid_user_list"
  type = set
}*/

/*variable "storagegateway_smb_file_share_vpc_endpoint_dns_name" {
  description = "(Optional) The value for vpc_endpoint_dns_name"
  type = string
}*/

/*variable "storagegateway_smb_file_share_cache_attributes_cache_stale_timeout_in_seconds" {
  description = "(Optional) The value for cache_attributes_cache_stale_timeout_in_seconds"
  type = number
}*/

/*variable "storagegateway_smb_file_share_timeouts_create" {
  description = "(Optional) The value for timeouts_create"
  type = string
}*/

/*variable "storagegateway_smb_file_share_timeouts_delete" {
  description = "(Optional) The value for timeouts_delete"
  type = string
}*/

/*variable "storagegateway_smb_file_share_timeouts_update" {
