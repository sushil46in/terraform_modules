...
output "ssm_maintenance_window_task_targets_key" {
  value = aws_ssm_maintenance_window_task.resname.targets_key
}

output "ssm_maintenance_window_task_targets_values" {
  value = aws_ssm_maintenance_window_task.resname.targets_values
}

output "ssm_maintenance_window_task_parameter_name" {
  value = aws_ssm_maintenance_window_task.resname.parameter_name
}

output "ssm_maintenance_window_task_parameter_values" {
  value = aws_ssm_maintenance_window_task.resname.parameter_values
}

output "ssm_maintenance_window_task_cloudwatch_config_cloudwatch_log_group_name" {
  value = aws_ssm_maintenance_window_task.resname.cloudwatch_config_cloudwatch_log_group_name
}
