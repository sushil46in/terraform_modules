...
output "transfer_server_endpoint_details_security_group_ids" {
  value = aws_transfer_server.resname.endpoint_details_security_group_ids
}

output "transfer_server_endpoint_details_vpc_endpoint_id" {
  value = aws_transfer_server.resname.endpoint_details_vpc_endpoint_id
}

output "transfer_server_on_upload_execution_role" {
  value = aws_transfer_server.resname.on_upload_execution_role
}

output "transfer_server_on_upload_workflow_id" {
  value = aws_transfer_server.resname.on_upload_workflow_id
}
