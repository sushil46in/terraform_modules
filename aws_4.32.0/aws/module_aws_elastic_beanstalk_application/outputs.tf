...
output "elastic_beanstalk_application_appversion_lifecycle_service_role" {
  value = aws_elastic_beanstalk_application.resname.appversion_lifecycle_service_role
}
