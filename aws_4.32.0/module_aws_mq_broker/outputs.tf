...
output "mq_broker_configuration_revision" {
  value = aws_mq_broker.resname.revision
}

output "mq_broker_configuration" {
  value = aws_mq_broker.resname.configuration
}

output "mq_broker_encryption_options_kms_key_id" {
  value = aws_mq_broker.resname.kms_key_id
}

output "mq_broker_encryption_options" {
  value = aws_mq_broker.resname.encryption_options
}

output "mq_broker_maintenance_window_start_time" {
  value = aws_mq_broker.resname.maintenance_window_start_time
}

output "mq_broker_user" {
  value = aws_mq_broker.resname.user
}
