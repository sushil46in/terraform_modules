...
output "db_security_group_ingress_security_group_id" {
  value = aws_db_security_group.resname.security_group_id
}

output "db_security_group_ingress_security_group_name" {
  value = aws_db_security_group.resname.security_group_name
}

output "db_security_group_ingress_security_group_owner_id" {
  value = aws_db_security_group.resname.security_group_owner_id
}

output "db_security_group_ingress" {
  value = aws_db_security_group.resname.ingress
}
