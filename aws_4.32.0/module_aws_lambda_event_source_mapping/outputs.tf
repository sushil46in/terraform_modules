...
output "lambda_event_source_mapping_amazon_managed_kafka_event_source_config_consumer_group_id" {
  value = aws_lambda_event_source_mapping.resname.consumer_group_id
}

output "lambda_event_source_mapping_amazon_managed_kafka_event_source_config" {
  value = aws_lambda_event_source_mapping.resname.amazon_managed_kafka_event_source_config
}

output "lambda_event_source_mapping_self_managed_event_source" {
  value = aws_lambda_event_source_mapping.resname.self_managed_event_source
}
...
output "lambda_event_source_mapping_self_managed_kafka_event_source_config" {
  value = aws_lambda_event_source_mapping.resname.self_managed_kafka_event_source_config
}

output "lambda_event_source_mapping_source_access_configuration" {
  value = aws_lambda_event_source_mapping.resname.source_access_configuration
}
