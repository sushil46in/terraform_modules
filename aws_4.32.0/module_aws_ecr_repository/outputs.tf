...
output "ecr_repository_encryption_configuration_kms_key" {
  value = aws_ecr_repository.resname.kms_key
}

output "ecr_repository_encryption_configuration" {
  value = aws_ecr_repository.resname.encryption_configuration
}

output "ecr_repository_image_scanning_configuration" {
  value = aws_ecr_repository.resname.image_scanning_configuration
}
