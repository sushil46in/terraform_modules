...
output "ami_ebs_block_device_device_name" {
  value = aws_ami.resname.ebs_block_device_device_name
}

output "ami_ebs_block_device_throughput" {
  value = aws_ami.resname.ebs_block_device_throughput
}

output "ami_ebs_block_device_volume_size" {
  value = aws_ami.resname.ebs_block_device_volume_size
}

output "ami_ephemeral_block_device_device_name" {
  value = aws_ami.resname.ephemeral_block_device_device_name
}

output "ami_ephemeral_block_device_virtual_name" {
  value = aws_ami.resname.ephemeral_block_device_virtual_name
}
