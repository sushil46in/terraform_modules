...
output "autoscaling_group_initial_lifecycle_hook_default_result" {
  value = aws_autoscaling_group.resname.initial_lifecycle_hook_default_result
}

output "autoscaling_group_initial_lifecycle_hook_lifecycle_transition" {
  value = aws_autoscaling_group.resname.initial_lifecycle_hook_lifecycle_transition
}

output "autoscaling_group_initial_lifecycle_hook_name" {
  value = aws_autoscaling_group.resname.initial_lifecycle_hook_name
}

output "autoscaling_group_instance_refresh_strategy" {
  value = aws_autoscaling_group.resname.instance_refresh_strategy
}
...
output "autoscaling_group_instances_distribution_on_demand_allocation_strategy" {
  value = aws_autoscaling_group.resname.instances_distribution_on_demand_allocation_strategy
}

output "autoscaling_group_instances_distribution_on_demand_base_capacity" {
  value = aws_autoscaling_group.resname.instances_distribution_on_demand_base_capacity
}

output "autoscaling_group_instances_distribution_on_demand_percentage_above_base_capacity" {
  value = aws_autoscaling_group.resname.instances_distribution_on_demand_percentage_above_base_capacity
}

output "autoscaling_group_instances_distribution_spot_allocation_strategy" {
  value = aws_autoscaling_group.resname.instances_distribution_spot_allocation_strategy
}

output "autoscaling_group_instances_distribution_spot_instance_pools" {
  value = aws_autoscaling_group.resname.instances_distribution_spot_instance_pools
}

output "autoscaling_group_launch_template_specification_launch_template_id" {
  value = aws_autoscaling_group.resname.launch_template_specification_launch_template_id
}

output "autoscaling_group_launch_template_specification_launch_template_name" {
  value = aws_autoscaling_group.resname.launch_template_specification_launch_template_name
}
...
output "autoscaling_group_tag_key" {
  value = aws_autoscaling_group.resname.tag_key
}

output "autoscaling_group_tag_propagate_at_launch" {
  value = aws_autoscaling_group.resname.tag_propagate_at_launch
}

output "autoscaling_group_tag_value" {
  value = aws_autoscaling_group.resname.tag_value
}
