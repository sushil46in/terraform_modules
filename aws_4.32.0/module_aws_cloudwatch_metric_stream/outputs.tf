...
output "cloudwatch_metric_stream_exclude_filter" {
  value = aws_cloudwatch_metric_stream.resname.exclude_filter
}

output "cloudwatch_metric_stream_include_filter" {
  value = aws_cloudwatch_metric_stream.resname.include_filter
}

output "cloudwatch_metric_stream_statistics_configuration" {
  value = aws_cloudwatch_metric_stream.resname.statistics_configuration
}
