...
output "s3_bucket_website_configuration_error_document" {
  value = aws_s3_bucket_website_configuration.resname.error_document
}

output "s3_bucket_website_configuration_index_document" {
  value = aws_s3_bucket_website_configuration.resname.index_document
}

output "s3_bucket_website_configuration_redirect_all_requests_to" {
  value = aws_s3_bucket_website_configuration.resname.redirect_all_requests_to
}
