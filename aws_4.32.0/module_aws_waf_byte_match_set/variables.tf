...
variable "waf_byte_match_set_byte_match_tuples_positional_constraint" {
  description = "(Required) 'The value for byte_match_tuples_positional_constraint'"
  type = string
}

/*variable "waf_byte_match_set_byte_match_tuples_target_string" {
  description = "(Optional) 'The value for byte_match_tuples_target_string'"
  type = string
}*/

variable "waf_byte_match_set_byte_match_tuples_text_transformation" {
