...
output "transfer_access_home_directory_mappings" {
  value = aws_transfer_access.resname.home_directory_mappings
}

output "transfer_access_posix_profile" {
  value = aws_transfer_access.resname.posix_profile
}
