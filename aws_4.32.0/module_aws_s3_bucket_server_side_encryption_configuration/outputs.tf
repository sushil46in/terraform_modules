...
output "s3_bucket_server_side_encryption_configuration_apply_server_side_encryption_by_default_sse_algorithm" {
  value = aws_s3_bucket_server_side_encryption_configuration.resname.apply_server_side_encryption_by_default_sse_algorithm
}
