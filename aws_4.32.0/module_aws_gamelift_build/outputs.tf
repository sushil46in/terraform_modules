...
output "gamelift_build_storage_location_bucket" {
  value = aws_gamelift_build.resname.storage_location_bucket
}

output "gamelift_build_storage_location_key" {
  value = aws_gamelift_build.resname.storage_location_key
}

output "gamelift_build_storage_location_role_arn" {
  value = aws_gamelift_build.resname.storage_location_role_arn
}
