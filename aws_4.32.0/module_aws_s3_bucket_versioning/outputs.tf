...
output "s3_bucket_versioning_versioning_configuration_mfa_delete" {
  value = aws_s3_bucket_versioning.resname.mfa_delete
}

output "s3_bucket_versioning_versioning_configuration" {
  value = aws_s3_bucket_versioning.resname.versioning_configuration
}
