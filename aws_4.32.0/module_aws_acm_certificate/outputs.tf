...
output "acm_certificate_validation_option_domain_name" {
  value = aws_acm_certificate.resname.validation_option_domain_name
}

output "acm_certificate_validation_option_validation_domain" {
  value = aws_acm_certificate.resname.validation_option_validation_domain
}
