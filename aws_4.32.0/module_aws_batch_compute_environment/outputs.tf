...
output "batch_compute_environment_compute_resources_desired_vcpus" {
  value = aws_batch_compute_environment.resname.desired_vcpus
}

output "batch_compute_environment_compute_resources" {
  value = aws_batch_compute_environment.resname.compute_resources
}

output "batch_compute_environment_ec2_configuration_image_id_override" {
  value = aws_batch_compute_environment.resname.image_id_override
}
