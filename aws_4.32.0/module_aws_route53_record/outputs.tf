...
output "route53_record_alias" {
  value = aws_route53_record.resname.alias
}

output "route53_record_failover_routing_policy" {
  value = aws_route53_record.resname.failover_routing_policy
}

output "route53_record_latency_routing_policy" {
  value = aws_route53_record.resname.latency_routing_policy
}

output "route53_record_weighted_routing_policy" {
  value = aws_route53_record.resname.weighted_routing_policy
}
