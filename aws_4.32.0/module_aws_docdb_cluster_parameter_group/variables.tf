...
/*variable "docdb_cluster_parameter_group_tags" {
  description = "(Optional) 'The value for tags'"
  type = map
}*/

/*variable "docdb_cluster_parameter_group_parameter_apply_method" {
  description = "(Optional) 'The value for parameter_apply_method'"
  type = string
}*/

variable "docdb_cluster_parameter_group_parameter_name" {
  description = "(Required) 'The value for parameter_name'"
  type = string
}

variable "docdb_cluster_parameter_group_parameter_value" {
