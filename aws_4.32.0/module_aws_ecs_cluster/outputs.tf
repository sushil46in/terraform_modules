...
output "ecs_cluster_default_capacity_provider_strategy" {
  value = aws_ecs_cluster.resname.default_capacity_provider_strategy
}

output "ecs_cluster_setting" {
  value = aws_ecs_cluster.resname.setting
}
