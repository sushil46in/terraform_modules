...
output "codepipeline_webhook_filter_json_path" {
  value = aws_codepipeline_webhook.resname.filter_json_path
}

output "codepipeline_webhook_filter_match_equals" {
  value = aws_codepipeline_webhook.resname.filter_match_equals
}
