...
output "eks_cluster_encryption_config" {
  value = aws_eks_cluster.resname.encryption_config
}

output "eks_cluster_kubernetes_network_config_ip_family" {
  value = aws_eks_cluster.resname.ip_family
}

output "eks_cluster_kubernetes_network_config_service_ipv4_cidr" {
  value = aws_eks_cluster.resname.service_ipv4_cidr
}

output "eks_cluster_kubernetes_network_config" {
  value = aws_eks_cluster.resname.kubernetes_network_config
}

output "eks_cluster_outpost_config" {
  value = aws_eks_cluster.resname.outpost_config
}

output "eks_cluster_vpc_config_cluster_security_group_id" {
  value = aws_eks_cluster.resname.cluster_security_group_id
}

output "eks_cluster_vpc_config_public_access_cidrs" {
  value = aws_eks_cluster.resname.public_access_cidrs
}

output "eks_cluster_vpc_config_vpc_id" {
  value = aws_eks_cluster.resname.vpc_id
}

output "eks_cluster_vpc_config" {
  value = aws_eks_cluster.resname.vpc_config
}
