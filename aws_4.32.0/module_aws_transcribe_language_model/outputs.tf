...
output "transcribe_language_model_input_data_config_data_access_role_arn" {
  value = aws_transcribe_language_model.resname.input_data_config_data_access_role_arn
}

output "transcribe_language_model_input_data_config_s3_uri" {
  value = aws_transcribe_language_model.resname.input_data_config_s3_uri
}

output "transcribe_language_model_input_data_config_tuning_data_s3_uri" {
  value = aws_transcribe_language_model.resname.input_data_config_tuning_data_s3_uri
}
