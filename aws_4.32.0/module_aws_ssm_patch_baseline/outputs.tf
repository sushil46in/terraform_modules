...
output "ssm_patch_baseline_global_filter" {
  value = aws_ssm_patch_baseline.resname.global_filter
}

output "ssm_patch_baseline_source" {
  value = aws_ssm_patch_baseline.resname.source
}
