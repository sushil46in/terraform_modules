...
output "glacier_vault_notification_events" {
  value = aws_glacier_vault.resname.notification_events
}

output "glacier_vault_notification_sns_topic" {
  value = aws_glacier_vault.resname.notification_sns_topic
}
