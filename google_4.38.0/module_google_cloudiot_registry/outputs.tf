...
output "cloudiot_registry_credentials" {
  value = google_cloudiot_registry.resname.credentials
}

output "cloudiot_registry_event_notification_configs" {
  value = google_cloudiot_registry.resname.event_notification_configs
}
