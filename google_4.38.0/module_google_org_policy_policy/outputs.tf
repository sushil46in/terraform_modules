...
output "org_policy_policy_spec_etag" {
  value = google_org_policy_policy.resname.etag
}

output "org_policy_policy_spec_update_time" {
  value = google_org_policy_policy.resname.update_time
}

output "org_policy_policy_spec" {
  value = google_org_policy_policy.resname.spec
}
