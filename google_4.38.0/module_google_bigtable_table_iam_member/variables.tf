...
variable "bigtable_table_iam_member_instance" {
  description = "(Required)" #The value for instance
  type = string
}

variable "bigtable_table_iam_member_member" {
  description = "(Required)" #The value for member
  type = string
}

variable "bigtable_table_iam_member_role" {
  description = "(Required)" #The value for role
  type = string
}

variable "bigtable_table_iam_member_table" {
  description = "(Required)" #The value for table
  type = string
}

/*variable "bigtable_table_iam_member_condition_description" {
  description = "(Optional)" #The value for condition_description
  type = string
}*/

variable "bigtable_table_iam_member_condition_expression" {
  description = "(Required)" #The value for condition_expression
  type = string
}

variable "bigtable_table_iam_member_condition_title" {
