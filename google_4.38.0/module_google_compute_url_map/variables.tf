...
/*variable "compute_url_map_cors_policy_allow_credentials" {
...
/*variable "compute_url_map_cors_policy_allow_origins" {
...
/*variable "compute_url_map_cors_policy_disabled" {
...
/*variable "compute_url_map_cors_policy_expose_headers" {
  description = "(Optional)" #Specifies the content for the Access-Control-Expose-Headers header.
  type = list
}*/

/*variable "compute_url_map_cors_policy_max_age" {
...
/*variable "compute_url_map_delay_percentage" {
  description = "(Optional)" #The percentage of traffic (connections/operations/requests) on which delay will be introduced as part of fault injection. The value must be between 0.0 and 100.0 inclusive.
  type = number
}*/

/*variable "compute_url_map_fixed_delay_nanos" {
...
/*variable "compute_url_map_fixed_delay_seconds" {
...
/*variable "compute_url_map_per_try_timeout_nanos" {
  description = "(Optional)" #Span of time that's a fraction of a second at nanosecond resolution. Durations less than one second are represented with a 0 seconds field and a positive nanos field. Must be from 0 to 999,999,999 inclusive.
  type = number
}*/

/*variable "compute_url_map_per_try_timeout_seconds" {
  description = "(Optional)" #Span of time at a resolution of a second. Must be from 0 to 315,576,000,000 inclusive. Note: these bounds are computed from: 60 sec/min  60 min/hr  24 hr/day  365.25 days/year  10000 years
  type = string
}*/

/*variable "compute_url_map_timeout_nanos" {
  description = "(Optional)" #Span of time that's a fraction of a second at nanosecond resolution. Durations less than one second are represented with a 0 seconds field and a positive nanos field. Must be from 0 to 999,999,999 inclusive.
  type = number
}*/

/*variable "compute_url_map_timeout_seconds" {
  description = "(Optional)" #Span of time at a resolution of a second. Must be from 0 to 315,576,000,000 inclusive. Note: these bounds are computed from: 60 sec/min  60 min/hr  24 hr/day  365.25 days/year  10000 years
  type = string
}*/

/*variable "compute_url_map_url_rewrite_host_rewrite" {
...
/*variable "compute_url_map_url_rewrite_path_prefix_rewrite" {
...
/*variable "compute_url_map_weighted_backend_services_backend_service" {
...
/*variable "compute_url_map_weighted_backend_services_weight" {
  description = "(Optional)" #Specifies the fraction of traffic sent to backendService, computed as weight / (sum of all weightedBackendService weights in routeAction) .  The selection of a backend service is determined only for new traffic. Once a user's request has been directed to a backendService, subsequent requests will be sent to the same backendService as determined by the BackendService's session affinity policy.  The value must be between 0 and 1000
  type = number
}*/

/*variable "compute_url_map_header_action_request_headers_to_remove" {
...
/*variable "compute_url_map_header_action_response_headers_to_remove" {
...
/*variable "compute_url_map_request_headers_to_add_header_name" {
  description = "(Optional)" #The name of the header to add.
  type = string
}*/

/*variable "compute_url_map_request_headers_to_add_header_value" {
  description = "(Optional)" #The value of the header to add.
  type = string
}*/

/*variable "compute_url_map_request_headers_to_add_replace" {
  description = "(Optional)" #If false, headerValue is appended to any values that already exist for the header. If true, headerValue is set for the header, discarding any values that were set for that header.
  type = bool
}*/

/*variable "compute_url_map_response_headers_to_add_header_name" {
  description = "(Optional)" #The name of the header to add.
  type = string
}*/

/*variable "compute_url_map_response_headers_to_add_header_value" {
  description = "(Optional)" #The value of the header to add.
  type = string
}*/

/*variable "compute_url_map_response_headers_to_add_replace" {
  description = "(Optional)" #If false, headerValue is appended to any values that already exist for the header. If true, headerValue is set for the header, discarding any values that were set for that header.
  type = bool
}*/

/*variable "compute_url_map_default_url_redirect_host_redirect" {
...
/*variable "compute_url_map_default_url_redirect_https_redirect" {
  description = "(Optional)" #If set to true, the URL scheme in the redirected request is set to https. If set to false, the URL scheme of the redirected request will remain the same as that of the request. This must only be set for UrlMaps used in TargetHttpProxys. Setting this true for TargetHttpsProxy is not permitted. The default is set to false.
  type = bool
}*/

/*variable "compute_url_map_default_url_redirect_path_redirect" {
...
/*variable "compute_url_map_default_url_redirect_prefix_redirect" {
  description = "(Optional)" #The prefix that replaces the prefixMatch specified in the HttpRouteRuleMatch, retaining the remaining portion of the URL before redirecting the request. prefixRedirect cannot be supplied together with pathRedirect. Supply one alone or neither. If neither is supplied, the path of the original request will be used for the redirect. The value must be between 1 and 1024 characters.
  type = string
}*/

/*variable "compute_url_map_default_url_redirect_redirect_response_code" {
...
variable "compute_url_map_default_url_redirect_strip_query" {
...
variable "compute_url_map_request_headers_to_add_replace" {
  description = "(Required)" #If false, headerValue is appended to any values that already exist for the header. If true, headerValue is set for the header, discarding any values that were set for that header.
  type = bool
}
...
/*variable "compute_url_map_host_rule_description" {
  description = "(Optional)" #An optional description of this resource. Provide this property when you create the resource.
  type = string
}*/

variable "compute_url_map_host_rule_hosts" {
...
variable "compute_url_map_host_rule_path_matcher" {
  description = "(Required)" #The name of the PathMatcher to use to match the path portion of the URL if the hostRule matches the URL's host portion.
  type = string
}

/*variable "compute_url_map_path_matcher_default_service" {
  description = "(Optional)" #The backend service or backend bucket to use when none of the given paths match.
  type = string
}*/

/*variable "compute_url_map_path_matcher_description" {
  description = "(Optional)" #An optional description of this resource. Provide this property when you create the resource.
  type = string
}*/

variable "compute_url_map_path_matcher_name" {
...
variable "compute_url_map_default_url_redirect_strip_query" {
  description = "(Required)" #If set to true, any accompanying query portion of the original URL is removed prior to redirecting the request. If set to false, the query portion of the original URL is retained.  This field is required to ensure an empty block is not set. The normal default value is false.
  type = bool
}
...
variable "compute_url_map_path_rule_paths" {
...
/*variable "compute_url_map_path_rule_service" {
...
/*variable "compute_url_map_cors_policy_max_age" {
  description = "(Optional)" #Specifies how long the results of a preflight request can be cached. This translates to the content for the Access-Control-Max-Age header.
  type = number
}*/
...
variable "compute_url_map_abort_percentage" {
  description = "(Required)" #The percentage of traffic (connections/operations/requests) which will be aborted as part of fault injection. The value must be between 0.0 and 100.0 inclusive.
  type = number
}

variable "compute_url_map_delay_percentage" {
  description = "(Required)" #The percentage of traffic (connections/operations/requests) on which delay will be introduced as part of fault injection. The value must be between 0.0 and 100.0 inclusive.
  type = number
}
...
/*variable "compute_url_map_url_redirect_host_redirect" {
  description = "(Optional)" #The host that will be used in the redirect response instead of the one that was supplied in the request. The value must be between 1 and 255 characters.
  type = string
}*/

/*variable "compute_url_map_url_redirect_https_redirect" {
  description = "(Optional)" #If set to true, the URL scheme in the redirected request is set to https. If set to false, the URL scheme of the redirected request will remain the same as that of the request. This must only be set for UrlMaps used in TargetHttpProxys. Setting this true for TargetHttpsProxy is not permitted. The default is set to false.
  type = bool
}*/

/*variable "compute_url_map_url_redirect_path_redirect" {
  description = "(Optional)" #The path that will be used in the redirect response instead of the one that was supplied in the request. pathRedirect cannot be supplied together with prefixRedirect. Supply one alone or neither. If neither is supplied, the path of the original request will be used for the redirect. The value must be between 1 and 1024 characters.
  type = string
}*/

/*variable "compute_url_map_url_redirect_prefix_redirect" {
  description = "(Optional)" #The prefix that replaces the prefixMatch specified in the HttpRouteRuleMatch, retaining the remaining portion of the URL before redirecting the request. prefixRedirect cannot be supplied together with pathRedirect. Supply one alone or neither. If neither is supplied, the path of the original request will be used for the redirect. The value must be between 1 and 1024 characters.
  type = string
}*/

/*variable "compute_url_map_url_redirect_redirect_response_code" {
  description = "(Optional)" #The HTTP Status code to use for this RedirectAction. Supported values are:   MOVED_PERMANENTLY_DEFAULT, which is the default value and corresponds to 301.   FOUND, which corresponds to 302.   SEE_OTHER which corresponds to 303.   TEMPORARY_REDIRECT, which corresponds to 307. In this case, the request method will be retained.   PERMANENT_REDIRECT, which corresponds to 308. In this case, the request method will be retained. Possible values: ["FOUND", "MOVED_PERMANENTLY_DEFAULT", "PERMANENT_REDIRECT", "SEE_OTHER", "TEMPORARY_REDIRECT"]
  type = string
}*/

variable "compute_url_map_url_redirect_strip_query" {
  description = "(Required)" #If set to true, any accompanying query portion of the original URL is removed prior to redirecting the request. If set to false, the query portion of the original URL is retained.  This field is required to ensure an empty block is not set. The normal default value is false.
  type = bool
}

variable "compute_url_map_route_rules_priority" {
...
/*variable "compute_url_map_route_rules_service" {
...
/*variable "compute_url_map_match_rules_full_path_match" {
...
/*variable "compute_url_map_match_rules_regex_match" {
...
/*variable "compute_url_map_header_matches_exact_match" {
...
variable "compute_url_map_header_matches_header_name" {
...
/*variable "compute_url_map_header_matches_invert_match" {
...
/*variable "compute_url_map_header_matches_prefix_match" {
...
/*variable "compute_url_map_header_matches_present_match" {
...
/*variable "compute_url_map_header_matches_regex_match" {
...
/*variable "compute_url_map_header_matches_suffix_match" {
  description = "(Optional)" #The value of the header must end with the contents of suffixMatch. Only one of exactMatch, prefixMatch, suffixMatch, regexMatch, presentMatch or rangeMatch must be set.
  type = string
}*/

variable "compute_url_map_range_match_range_end" {
  description = "(Required)" #The end of the range (exclusive).
  type = number
}

variable "compute_url_map_range_match_range_start" {
  description = "(Required)" #The start of the range (inclusive).
  type = number
}

variable "compute_url_map_metadata_filters_filter_match_criteria" {
  description = "(Required)" #Specifies how individual filterLabel matches within the list of filterLabels contribute towards the overall metadataFilter match. Supported values are:   - MATCH_ANY: At least one of the filterLabels must have a matching label in the provided metadata.   - MATCH_ALL: All filterLabels must have matching labels in the provided metadata. Possible values: ["MATCH_ALL", "MATCH_ANY"]
  type = string
}

variable "compute_url_map_filter_labels_name" {
...
variable "compute_url_map_filter_labels_value" {
...
/*variable "compute_url_map_query_parameter_matches_exact_match" {
...
variable "compute_url_map_query_parameter_matches_name" {
...
/*variable "compute_url_map_query_parameter_matches_present_match" {
...
/*variable "compute_url_map_query_parameter_matches_regex_match" {
  description = "(Optional)" #The queryParameterMatch matches if the value of the parameter matches the regular expression specified by regexMatch. For the regular expression grammar, please see en.cppreference.com/w/cpp/regex/ecmascript  Only one of presentMatch, exactMatch and regexMatch must be set.
  type = string
}*/
...
/*variable "compute_url_map_url_redirect_strip_query" {
  description = "(Optional)" #If set to true, any accompanying query portion of the original URL is removed prior to redirecting the request. If set to false, the query portion of the original URL is retained. Defaults to false.
  type = bool
}*/

/*variable "compute_url_map_test_description" {
  description = "(Optional)" #Description of this test case.
  type = string
}*/

variable "compute_url_map_test_host" {
  description = "(Required)" #Host portion of the URL.
  type = string
}

variable "compute_url_map_test_path" {
  description = "(Required)" #Path portion of the URL.
  type = string
}

variable "compute_url_map_test_service" {
  description = "(Required)" #The backend service or backend bucket link that should be matched by this test.
  type = string
}

/*variable "compute_url_map_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "compute_url_map_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "compute_url_map_timeouts_update" {
