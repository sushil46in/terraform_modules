...
output "service_account_iam_binding_condition_expression" {
  value = google_service_account_iam_binding.resname.condition_expression
}

output "service_account_iam_binding_condition_title" {
  value = google_service_account_iam_binding.resname.condition_title
}
