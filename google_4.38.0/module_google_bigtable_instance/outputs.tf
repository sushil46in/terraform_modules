...
output "bigtable_instance_cluster_kms_key_name" {
  value = google_bigtable_instance.resname.kms_key_name
}

output "bigtable_instance_cluster_num_nodes" {
  value = google_bigtable_instance.resname.num_nodes
}

output "bigtable_instance_cluster_zone" {
  value = google_bigtable_instance.resname.zone
}

output "bigtable_instance_cluster" {
  value = google_bigtable_instance.resname.cluster
}

output "bigtable_instance_autoscaling_config_storage_target" {
  value = google_bigtable_instance.resname.storage_target
}
