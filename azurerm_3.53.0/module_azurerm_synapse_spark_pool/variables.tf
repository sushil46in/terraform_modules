...
/*variable "synapse_spark_pool_max_executors" {
  description = "(Optional)" #The value for max_executors
  type = number
}*/

/*variable "synapse_spark_pool_min_executors" {
  description = "(Optional)" #The value for min_executors
  type = number
}*/
