...
/*variable "site_recovery_replicated_vm_multi_vm_group_name" {
  description = "(Optional)" #The value for multi_vm_group_name
  type = string
}*/
...
/*variable "site_recovery_replicated_vm_target_boot_diagnostic_storage_account_id" {
  description = "(Optional)" #The value for target_boot_diagnostic_storage_account_id
  type = string
}*/

/*variable "site_recovery_replicated_vm_target_capacity_reservation_group_id" {
  description = "(Optional)" #The value for target_capacity_reservation_group_id
  type = string
}*/

/*variable "site_recovery_replicated_vm_target_edge_zone" {
  description = "(Optional)" #The value for target_edge_zone
  type = string
}*/

/*variable "site_recovery_replicated_vm_target_proximity_placement_group_id" {
  description = "(Optional)" #The value for target_proximity_placement_group_id
  type = string
}*/
...
/*variable "site_recovery_replicated_vm_target_virtual_machine_scale_set_id" {
  description = "(Optional)" #The value for target_virtual_machine_scale_set_id
  type = string
}*/
...
/*variable "site_recovery_replicated_vm_unmanaged_disk" {
  description = "(Optional)" #The value for unmanaged_disk
  type = set
}*/
