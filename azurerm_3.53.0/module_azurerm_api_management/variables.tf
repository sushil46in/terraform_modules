...
/*variable "api_management_additional_location_gateway_disabled" {
  description = "(Optional)" #The value for additional_location_gateway_disabled
  type = bool
}*/
...
/*variable "api_management_delegation_subscriptions_enabled" {
  description = "(Optional)" #The value for delegation_subscriptions_enabled
  type = bool
}*/

/*variable "api_management_delegation_url" {
  description = "(Optional)" #The value for delegation_url
  type = string
}*/

/*variable "api_management_delegation_user_registration_enabled" {
  description = "(Optional)" #The value for delegation_user_registration_enabled
  type = bool
}*/

/*variable "api_management_delegation_validation_key" {
  description = "(Optional)" #The value for delegation_validation_key
  type = string
}*/
...
/*variable "api_management_security_tls_rsa_with_aes256_gcm_sha384_ciphers_enabled" {
  description = "(Optional)" #The value for security_tls_rsa_with_aes256_gcm_sha384_ciphers_enabled
  type = bool
}*/
