...
resource "azurerm_lighthouse_definition" "resname" {
  ...
  eligible_authorization {
    #principal_display_name = var.lighthouse_definition_eligible_authorization_principal_display_name
    principal_id = var.lighthouse_definition_eligible_authorization_principal_id
    role_definition_id = var.lighthouse_definition_eligible_authorization_role_definition_id
    just_in_time_access_policy {
      #maximum_activation_duration = var.lighthouse_definition_just_in_time_access_policy_maximum_activation_duration
      #multi_factor_auth_provider = var.lighthouse_definition_just_in_time_access_policy_multi_factor_auth_provider
      approver {
        #principal_display_name = var.lighthouse_definition_approver_principal_display_name
        principal_id = var.lighthouse_definition_approver_principal_id
      }
    }
  }
