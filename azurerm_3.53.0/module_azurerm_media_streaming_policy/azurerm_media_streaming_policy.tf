...
resource "azurerm_media_streaming_policy" "resname" {
  ...
  common_encryption_cbcs {
    clear_key_encryption {
      custom_keys_acquisition_url_template = var.media_streaming_policy_clear_key_encryption_custom_keys_acquisition_url_template
    }
    default_content_key {
  ...
  common_encryption_cenc {
    ...
    clear_track {
      condition {
        operation = var.media_streaming_policy_condition_operation
        property = var.media_streaming_policy_condition_property
        value = var.media_streaming_policy_condition_value
      }
    }
    content_key_to_track_mapping {
      #label = var.media_streaming_policy_content_key_to_track_mapping_label
      #policy_name = var.media_streaming_policy_content_key_to_track_mapping_policy_name
      track {
        condition {
          operation = var.media_streaming_policy_condition_operation
          property = var.media_streaming_policy_condition_property
  ...
  envelope_encryption {
    #custom_keys_acquisition_url_template = var.media_streaming_policy_envelope_encryption_custom_keys_acquisition_url_template
    default_content_key {
      #label = var.media_streaming_policy_default_content_key_label
      #policy_name = var.media_streaming_policy_default_content_key_policy_name
    }
