...
/*variable "storage_account_allowed_copy_scope" {
  description = "(Optional)" #The value for allowed_copy_scope
  type = string
}*/
...
/*variable "storage_account_sftp_enabled" {
  description = "(Optional)" #The value for sftp_enabled
  type = bool
}*/
...
variable "storage_account_restore_policy_days" {
  description = "(Required)" #The value for restore_policy_days
  type = number
}
...
variable "storage_account_immutability_policy_allow_protected_append_writes" {
  description = "(Required)" #The value for immutability_policy_allow_protected_append_writes
  type = bool
}

variable "storage_account_immutability_policy_period_since_creation_in_days" {
  description = "(Required)" #The value for immutability_policy_period_since_creation_in_days
  type = number
}

variable "storage_account_immutability_policy_state" {
  description = "(Required)" #The value for immutability_policy_state
  type = string
}
...
/*variable "storage_account_sas_policy_expiration_action" {
  description = "(Optional)" #The value for sas_policy_expiration_action
  type = string
}*/

variable "storage_account_sas_policy_expiration_period" {
  description = "(Required)" #The value for sas_policy_expiration_period
  type = string
}
...
/*variable "storage_account_smb_multichannel_enabled" {
  description = "(Optional)" #The value for smb_multichannel_enabled
  type = bool
}*/
