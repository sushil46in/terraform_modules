...
resource "azurerm_express_route_connection" "resname" {
  ...
  #express_route_gateway_bypass_enabled = var.express_route_connection_express_route_gateway_bypass_enabled
  ...
  routing {
    #inbound_route_map_id = var.express_route_connection_routing_inbound_route_map_id
    #outbound_route_map_id = var.express_route_connection_routing_outbound_route_map_id
