...
/*variable "snapshot_incremental_enabled" {
  description = "(Optional)" #The value for incremental_enabled
  type = bool
}*/
...
/*variable "snapshot_encryption_settings_enabled" {
  description = "(Optional)" #The value for encryption_settings_enabled
  type = bool
}*/
