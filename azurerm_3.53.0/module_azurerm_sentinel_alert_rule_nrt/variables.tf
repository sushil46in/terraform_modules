...
/*variable "sentinel_alert_rule_nrt_techniques" {
...
variable "sentinel_alert_rule_nrt_dynamic_property_name" {
  description = "(Required)" #The value for dynamic_property_name
  type = string
}

variable "sentinel_alert_rule_nrt_dynamic_property_value" {
  description = "(Required)" #The value for dynamic_property_value
  type = string
}
...
variable "sentinel_alert_rule_nrt_event_grouping_aggregation_method" {
...
variable "sentinel_alert_rule_nrt_sentinel_entity_mapping_column_name" {
  description = "(Required)" #The value for sentinel_entity_mapping_column_name
  type = string
}
