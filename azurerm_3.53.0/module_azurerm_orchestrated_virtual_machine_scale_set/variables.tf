...
variable "orchestrated_virtual_machine_scale_set_protected_settings_from_key_vault_secret_url" {
  description = "(Required)" #The value for protected_settings_from_key_vault_secret_url
  type = string
}

variable "orchestrated_virtual_machine_scale_set_protected_settings_from_key_vault_source_vault_id" {
...
/*variable "orchestrated_virtual_machine_scale_set_priority_mix_base_regular_count" {
  description = "(Optional)" #The value for priority_mix_base_regular_count
  type = number
}*/

/*variable "orchestrated_virtual_machine_scale_set_priority_mix_regular_percentage_above_base" {
  description = "(Optional)" #The value for priority_mix_regular_percentage_above_base
  type = number
}*/
