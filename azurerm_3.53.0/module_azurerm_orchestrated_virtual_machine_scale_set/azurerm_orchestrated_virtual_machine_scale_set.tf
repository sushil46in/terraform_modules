...
resource "azurerm_orchestrated_virtual_machine_scale_set" "resname" {
  ...
  extension {
    ...
    protected_settings_from_key_vault {
      secret_url = var.orchestrated_virtual_machine_scale_set_protected_settings_from_key_vault_secret_url
      source_vault_id = var.orchestrated_virtual_machine_scale_set_protected_settings_from_key_vault_source_vault_id
    }
  }
  ...
  priority_mix {
    #base_regular_count = var.orchestrated_virtual_machine_scale_set_priority_mix_base_regular_count
    #regular_percentage_above_base = var.orchestrated_virtual_machine_scale_set_priority_mix_regular_percentage_above_base
  }
