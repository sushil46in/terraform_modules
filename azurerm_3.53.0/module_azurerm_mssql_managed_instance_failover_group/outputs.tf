...
output "mssql_managed_instance_failover_group_read_write_endpoint_failover_policy" {
  value = azurerm_mssql_managed_instance_failover_group.resname.read_write_endpoint_failover_policy
}
