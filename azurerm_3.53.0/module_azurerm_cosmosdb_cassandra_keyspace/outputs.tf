...
output "cosmosdb_cassandra_keyspace_autoscale_settings_max_throughput" {
  value = azurerm_cosmosdb_cassandra_keyspace.resname.max_throughput
}

output "cosmosdb_cassandra_keyspace_autoscale_settings" {
  value = azurerm_cosmosdb_cassandra_keyspace.resname.autoscale_settings
}
