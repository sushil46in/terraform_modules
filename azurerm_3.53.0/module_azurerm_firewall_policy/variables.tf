...
/*variable "firewall_policy_auto_learn_private_ranges_enabled" {
  description = "(Optional)" #The value for auto_learn_private_ranges_enabled
  type = bool
}*/
...
/*variable "firewall_policy_explicit_proxy_enable_pac_file" {
  description = "(Optional)" #The value for explicit_proxy_enable_pac_file
  type = bool
}*/

/*variable "firewall_policy_explicit_proxy_enabled" {
  description = "(Optional)" #The value for explicit_proxy_enabled
  type = bool
}*/

/*variable "firewall_policy_explicit_proxy_http_port" {
  description = "(Optional)" #The value for explicit_proxy_http_port
  type = number
}*/

/*variable "firewall_policy_explicit_proxy_https_port" {
  description = "(Optional)" #The value for explicit_proxy_https_port
  type = number
}*/

/*variable "firewall_policy_explicit_proxy_pac_file" {
  description = "(Optional)" #The value for explicit_proxy_pac_file
  type = string
}*/

/*variable "firewall_policy_explicit_proxy_pac_file_port" {
  description = "(Optional)" #The value for explicit_proxy_pac_file_port
  type = number
}*/
