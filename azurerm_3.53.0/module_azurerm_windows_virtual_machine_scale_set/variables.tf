...
/*variable "windows_virtual_machine_scale_set_capacity_reservation_group_id" {
...
/*variable "windows_virtual_machine_scale_set_edge_zone" {
...
/*variable "windows_virtual_machine_scale_set_eviction_policy" {
  description = "(Optional)" #The value for eviction_policy
  type = string
}*/

/*variable "windows_virtual_machine_scale_set_extensions_time_budget" {
...
/*variable "windows_virtual_machine_scale_set_host_group_id" {
...
/*variable "windows_virtual_machine_scale_set_max_bid_price" {
...
/*variable "windows_virtual_machine_scale_set_priority" {
...
/*variable "windows_virtual_machine_scale_set_proximity_placement_group_id" {
...
/*variable "windows_virtual_machine_scale_set_secure_boot_enabled" {
...
/*variable "windows_virtual_machine_scale_set_user_data" {
  description = "(Optional)" #The value for user_data
  type = string
}*/

/*variable "windows_virtual_machine_scale_set_vtpm_enabled" {
  description = "(Optional)" #The value for vtpm_enabled
  type = bool
}*/

/*variable "windows_virtual_machine_scale_set_zone_balance" {
  description = "(Optional)" #The value for zone_balance
  type = bool
}*/

/*variable "windows_virtual_machine_scale_set_zones" {
...
/*variable "windows_virtual_machine_scale_set_data_disk_name" {
...
variable "windows_virtual_machine_scale_set_protected_settings_from_key_vault_secret_url" {
  description = "(Required)" #The value for protected_settings_from_key_vault_secret_url
  type = string
}

variable "windows_virtual_machine_scale_set_protected_settings_from_key_vault_source_vault_id" {
  description = "(Required)" #The value for protected_settings_from_key_vault_source_vault_id
  type = string
}

/*variable "windows_virtual_machine_scale_set_gallery_application_configuration_blob_uri" {
  description = "(Optional)" #The value for gallery_application_configuration_blob_uri
  type = string
}*/

/*variable "windows_virtual_machine_scale_set_gallery_application_order" {
  description = "(Optional)" #The value for gallery_application_order
  type = number
}*/

/*variable "windows_virtual_machine_scale_set_gallery_application_tag" {
  description = "(Optional)" #The value for gallery_application_tag
  type = string
}*/

variable "windows_virtual_machine_scale_set_gallery_application_version_id" {
  description = "(Required)" #The value for gallery_application_version_id
  type = string
}

/*variable "windows_virtual_machine_scale_set_gallery_applications_configuration_reference_blob_uri" {
  description = "(Optional)" #The value for gallery_applications_configuration_reference_blob_uri
  type = string
}*/

/*variable "windows_virtual_machine_scale_set_gallery_applications_order" {
  description = "(Optional)" #The value for gallery_applications_order
  type = number
}*/

variable "windows_virtual_machine_scale_set_gallery_applications_package_reference_id" {
  description = "(Required)" #The value for gallery_applications_package_reference_id
  type = string
}

/*variable "windows_virtual_machine_scale_set_gallery_applications_tag" {
  description = "(Optional)" #The value for gallery_applications_tag
  type = string
}*/

/*variable "windows_virtual_machine_scale_set_identity_identity_ids" {
  description = "(Optional)" #The value for identity_identity_ids
  type = set
}*/

variable "windows_virtual_machine_scale_set_identity_type" {
...
/*variable "windows_virtual_machine_scale_set_network_interface_enable_accelerated_networking" {
...
/*variable "windows_virtual_machine_scale_set_ip_configuration_application_gateway_backend_address_pool_ids" {
  description = "(Optional)" #The value for ip_configuration_application_gateway_backend_address_pool_ids
  type = set
}*/

/*variable "windows_virtual_machine_scale_set_ip_configuration_application_security_group_ids" {
...
/*variable "windows_virtual_machine_scale_set_public_ip_address_domain_name_label" {
  description = "(Optional)" #The value for public_ip_address_domain_name_label
  type = string
}*/

variable "windows_virtual_machine_scale_set_public_ip_address_name" {
  description = "(Required)" #The value for public_ip_address_name
  type = string
}

/*variable "windows_virtual_machine_scale_set_public_ip_address_public_ip_prefix_id" {
  description = "(Optional)" #The value for public_ip_address_public_ip_prefix_id
  type = string
}*/

/*variable "windows_virtual_machine_scale_set_public_ip_address_version" {
  description = "(Optional)" #The value for public_ip_address_version
  type = string
}*/

variable "windows_virtual_machine_scale_set_ip_tag_tag" {
  description = "(Required)" #The value for ip_tag_tag
  type = string
}

variable "windows_virtual_machine_scale_set_ip_tag_type" {
...
/*variable "windows_virtual_machine_scale_set_os_disk_secure_vm_disk_encryption_set_id" {
  description = "(Optional)" #The value for os_disk_secure_vm_disk_encryption_set_id
  type = string
}*/

/*variable "windows_virtual_machine_scale_set_os_disk_security_encryption_type" {
...
/*variable "windows_virtual_machine_scale_set_diff_disk_settings_placement" {
...
/*variable "windows_virtual_machine_scale_set_rolling_upgrade_policy_cross_zone_upgrades_enabled" {
  description = "(Optional)" #The value for rolling_upgrade_policy_cross_zone_upgrades_enabled
  type = bool
}*/

variable "windows_virtual_machine_scale_set_rolling_upgrade_policy_max_batch_instance_percent" {
  description = "(Required)" #The value for rolling_upgrade_policy_max_batch_instance_percent
  type = number
}

variable "windows_virtual_machine_scale_set_rolling_upgrade_policy_max_unhealthy_instance_percent" {
  description = "(Required)" #The value for rolling_upgrade_policy_max_unhealthy_instance_percent
  type = number
}

variable "windows_virtual_machine_scale_set_rolling_upgrade_policy_max_unhealthy_upgraded_instance_percent" {
  description = "(Required)" #The value for rolling_upgrade_policy_max_unhealthy_upgraded_instance_percent
  type = number
}

variable "windows_virtual_machine_scale_set_rolling_upgrade_policy_pause_time_between_batches" {
  description = "(Required)" #The value for rolling_upgrade_policy_pause_time_between_batches
  type = string
}

/*variable "windows_virtual_machine_scale_set_rolling_upgrade_policy_prioritize_unhealthy_instances_enabled" {
  description = "(Optional)" #The value for rolling_upgrade_policy_prioritize_unhealthy_instances_enabled
  type = bool
}*/

/*variable "windows_virtual_machine_scale_set_scale_in_force_deletion_enabled" {
  description = "(Optional)" #The value for scale_in_force_deletion_enabled
  type = bool
}*/

/*variable "windows_virtual_machine_scale_set_scale_in_rule" {
...
variable "windows_virtual_machine_scale_set_certificate_url" {
...
/*variable "windows_virtual_machine_scale_set_spot_restore_enabled" {
  description = "(Optional)" #The value for spot_restore_enabled
  type = bool
}*/

/*variable "windows_virtual_machine_scale_set_spot_restore_timeout" {
...
variable "windows_virtual_machine_scale_set_termination_notification_enabled" {
  description = "(Required)" #The value for termination_notification_enabled
  type = bool
}

/*variable "windows_virtual_machine_scale_set_termination_notification_timeout" {
...
/*variable "windows_virtual_machine_scale_set_winrm_listener_certificate_url" {
