...
/*variable "api_management_api_terms_of_service_url" {
  description = "(Optional)" #The value for terms_of_service_url
  type = string
}*/
...
/*variable "api_management_api_contact_email" {
  description = "(Optional)" #The value for contact_email
  type = string
}*/

/*variable "api_management_api_contact_name" {
  description = "(Optional)" #The value for contact_name
  type = string
}*/

/*variable "api_management_api_contact_url" {
  description = "(Optional)" #The value for contact_url
  type = string
}*/
...
/*variable "api_management_api_license_name" {
  description = "(Optional)" #The value for license_name
  type = string
}*/

/*variable "api_management_api_license_url" {
  description = "(Optional)" #The value for license_url
  type = string
}*/
