...
/*variable "cdn_frontdoor_rule_route_configuration_override_action_cache_duration" {
  description = "(Optional)" #The value for route_configuration_override_action_cache_duration
  type = string
}*/

/*variable "cdn_frontdoor_rule_route_configuration_override_action_cdn_frontdoor_origin_group_id" {
  description = "(Optional)" #The value for route_configuration_override_action_cdn_frontdoor_origin_group_id
  type = string
}*/
