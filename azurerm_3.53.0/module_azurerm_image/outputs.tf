...
output "image_data_disk_blob_uri" {
  value = azurerm_image.resname.blob_uri
}

output "image_data_disk_size_gb" {
  value = azurerm_image.resname.size_gb
}

output "image_data_disk" {
  value = azurerm_image.resname.data_disk
}
...
output "image_os_disk_managed_disk_id" {
  value = azurerm_image.resname.managed_disk_id
}
...
output "image_os_disk" {
  value = azurerm_image.resname.os_disk
}
