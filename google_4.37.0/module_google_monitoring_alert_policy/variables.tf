...
variable "monitoring_alert_policy_combiner" {
  description = "(Required) 'How to combine the results of multiple conditions to determine if an incident should be opened. Possible values: ["AND", "OR", "AND_WITH_MATCHING_RESOURCE"]'"
  type = string
}
...
/*variable "monitoring_alert_policy_trigger_count" {
  description = "(Optional) 'The absolute number of time series that must fail the predicate for the condition to be triggered.'"
  type = number
}*/
...
/*variable "monitoring_alert_policy_condition_monitoring_query_language_evaluation_missing_data" {
  description = "(Optional) 'A condition control that determines how metric-threshold conditions are evaluated when data stops arriving. Possible values: ["EVALUATION_MISSING_DATA_INACTIVE", "EVALUATION_MISSING_DATA_ACTIVE", "EVALUATION_MISSING_DATA_NO_OP"]'"
  type = string
}*/
