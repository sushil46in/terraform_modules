...
/*variable "compute_disk_disk_encryption_key_kms_key_self_link" {
  description = "(Optional) The self link of the encryption key used to encrypt the disk. Also called KmsKeyName
...
/*variable "compute_disk_disk_encryption_key_kms_key_service_account" {
  description = "(Optional) The service account used for the encryption request for the given KMS key.
If absent, the Compute Engine Service Agent service account is used."
  type = string
}*/

/*variable "compute_disk_disk_encryption_key_raw_key" {
  description = "(Optional) Specifies a 256-bit customer-supplied encryption key, encoded in
