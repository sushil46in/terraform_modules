...
variable "certificate_manager_certificate_map_entry_certificates" {
  description = "(Required) A set of Certificates defines for the given hostname.
...
/*variable "certificate_manager_certificate_map_entry_hostname" {
  description = "(Optional) A Hostname (FQDN, e.g. example.com) or a wildcard hostname expression (*.example.com)
...
variable "certificate_manager_certificate_map_entry_name" {
  description = "(Required) A user-defined name of the Certificate Map Entry. Certificate Map Entry 
