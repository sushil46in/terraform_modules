...
/*variable "compute_router_nat_subnetwork_secondary_ip_range_names" {
  description = "(Optional) List of the secondary ranges of the subnetwork that are allowed
...
variable "compute_router_nat_subnetwork_source_ip_ranges_to_nat" {
  description = "(Required) List of options for which source IPs in the subnetwork
