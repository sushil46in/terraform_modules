...
variable "tags_tag_key_iam_binding_members" {
  description = "(Required) The value for members"
  type = set
}

variable "tags_tag_key_iam_binding_role" {
  description = "(Required) The value for role"
  type = string
}

variable "tags_tag_key_iam_binding_tag_key" {
  description = "(Required) The value for tag_key"
  type = string
}

/*variable "tags_tag_key_iam_binding_condition_description" {
  description = "(Optional) The value for condition_description"
  type = string
}*/

variable "tags_tag_key_iam_binding_condition_expression" {
  description = "(Required) The value for condition_expression"
  type = string
}

variable "tags_tag_key_iam_binding_condition_title" {
