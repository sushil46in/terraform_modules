...
/*variable "dialogflow_cx_intent_is_fallback" {
  description = "(Optional) Indicates whether this is a fallback intent. Currently only default fallback intent is allowed in the agent, which is added upon agent creation.
...
/*variable "dialogflow_cx_intent_language_code" {
  description = "(Optional) The language of the following fields in intent:
...
/*variable "dialogflow_cx_intent_parent" {
  description = "(Optional) The agent to create an intent for.
...
variable "dialogflow_cx_intent_parameters_entity_type" {
  description = "(Required) The entity type of the parameter.
...
/*variable "dialogflow_cx_intent_parameters_redact" {
  description = "(Optional) Indicates whether the parameter content should be redacted in log. If redaction is enabled, the parameter content will be replaced by parameter name during logging.
