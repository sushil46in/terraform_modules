...
variable "game_services_game_server_config_fleet_configs_fleet_spec" {
  description = "(Required) The fleet spec, which is sent to Agones to configure fleet.
...
/*variable "game_services_game_server_config_schedules_cron_job_duration" {
  description = "(Optional) The duration for the cron job event. The duration of the event is effective
...
/*variable "game_services_game_server_config_schedules_cron_spec" {
  description = "(Optional) The cron definition of the scheduled event. See
...
/*variable "game_services_game_server_config_schedules_end_time" {
  description = "(Optional) The end time of the event.
...
/*variable "game_services_game_server_config_schedules_start_time" {
  description = "(Optional) The start time of the event.
