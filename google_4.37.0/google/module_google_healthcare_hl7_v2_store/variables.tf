...
variable "healthcare_hl7_v2_store_notification_config_pubsub_topic" {
  description = "(Required) The Cloud Pub/Sub topic that notifications of changes are published on. Supplied by the client.
...
/*variable "healthcare_hl7_v2_store_notification_configs_filter" {
  description = "(Optional) Restricts notifications sent for messages matching a filter. If this is empty, all messages
...
/*variable "healthcare_hl7_v2_store_parser_config_schema" {
  description = "(Optional) JSON encoded string for schemas used to parse messages in this
store if schematized parsing is desired."
  type = string
}*/

/*variable "healthcare_hl7_v2_store_parser_config_segment_terminator" {
  description = "(Optional) Byte(s) to be used as the segment terminator. If this is unset, '\r' will be used as segment terminator.
