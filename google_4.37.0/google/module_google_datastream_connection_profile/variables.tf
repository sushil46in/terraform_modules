...
/*variable "datastream_connection_profile_ssl_config_ca_certificate" {
  description = "(Optional) PEM-encoded certificate of the CA that signed the source database
server's certificate."
  type = string
}*/

/*variable "datastream_connection_profile_ssl_config_client_certificate" {
  description = "(Optional) PEM-encoded certificate that will be used by the replica to
...
/*variable "datastream_connection_profile_ssl_config_client_key" {
  description = "(Optional) PEM-encoded private key associated with the Client Certificate.
