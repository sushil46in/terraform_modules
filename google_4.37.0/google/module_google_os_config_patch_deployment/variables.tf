...
/*variable "os_config_patch_deployment_instance_filter_instance_name_prefixes" {
  description = "(Optional) Targets VMs whose name starts with one of these prefixes. Similar to labels, this is another way to group
VMs when targeting configs, for example prefix="prod-"."
  type = list
}*/

/*variable "os_config_patch_deployment_instance_filter_instances" {
  description = "(Optional) Targets any of the VM instances specified. Instances are specified by their URI in the 'form zones/{{zone}}/instances/{{instance_name}}',
...
variable "os_config_patch_deployment_one_time_schedule_execute_time" {
  description = "(Required) The desired patch job execution time. A timestamp in RFC3339 UTC "Zulu" format,
...
/*variable "os_config_patch_deployment_apt_exclusive_packages" {
  description = "(Optional) An exclusive list of packages to be updated. These are the only packages that will be updated.
...
/*variable "os_config_patch_deployment_linux_exec_step_config_interpreter" {
  description = "(Optional) The script interpreter to use to run the script. If no interpreter is specified the script will
...
/*variable "os_config_patch_deployment_windows_update_exclusive_patches" {
  description = "(Optional) An exclusive list of kbs to be updated. These are the only patches that will be updated.
...
/*variable "os_config_patch_deployment_zypper_exclusive_patches" {
  description = "(Optional) An exclusive list of patches to be updated. These are the only patches that will be installed using 'zypper patch patch:' command.
...
/*variable "os_config_patch_deployment_recurring_schedule_start_time" {
  description = "(Optional) The time that the recurring schedule becomes effective. Defaults to createTime of the patch deployment.
A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z"."
  type = string
}*/

/*variable "os_config_patch_deployment_monthly_month_day" {
  description = "(Optional) One day of the month. 1-31 indicates the 1st to the 31st day. -1 indicates the last day of the month.
