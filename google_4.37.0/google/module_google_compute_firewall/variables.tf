...
/*variable "compute_firewall_allow_ports" {
  description = "(Optional) An optional list of ports to which this rule applies. This field
...
variable "compute_firewall_allow_protocol" {
  description = "(Required) The IP protocol to which this rule applies. The protocol type is
