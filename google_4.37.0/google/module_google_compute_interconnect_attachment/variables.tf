...
/*variable "compute_interconnect_attachment_encryption" {
  description = "(Optional) Indicates the user-supplied encryption option of this interconnect
attachment:
...
/*variable "compute_interconnect_attachment_ipsec_internal_addresses" {
  description = "(Optional) URL of addresses that have been reserved for the interconnect
