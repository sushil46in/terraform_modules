...
/*variable "dialogflow_cx_entity_type_auto_expansion_mode" {
  description = "(Optional) Represents kinds of entities.
...
variable "dialogflow_cx_entity_type_kind" {
  description = "(Required) Indicates whether the entity type can be automatically expanded.
...
/*variable "dialogflow_cx_entity_type_language_code" {
  description = "(Optional) The language of the following fields in entityType:
...
/*variable "dialogflow_cx_entity_type_parent" {
  description = "(Optional) The agent to create a entity type for.
...
/*variable "dialogflow_cx_entity_type_entities_synonyms" {
  description = "(Optional) A collection of value synonyms. For example, if the entity type is vegetable, and value is scallions, a synonym could be green onions.
For KIND_LIST entity types: This collection must contain exactly one synonym equal to value."
  type = list
}*/

/*variable "dialogflow_cx_entity_type_entities_value" {
  description = "(Optional) The primary value associated with this entity entry. For example, if the entity type is vegetable, the value could be scallions.
