...
/*variable "compute_region_backend_service_backend_balancing_mode" {
  description = "(Optional) Specifies the balancing mode for this backend.
...
/*variable "compute_region_backend_service_backend_capacity_scaler" {
  description = "(Optional) A multiplier applied to the group's maximum servicing capacity
...
variable "compute_region_backend_service_backend_group" {
  description = "(Required) The fully-qualified URL of an Instance Group or Network Endpoint
...
/*variable "compute_region_backend_service_backend_max_connections" {
  description = "(Optional) The max number of simultaneous connections for the group. Can
...
/*variable "compute_region_backend_service_backend_max_connections_per_endpoint" {
  description = "(Optional) The max number of simultaneous connections that a single backend
...
/*variable "compute_region_backend_service_backend_max_connections_per_instance" {
  description = "(Optional) The max number of simultaneous connections that a single
...
/*variable "compute_region_backend_service_backend_max_rate" {
  description = "(Optional) The max requests per second (RPS) of the group. Cannot be set
for INTERNAL backend services.
...
/*variable "compute_region_backend_service_backend_max_rate_per_endpoint" {
  description = "(Optional) The max requests per second (RPS) that a single backend network
...
/*variable "compute_region_backend_service_backend_max_rate_per_instance" {
  description = "(Optional) The max requests per second (RPS) that a single backend
...
/*variable "compute_region_backend_service_backend_max_utilization" {
  description = "(Optional) Used when balancingMode is UTILIZATION. This ratio defines the
...
/*variable "compute_region_backend_service_cdn_policy_signed_url_cache_max_age_sec" {
  description = "(Optional) Maximum number of seconds the response to a signed URL request
...
/*variable "compute_region_backend_service_cache_key_policy_include_query_string" {
  description = "(Optional) If true, include query string parameters in the cache key
...
/*variable "compute_region_backend_service_cache_key_policy_query_string_blacklist" {
  description = "(Optional) Names of query string parameters to exclude in cache keys.
...
/*variable "compute_region_backend_service_cache_key_policy_query_string_whitelist" {
  description = "(Optional) Names of query string parameters to include in cache keys.
...
/*variable "compute_region_backend_service_negative_caching_policy_code" {
  description = "(Optional) The HTTP status code to define a TTL against. Only HTTP status codes 300, 301, 308, 404, 405, 410, 421, 451 and 501
can be specified as values, and you cannot specify a status code more than once."
  type = number
}*/

/*variable "compute_region_backend_service_circuit_breakers_max_connections" {
  description = "(Optional) The maximum number of connections to the backend cluster.
Defaults to 1024."
  type = number
}*/

/*variable "compute_region_backend_service_circuit_breakers_max_pending_requests" {
  description = "(Optional) The maximum number of pending requests to the backend cluster.
Defaults to 1024."
  type = number
}*/

/*variable "compute_region_backend_service_circuit_breakers_max_requests" {
  description = "(Optional) The maximum number of parallel requests to the backend cluster.
Defaults to 1024."
  type = number
}*/

/*variable "compute_region_backend_service_circuit_breakers_max_requests_per_connection" {
  description = "(Optional) Maximum requests for a single backend connection. This parameter
...
/*variable "compute_region_backend_service_circuit_breakers_max_retries" {
  description = "(Optional) The maximum number of parallel retries to the backend cluster.
Defaults to 3."
  type = number
}*/

/*variable "compute_region_backend_service_consistent_hash_http_header_name" {
  description = "(Optional) The hash based on the value of the specified header field.
This field is applicable if the sessionAffinity is set to HEADER_FIELD."
  type = string
}*/

/*variable "compute_region_backend_service_consistent_hash_minimum_ring_size" {
  description = "(Optional) The minimum number of virtual nodes to use for the hash ring.
...
/*variable "compute_region_backend_service_ttl_nanos" {
  description = "(Optional) Span of time that's a fraction of a second at nanosecond
...
variable "compute_region_backend_service_ttl_seconds" {
  description = "(Required) Span of time at a resolution of a second.
Must be from 0 to 315,576,000,000 inclusive."
  type = number
}

/*variable "compute_region_backend_service_failover_policy_disable_connection_drain_on_failover" {
  description = "(Optional) On failover or failback, this field indicates whether connection drain
...
/*variable "compute_region_backend_service_failover_policy_drop_traffic_if_unhealthy" {
  description = "(Optional) This option is used only when no healthy VMs are detected in the primary
...
/*variable "compute_region_backend_service_failover_policy_failover_ratio" {
  description = "(Optional) The value of the field must be in [0, 1]. If the ratio of the healthy
...
/*variable "compute_region_backend_service_log_config_sample_rate" {
  description = "(Optional) This field can only be specified if logging is enabled for this backend service. The value of
...
/*variable "compute_region_backend_service_outlier_detection_consecutive_errors" {
  description = "(Optional) Number of errors before a host is ejected from the connection pool. When the
...
/*variable "compute_region_backend_service_outlier_detection_consecutive_gateway_failure" {
  description = "(Optional) The number of consecutive gateway failures (502, 503, 504 status or connection
...
/*variable "compute_region_backend_service_outlier_detection_enforcing_consecutive_errors" {
  description = "(Optional) The percentage chance that a host will be actually ejected when an outlier
...
/*variable "compute_region_backend_service_outlier_detection_max_ejection_percent" {
  description = "(Optional) Maximum percentage of hosts in the load balancing pool for the backend service
that can be ejected. Defaults to 10%."
  type = number
}*/

/*variable "compute_region_backend_service_outlier_detection_success_rate_minimum_hosts" {
  description = "(Optional) The number of hosts in a cluster that must have enough request volume to detect
...
/*variable "compute_region_backend_service_outlier_detection_success_rate_request_volume" {
  description = "(Optional) The minimum number of total requests that must be collected in one interval (as
...
/*variable "compute_region_backend_service_outlier_detection_success_rate_stdev_factor" {
  description = "(Optional) This factor is used to determine the ejection threshold for success rate outlier
