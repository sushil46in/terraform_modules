...
variable "cloudfunctions2_function_name" {
  description = "(Required) A user-defined name of the function. Function names must
...
/*variable "cloudfunctions2_function_build_config_entry_point" {
  description = "(Optional) The name of the function (as defined in source code) that will be executed.
...
/*variable "cloudfunctions2_function_build_config_runtime" {
  description = "(Optional) The runtime in which to run the function. Required when deploying a new
...
/*variable "cloudfunctions2_function_repo_source_invert_regex" {
  description = "(Optional) Only trigger a build if the revision regex does 
NOT match the revision regex."
  type = bool
}*/

/*variable "cloudfunctions2_function_repo_source_project_id" {
  description = "(Optional) ID of the project that owns the Cloud Source Repository. If omitted, the 
...
/*variable "cloudfunctions2_function_storage_source_generation" {
  description = "(Optional) Google Cloud Storage generation for the object. If the generation 
...
/*variable "cloudfunctions2_function_event_trigger_retry_policy" {
  description = "(Optional) Describes the retry policy in case of function's execution failure.
Retried execution is charged as any other execution. Possible values: ["RETRY_POLICY_UNSPECIFIED", "RETRY_POLICY_DO_NOT_RETRY", "RETRY_POLICY_RETRY"]"
  type = string
}*/

/*variable "cloudfunctions2_function_event_trigger_trigger_region" {
  description = "(Optional) The region that the trigger will be in. The trigger will only receive
...
variable "cloudfunctions2_function_event_filters_attribute" {
  description = "(Required) 'Required. The name of a CloudEvents attribute.
...
/*variable "cloudfunctions2_function_event_filters_operator" {
  description = "(Optional) Optional. The operator used for matching the events with the value of
...
/*variable "cloudfunctions2_function_service_config_available_memory" {
  description = "(Optional) The amount of memory available for a function.
...
/*variable "cloudfunctions2_function_service_config_max_instance_count" {
  description = "(Optional) The limit on the maximum number of function instances that may coexist at a
given time."
  type = number
}*/

/*variable "cloudfunctions2_function_service_config_min_instance_count" {
  description = "(Optional) The limit on the minimum number of function instances that may coexist at a
given time."
  type = number
}*/

/*variable "cloudfunctions2_function_service_config_timeout_seconds" {
  description = "(Optional) The function execution timeout. Execution is considered failed and
