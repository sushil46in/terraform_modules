...
variable "storage_bucket_iam_binding_bucket" {
  description = "(Required) The value for bucket"
  type = string
}

variable "storage_bucket_iam_binding_members" {
...
/*variable "storage_bucket_iam_binding_condition_description" {
  description = "(Optional) The value for condition_description"
  type = string
}*/

variable "storage_bucket_iam_binding_condition_expression" {
  description = "(Required) The value for condition_expression"
  type = string
}

variable "storage_bucket_iam_binding_condition_title" {
