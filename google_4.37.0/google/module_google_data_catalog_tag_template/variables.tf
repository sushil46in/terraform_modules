...
/*variable "data_catalog_tag_template_fields_order" {
  description = "(Optional) The order of this field with respect to other fields in this tag template.
...
/*variable "data_catalog_tag_template_type_primitive_type" {
  description = "(Optional) Represents primitive types - string, bool etc.
