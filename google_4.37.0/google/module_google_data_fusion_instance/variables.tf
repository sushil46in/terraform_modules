...
variable "data_fusion_instance_network_config_ip_allocation" {
  description = "(Required) The IP range in CIDR notation to use for the managed Data Fusion instance
nodes. This range must not overlap with any other ranges used in the Data Fusion instance network."
  type = string
}

variable "data_fusion_instance_network_config_network" {
  description = "(Required) Name of the network in the project with which the tenant project
