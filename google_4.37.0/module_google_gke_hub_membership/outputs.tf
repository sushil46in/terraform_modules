...
output "gke_hub_membership_authority_issuer" {
  value = google_gke_hub_membership.resname.authority_issuer
}

output "gke_hub_membership_gke_cluster_resource_link" {
  value = google_gke_hub_membership.resname.gke_cluster_resource_link
}
