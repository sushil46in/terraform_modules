...
/*variable "monitoring_slo_basic_sli_location" {
  description = "(Optional) An optional set of locations to which this SLI is relevant.
...
/*variable "monitoring_slo_basic_sli_method" {
  description = "(Optional) An optional set of RPCs to which this SLI is relevant.
...
/*variable "monitoring_slo_basic_sli_version" {
  description = "(Optional) The set of API versions to which this SLI is relevant.
...
/*variable "monitoring_slo_range_max" {
  description = "(Optional) max value for the range (inclusive). If not given,
...
/*variable "monitoring_slo_range_min" {
  description = "(Optional) Min value for the range (inclusive). If not given,
will be set to "-infinity", defining an open range
"< range.max""
  type = number
}*/
...
/*variable "monitoring_slo_good_total_ratio_bad_service_filter" {
  description = "(Optional) A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
...
/*variable "monitoring_slo_windows_based_sli_window_period" {
  description = "(Optional) Duration over which window quality is evaluated, given as a
...
/*variable "monitoring_slo_good_total_ratio_threshold_threshold" {
  description = "(Optional) If window performance >= threshold, the window is counted
as good."
  type = number
}*/
...
variable "monitoring_slo_metric_mean_in_range_time_series" {
  description = "(Required) A [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
