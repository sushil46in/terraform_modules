...
variable "compute_service_attachment_connection_preference" {
  description = "(Required) The connection preference to use for this service attachment. Valid
values include "ACCEPT_AUTOMATIC", "ACCEPT_MANUAL"."
  type = string
}

/*variable "compute_service_attachment_consumer_reject_lists" {
  description = "(Optional) An array of projects that are not allowed to connect to this service
attachment."
  type = list
}*/
...
/*variable "compute_service_attachment_domain_names" {
  description = "(Optional) If specified, the domain name will be used during the integration between
...
variable "compute_service_attachment_enable_proxy_protocol" {
  description = "(Required) If true, enable the proxy protocol which is for supplying client TCP/IP
...
variable "compute_service_attachment_target_service" {
  description = "(Required) The URL of a forwarding rule that represents the service identified by
this service attachment."
  type = string
}

variable "compute_service_attachment_consumer_accept_lists_connection_limit" {
  description = "(Required) The number of consumer forwarding rules the consumer project can
create."
  type = number
}
