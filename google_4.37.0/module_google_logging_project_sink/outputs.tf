...
output "logging_project_sink_bigquery_options_use_partitioned_tables" {
  value = google_logging_project_sink.resname.bigquery_options_use_partitioned_tables
}

output "logging_project_sink_exclusions_filter" {
  value = google_logging_project_sink.resname.exclusions_filter
}

output "logging_project_sink_exclusions_name" {
  value = google_logging_project_sink.resname.exclusions_name
}
