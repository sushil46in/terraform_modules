...
/*variable "cloudbuild_trigger_filename" {
  description = "(Optional) Path, from the source root, to a file whose contents is used for the template. 
...
/*variable "cloudbuild_trigger_include_build_logs" {
  description = "(Optional) Build logs will be sent back to GitHub as part of the checkrun
...
/*variable "cloudbuild_trigger_location" {
  description = "(Optional) The [Cloud Build location](https://cloud.google.com/build/docs/locations) for the trigger.
If not specified, "global" is used."
  type = string
}*/

/*variable "cloudbuild_trigger_service_account" {
  description = "(Optional) The service account used for all user-controlled operations including
...
/*variable "cloudbuild_trigger_approval_config_approval_required" {
  description = "(Optional) Whether or not approval is needed. If this is set on a build, it will become pending when run, 
...
/*variable "cloudbuild_trigger_build_logs_bucket" {
  description = "(Optional) Google Cloud Storage bucket where logs should be written. 
Logs file names will be of the format ${logsBucket}/log-${build_id}.txt."
  type = string
}*/

/*variable "cloudbuild_trigger_build_queue_ttl" {
  description = "(Optional) TTL in queue for this build. If provided and the build is enqueued longer than this value, 
...
/*variable "cloudbuild_trigger_build_timeout" {
  description = "(Optional) Amount of time that this build should be allowed to run, to second granularity.
...
/*variable "cloudbuild_trigger_objects_location" {
  description = "(Optional) Cloud Storage bucket and optional object path, in the form "gs://bucket/path/to/somewhere/".
...
variable "cloudbuild_trigger_secret_manager_env" {
  description = "(Required) Environment variable name to associate with the secret. Secret environment
...
/*variable "cloudbuild_trigger_options_disk_size_gb" {
  description = "(Optional) Requested disk size for the VM that runs the build. Note that this is NOT "disk free";
...
/*variable "cloudbuild_trigger_options_dynamic_substitutions" {
  description = "(Optional) Option to specify whether or not to apply bash style string operations to the substitutions.
...
/*variable "cloudbuild_trigger_options_env" {
  description = "(Optional) A list of global environment variable definitions that will exist for all build steps
...
/*variable "cloudbuild_trigger_options_secret_env" {
  description = "(Optional) A list of global environment variables, which are encrypted using a Cloud Key Management
...
/*variable "cloudbuild_trigger_options_substitution_option" {
  description = "(Optional) Option to specify behavior when there is an error in the substitution checks.
...
/*variable "cloudbuild_trigger_options_worker_pool" {
  description = "(Optional) Option to specify a WorkerPool for the build. Format projects/{project}/workerPools/{workerPool}
...
/*variable "cloudbuild_trigger_volumes_name" {
  description = "(Optional) Name of the volume to mount.
...
/*variable "cloudbuild_trigger_volumes_path" {
  description = "(Optional) Path at which to mount the volume.
...
/*variable "cloudbuild_trigger_secret_secret_env" {
  description = "(Optional) Map of environment variable name to its encrypted value.
...
/*variable "cloudbuild_trigger_repo_source_branch_name" {
  description = "(Optional) Regex matching branches to build. Exactly one a of branch name, tag, or commit SHA must be provided.
...
/*variable "cloudbuild_trigger_repo_source_tag_name" {
  description = "(Optional) Regex matching tags to build. Exactly one a of branch name, tag, or commit SHA must be provided.
The syntax of the regular expressions accepted is the syntax accepted by RE2 and 
described at https://github.com/google/re2/wiki/Syntax"
  type = string
}*/
...
/*variable "cloudbuild_trigger_storage_source_generation" {
  description = "(Optional) Google Cloud Storage generation for the object. 
If the generation is omitted, the latest generation will be used"
  type = string
}*/

variable "cloudbuild_trigger_storage_source_object" {
  description = "(Required) Google Cloud Storage object containing the source.
This object must be a gzipped archive file (.tar.gz) containing source to build."
  type = string
}

/*variable "cloudbuild_trigger_step_args" {
  description = "(Optional) A list of arguments that will be presented to the step when it is started.
...
/*variable "cloudbuild_trigger_step_dir" {
  description = "(Optional) Working directory to use when running this step's container.
...
/*variable "cloudbuild_trigger_step_entrypoint" {
  description = "(Optional) Entrypoint to be used instead of the build step image's
default entrypoint.
...
/*variable "cloudbuild_trigger_step_env" {
  description = "(Optional) A list of environment variable definitions to be used when
running a step.
...
variable "cloudbuild_trigger_step_name" {
  description = "(Required) The name of the container image that will run this particular build step.
...
/*variable "cloudbuild_trigger_step_secret_env" {
  description = "(Optional) A list of environment variables which are encrypted using
a Cloud Key
...
/*variable "cloudbuild_trigger_step_timeout" {
  description = "(Optional) Time limit for executing this build step. If not defined,
the step has no
...
/*variable "cloudbuild_trigger_step_timing" {
  description = "(Optional) Output only. Stores timing information for executing this
build step."
  type = string
}*/

/*variable "cloudbuild_trigger_step_wait_for" {
  description = "(Optional) The ID(s) of the step(s) that this build step depends on.
...
variable "cloudbuild_trigger_volumes_name" {
  description = "(Required) Name of the volume to mount.
...
variable "cloudbuild_trigger_volumes_path" {
  description = "(Required) Path at which to mount the volume.
...
variable "cloudbuild_trigger_git_file_source_repo_type" {
  description = "(Required) The type of the repo, since it may not be explicit from the repo field (e.g from a URL). 
...
/*variable "cloudbuild_trigger_git_file_source_revision" {
  description = "(Optional) The branch, tag, arbitrary ref, or SHA version of the repo to use when resolving the 
...
/*variable "cloudbuild_trigger_git_file_source_uri" {
  description = "(Optional) The URI of the repo (optional). If unspecified, the repo from which the trigger 
invocation originated is assumed to be the repo from which to read the specified path."
  type = string
}*/

/*variable "cloudbuild_trigger_github_name" {
  description = "(Optional) Name of the repository. For example: The name for
https://github.com/googlecloudplatform/cloud-builders is "cloud-builders"."
  type = string
}*/

/*variable "cloudbuild_trigger_github_owner" {
  description = "(Optional) Owner of the repository. For example: The owner for
