...
output "dns_managed_zone_dnssec_config_non_existence" {
  value = google_dns_managed_zone.resname.dnssec_config_non_existence
}

output "dns_managed_zone_target_name_servers_ipv4_address" {
  value = google_dns_managed_zone.resname.target_name_servers_ipv4_address
}

output "dns_managed_zone_target_network_network_url" {
  value = google_dns_managed_zone.resname.target_network_network_url
}

output "dns_managed_zone_networks_network_url" {
  value = google_dns_managed_zone.resname.networks_network_url
}
