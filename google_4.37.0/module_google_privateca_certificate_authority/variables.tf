...
/*variable "privateca_certificate_authority_key_spec_algorithm" {
  description = "(Optional) The algorithm to use for creating a managed Cloud KMS key for a for a simplified
...
/*variable "privateca_certificate_authority_key_spec_cloud_kms_key_version" {
  description = "(Optional) The resource name for an existing Cloud KMS CryptoKeyVersion in the format
'projects/*/locations/*/keyRings/*/cryptoKeys/*/cryptoKeyVersions/*'."
  type = string
}*/

/*variable "privateca_certificate_authority_subordinate_config_certificate_authority" {
  description = "(Optional) This can refer to a CertificateAuthority that was used to create a
