...
/*variable "compute_backend_bucket_cdn_policy_signed_url_cache_max_age_sec" {
  description = "(Optional) Maximum number of seconds the response to a signed URL request will
...
/*variable "compute_backend_bucket_cache_key_policy_include_http_headers" {
  description = "(Optional) Allows HTTP request headers (by name) to be used in the
cache key."
  type = list
}*/
