...
variable "binary_authorization_attestor_attestation_authority_note_note_reference" {
  description = "(Required) The resource name of a ATTESTATION_AUTHORITY Note, created by the
...
/*variable "binary_authorization_attestor_public_keys_ascii_armored_pgp_public_key" {
  description = "(Optional) ASCII-armored representation of a PGP public key, as the
...
/*variable "binary_authorization_attestor_pkix_public_key_public_key_pem" {
  description = "(Optional) A PEM-encoded public key, as described in
'https://tools.ietf.org/html/rfc7468#section-13'"
  type = string
}*/

/*variable "binary_authorization_attestor_pkix_public_key_signature_algorithm" {
  description = "(Optional) The signature algorithm used to verify a message against
