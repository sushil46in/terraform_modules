...
variable "network_services_edge_cache_keyset_public_key_id" {
  description = "(Required) The ID of the public key. The ID must be 1-63 characters long, and comply with RFC1035.
...
variable "network_services_edge_cache_keyset_public_key_value" {
  description = "(Required) The base64-encoded value of the Ed25519 public key. The base64 encoding can be padded (44 bytes) or unpadded (43 bytes).
