...
/*variable "project_organization_policy_allow_all" {
  description = "(Optional) The policy allows or denies all values."
  type = bool
}*/

/*variable "project_organization_policy_allow_values" {
  description = "(Optional) The policy can define specific values that are allowed or denied."
  type = set
}*/

/*variable "project_organization_policy_deny_all" {
  description = "(Optional) The policy allows or denies all values."
  type = bool
}*/

/*variable "project_organization_policy_deny_values" {
  description = "(Optional) The policy can define specific values that are allowed or denied."
  type = set
}*/

variable "project_organization_policy_restore_policy_default" {
  description = "(Required) May only be set to true. If set, then the default Policy is restored."
  type = bool
}

/*variable "project_organization_policy_timeouts_create" {
  description = "(Optional) The value for timeouts_create"
  type = string
}*/

/*variable "project_organization_policy_timeouts_delete" {
  description = "(Optional) The value for timeouts_delete"
  type = string
}*/

/*variable "project_organization_policy_timeouts_read" {
  description = "(Optional) The value for timeouts_read"
  type = string
}*/

/*variable "project_organization_policy_timeouts_update" {
