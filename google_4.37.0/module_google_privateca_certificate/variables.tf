...
/*variable "privateca_certificate_certificate_authority" {
  description = "(Optional) The Certificate Authority ID that should issue the certificate. For example, to issue a Certificate from
...
/*variable "privateca_certificate_certificate_template" {
  description = "(Optional) The resource name for a CertificateTemplate used to issue this certificate,
...
variable "privateca_certificate_location" {
  description = "(Required) Location of the Certificate. A full list of valid locations can be found by
