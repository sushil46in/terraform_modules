...
/*variable "compute_health_check_check_interval_sec" {
  description = "(Optional)" #How often (in seconds) to send a health check. The default value is 5 seconds.
  type = number
}*/

/*variable "compute_health_check_description" {
  description = "(Optional)" #An optional description of this resource. Provide this property when you create the resource.
  type = string
}*/

/*variable "compute_health_check_healthy_threshold" {
...
/*variable "compute_health_check_timeout_sec" {
...
/*variable "compute_health_check_unhealthy_threshold" {
...
/*variable "compute_health_check_grpc_health_check_grpc_service_name" {
...
/*variable "compute_health_check_grpc_health_check_port" {
...
/*variable "compute_health_check_grpc_health_check_port_name" {
...
/*variable "compute_health_check_grpc_health_check_port_specification" {
...
/*variable "compute_health_check_http2_health_check_host" {
...
/*variable "compute_health_check_http2_health_check_port" {
  description = "(Optional)" #The TCP port number for the HTTP2 health check request. The default value is 443.
  type = number
}*/

/*variable "compute_health_check_http2_health_check_port_name" {
  description = "(Optional)" #Port name as defined in InstanceGroup#NamedPort#name. If both port and port_name are defined, port takes precedence.
  type = string
}*/

/*variable "compute_health_check_http2_health_check_port_specification" {
...
/*variable "compute_health_check_http2_health_check_proxy_header" {
...
/*variable "compute_health_check_http2_health_check_request_path" {
  description = "(Optional)" #The request path of the HTTP2 health check request. The default value is /.
  type = string
}*/

/*variable "compute_health_check_http2_health_check_response" {
...
/*variable "compute_health_check_http_health_check_host" {
...
/*variable "compute_health_check_http_health_check_port" {
  description = "(Optional)" #The TCP port number for the HTTP health check request. The default value is 80.
  type = number
}*/

/*variable "compute_health_check_http_health_check_port_name" {
  description = "(Optional)" #Port name as defined in InstanceGroup#NamedPort#name. If both port and port_name are defined, port takes precedence.
  type = string
}*/

/*variable "compute_health_check_http_health_check_port_specification" {
...
/*variable "compute_health_check_http_health_check_proxy_header" {
  description = "(Optional)" #Specifies the type of proxy header to append before sending data to the backend. Default value: "NONE" Possible values: ["NONE", "PROXY_V1"]
  type = string
}*/

/*variable "compute_health_check_http_health_check_request_path" {
  description = "(Optional)" #The request path of the HTTP health check request. The default value is /.
  type = string
}*/

/*variable "compute_health_check_http_health_check_response" {
  description = "(Optional)" #The bytes to match against the beginning of the response data. If left empty (the default value), any response will indicate health. The response data can only be ASCII.
  type = string
}*/

/*variable "compute_health_check_https_health_check_host" {
...
/*variable "compute_health_check_https_health_check_port" {
  description = "(Optional)" #The TCP port number for the HTTPS health check request. The default value is 443.
  type = number
}*/

/*variable "compute_health_check_https_health_check_port_name" {
  description = "(Optional)" #Port name as defined in InstanceGroup#NamedPort#name. If both port and port_name are defined, port takes precedence.
  type = string
}*/

/*variable "compute_health_check_https_health_check_port_specification" {
...
/*variable "compute_health_check_https_health_check_proxy_header" {
  description = "(Optional)" #Specifies the type of proxy header to append before sending data to the backend. Default value: "NONE" Possible values: ["NONE", "PROXY_V1"]
  type = string
}*/

/*variable "compute_health_check_https_health_check_request_path" {
  description = "(Optional)" #The request path of the HTTPS health check request. The default value is /.
  type = string
}*/

/*variable "compute_health_check_https_health_check_response" {
  description = "(Optional)" #The bytes to match against the beginning of the response data. If left empty (the default value), any response will indicate health. The response data can only be ASCII.
  type = string
}*/

/*variable "compute_health_check_log_config_enable" {
...
/*variable "compute_health_check_ssl_health_check_port" {
  description = "(Optional)" #The TCP port number for the SSL health check request. The default value is 443.
  type = number
}*/

/*variable "compute_health_check_ssl_health_check_port_name" {
  description = "(Optional)" #Port name as defined in InstanceGroup#NamedPort#name. If both port and port_name are defined, port takes precedence.
  type = string
}*/

/*variable "compute_health_check_ssl_health_check_port_specification" {
...
/*variable "compute_health_check_ssl_health_check_proxy_header" {
  description = "(Optional)" #Specifies the type of proxy header to append before sending data to the backend. Default value: "NONE" Possible values: ["NONE", "PROXY_V1"]
  type = string
}*/

/*variable "compute_health_check_ssl_health_check_request" {
...
/*variable "compute_health_check_ssl_health_check_response" {
  description = "(Optional)" #The bytes to match against the beginning of the response data. If left empty (the default value), any response will indicate health. The response data can only be ASCII.
  type = string
}*/

/*variable "compute_health_check_tcp_health_check_port" {
  description = "(Optional)" #The TCP port number for the TCP health check request. The default value is 443.
  type = number
}*/

/*variable "compute_health_check_tcp_health_check_port_name" {
  description = "(Optional)" #Port name as defined in InstanceGroup#NamedPort#name. If both port and port_name are defined, port takes precedence.
  type = string
}*/

/*variable "compute_health_check_tcp_health_check_port_specification" {
...
/*variable "compute_health_check_tcp_health_check_proxy_header" {
  description = "(Optional)" #Specifies the type of proxy header to append before sending data to the backend. Default value: "NONE" Possible values: ["NONE", "PROXY_V1"]
  type = string
}*/

/*variable "compute_health_check_tcp_health_check_request" {
...
/*variable "compute_health_check_tcp_health_check_response" {
  description = "(Optional)" #The bytes to match against the beginning of the response data. If left empty (the default value), any response will indicate health. The response data can only be ASCII.
  type = string
}*/

/*variable "compute_health_check_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "compute_health_check_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "compute_health_check_timeouts_update" {
