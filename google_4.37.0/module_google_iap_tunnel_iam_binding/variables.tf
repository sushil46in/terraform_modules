...
variable "iap_tunnel_iam_binding_members" {
  description = "(Required) The value for members"
  type = set
}

variable "iap_tunnel_iam_binding_role" {
  description = "(Required) The value for role"
  type = string
}

/*variable "iap_tunnel_iam_binding_condition_description" {
  description = "(Optional) The value for condition_description"
  type = string
}*/

variable "iap_tunnel_iam_binding_condition_expression" {
  description = "(Required) The value for condition_expression"
  type = string
}

variable "iap_tunnel_iam_binding_condition_title" {
