...
/*variable "compute_router_peer_enable" {
  description = "(Optional) The status of the BGP peer connection. If set to false, any active session
...
/*variable "compute_router_peer_bfd_min_receive_interval" {
  description = "(Optional) The minimum interval, in milliseconds, between BFD control packets
...
/*variable "compute_router_peer_bfd_multiplier" {
  description = "(Optional) The number of consecutive BFD packets that must be missed before
...
variable "compute_router_peer_bfd_session_initialization_mode" {
  description = "(Required) The BFD session initialization mode for this BGP peer.
