...
variable "folder_iam_binding_folder" {
  description = "(Required) 'The value for folder'"
  type = string
}

variable "folder_iam_binding_members" {
  description = "(Required) 'The value for members'"
  type = set
}

variable "folder_iam_binding_role" {
  description = "(Required) 'The value for role'"
  type = string
}

/*variable "folder_iam_binding_condition_description" {
  description = "(Optional) 'The value for condition_description'"
  type = string
}*/

variable "folder_iam_binding_condition_expression" {
  description = "(Required) 'The value for condition_expression'"
  type = string
}

variable "folder_iam_binding_condition_title" {
