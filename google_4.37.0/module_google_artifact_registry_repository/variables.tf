...
variable "artifact_registry_repository_format" {
  description = "(Required) The format of packages that are stored in the repository. Supported formats
...
/*variable "artifact_registry_repository_maven_config_allow_snapshot_overwrites" {
  description = "(Optional) The repository with this flag will allow publishing the same
snapshot versions."
  type = bool
}*/
