...
/*variable "dataproc_autoscaling_policy_basic_algorithm_cooldown_period" {
  description = "(Optional) Duration between scaling events. A scaling period starts after the
...
variable "dataproc_autoscaling_policy_yarn_config_graceful_decommission_timeout" {
  description = "(Required) Timeout for YARN graceful decommissioning of Node Managers. Specifies the
...
variable "dataproc_autoscaling_policy_yarn_config_scale_down_factor" {
  description = "(Required) Fraction of average pending memory in the last cooldown period for which to
...
/*variable "dataproc_autoscaling_policy_yarn_config_scale_down_min_worker_fraction" {
  description = "(Optional) Minimum scale-down threshold as a fraction of total cluster size before scaling occurs.
...
/*variable "dataproc_autoscaling_policy_yarn_config_scale_up_min_worker_fraction" {
  description = "(Optional) Minimum scale-up threshold as a fraction of total cluster size before scaling
...
/*variable "dataproc_autoscaling_policy_secondary_worker_config_max_instances" {
  description = "(Optional) Maximum number of instances for this group. Note that by default, clusters will not use
...
/*variable "dataproc_autoscaling_policy_secondary_worker_config_weight" {
  description = "(Optional) Weight for the instance group, which is used to determine the fraction of total workers
