...
variable "pubsub_topic_iam_member_member" {
  description = "(Required) 'The value for member'"
  type = string
}

variable "pubsub_topic_iam_member_role" {
  description = "(Required) 'The value for role'"
  type = string
}

variable "pubsub_topic_iam_member_topic" {
  description = "(Required) 'The value for topic'"
  type = string
}

/*variable "pubsub_topic_iam_member_condition_description" {
  description = "(Optional) 'The value for condition_description'"
  type = string
}*/

variable "pubsub_topic_iam_member_condition_expression" {
  description = "(Required) 'The value for condition_expression'"
  type = string
}

variable "pubsub_topic_iam_member_condition_title" {
