...
output "kms_key_ring_iam_binding_condition_expression" {
  value = google_kms_key_ring_iam_binding.resname.condition_expression
}

output "kms_key_ring_iam_binding_condition_title" {
  value = google_kms_key_ring_iam_binding.resname.condition_title
}
