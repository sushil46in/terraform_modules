...
/*variable "dialogflow_cx_page_language_code" {
  description = "(Optional) The language of the following fields in page:
...
/*variable "dialogflow_cx_page_parent" {
  description = "(Optional) The flow to create a page for.
Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>."
  type = string
}*/

/*variable "dialogflow_cx_page_transition_route_groups" {
  description = "(Optional) Ordered list of TransitionRouteGroups associated with the page. Transition route groups must be unique within a page.
...
/*variable "dialogflow_cx_page_event_handlers_target_flow" {
  description = "(Optional) The target flow to transition to.
Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>."
  type = string
}*/

/*variable "dialogflow_cx_page_event_handlers_target_page" {
  description = "(Optional) The target page to transition to.
...
/*variable "dialogflow_cx_page_parameters_entity_type" {
  description = "(Optional) The entity type of the parameter.
...
/*variable "dialogflow_cx_page_parameters_redact" {
  description = "(Optional) Indicates whether the parameter content should be redacted in log.
If redaction is enabled, the parameter content will be replaced by parameter name during logging. Note: the parameter content is subject to redaction if either parameter level redaction or entity type level redaction is enabled."
  type = bool
}*/

/*variable "dialogflow_cx_page_parameters_required" {
  description = "(Optional) Indicates whether the parameter is required. Optional parameters will not trigger prompts; however, they are filled if the user specifies them.
...
/*variable "dialogflow_cx_page_transition_routes_condition" {
  description = "(Optional) The condition to evaluate against form parameters or session parameters.
At least one of intent or condition must be specified. When both intent and condition are specified, the transition can only happen when both are fulfilled."
  type = string
}*/

/*variable "dialogflow_cx_page_transition_routes_intent" {
  description = "(Optional) The unique identifier of an Intent.
