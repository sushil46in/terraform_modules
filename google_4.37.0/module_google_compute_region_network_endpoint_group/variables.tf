...
/*variable "compute_region_network_endpoint_group_network" {
  description = "(Optional) This field is only used for PSC.
...
/*variable "compute_region_network_endpoint_group_psc_target_service" {
  description = "(Optional) The target service url used to set up private service connection to
...
/*variable "compute_region_network_endpoint_group_app_engine_service" {
  description = "(Optional) Optional serving service.
...
/*variable "compute_region_network_endpoint_group_app_engine_url_mask" {
  description = "(Optional) A template to parse service and version fields from a request URL.
...
/*variable "compute_region_network_endpoint_group_app_engine_version" {
  description = "(Optional) Optional serving version.
...
/*variable "compute_region_network_endpoint_group_cloud_function_function" {
  description = "(Optional) A user-defined name of the Cloud Function.
...
/*variable "compute_region_network_endpoint_group_cloud_function_url_mask" {
  description = "(Optional) A template to parse function field from a request URL. URL mask allows
...
/*variable "compute_region_network_endpoint_group_cloud_run_service" {
  description = "(Optional) Cloud Run service is the main resource of Cloud Run.
...
/*variable "compute_region_network_endpoint_group_cloud_run_tag" {
  description = "(Optional) Cloud Run tag represents the "named-revision" to provide
...
/*variable "compute_region_network_endpoint_group_cloud_run_url_mask" {
  description = "(Optional) A template to parse service and tag fields from a request URL.
