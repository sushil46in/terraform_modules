...
variable "bigquery_data_transfer_config_params" {
  description = "(Required) Parameters specific to each data source. For more information see the bq tab in the 'Setting up a data transfer'
...
/*variable "bigquery_data_transfer_config_service_account_name" {
  description = "(Optional) Service account email. If this field is set, transfer config will
...
/*variable "bigquery_data_transfer_config_schedule_options_disable_auto_scheduling" {
  description = "(Optional) If true, automatic scheduling of data transfer runs for this
...
/*variable "bigquery_data_transfer_config_schedule_options_end_time" {
  description = "(Optional) Defines time to stop scheduling transfer runs. A transfer run cannot be
...
/*variable "bigquery_data_transfer_config_schedule_options_start_time" {
  description = "(Optional) Specifies time to start scheduling transfer runs. The first run will be
