...
variable "certificate_manager_certificate_name" {
  description = "(Required) A user-defined name of the certificate. Certificate names must be unique
...
/*variable "certificate_manager_certificate_scope" {
  description = "(Optional) The scope of the certificate.
...
/*variable "certificate_manager_certificate_managed_domains" {
  description = "(Optional) The domains for which a managed SSL certificate will be generated.
Wildcard domains are only supported with DNS challenge resolution"
  type = list
}*/

variable "certificate_manager_certificate_self_managed_certificate_pem" {
  description = "(Required) The certificate chain in PEM-encoded form.
