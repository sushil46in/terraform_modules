...
/*variable "compute_url_map_cors_policy_allow_origin_regexes" {
  description = "(Optional) Specifies the regular expression patterns that match allowed origins. For regular expression grammar
...
/*variable "compute_url_map_cors_policy_max_age" {
  description = "(Optional) Specifies how long results of a preflight request can be cached in seconds.
...
/*variable "compute_url_map_abort_percentage" {
  description = "(Optional) The percentage of traffic (connections/operations/requests) which will be aborted as part of fault injection.
The value must be between 0.0 and 100.0 inclusive."
  type = number
}*/

/*variable "compute_url_map_delay_percentage" {
  description = "(Optional) The percentage of traffic (connections/operations/requests) on which delay will be introduced as part of fault injection.
The value must be between 0.0 and 100.0 inclusive."
  type = number
}*/

/*variable "compute_url_map_fixed_delay_nanos" {
  description = "(Optional) Span of time that's a fraction of a second at nanosecond resolution. Durations less than one second are
...
/*variable "compute_url_map_retry_policy_retry_conditions" {
  description = "(Optional) Specfies one or more conditions when this retry rule applies. Valid values are:
...
/*variable "compute_url_map_timeout_nanos" {
  description = "(Optional) Span of time that's a fraction of a second at nanosecond resolution. Durations less than one second are represented
...
/*variable "compute_url_map_url_rewrite_host_rewrite" {
  description = "(Optional) Prior to forwarding the request to the selected service, the request's host header is replaced
...
/*variable "compute_url_map_url_rewrite_path_prefix_rewrite" {
  description = "(Optional) Prior to forwarding the request to the selected backend service, the matching portion of the
...
/*variable "compute_url_map_weighted_backend_services_backend_service" {
  description = "(Optional) The full or partial URL to the default BackendService resource. Before forwarding the
...
/*variable "compute_url_map_weighted_backend_services_weight" {
  description = "(Optional) Specifies the fraction of traffic sent to backendService, computed as
...
/*variable "compute_url_map_header_action_request_headers_to_remove" {
  description = "(Optional) A list of header names for headers that need to be removed from the request prior to
forwarding the request to the backendService."
  type = list
}*/

/*variable "compute_url_map_header_action_response_headers_to_remove" {
  description = "(Optional) A list of header names for headers that need to be removed from the response prior to sending the
...
/*variable "compute_url_map_request_headers_to_add_replace" {
  description = "(Optional) If false, headerValue is appended to any values that already exist for the header.
...
variable "compute_url_map_host_rule_hosts" {
  description = "(Required) The list of host patterns to match. They must be valid hostnames, except * will
...
variable "compute_url_map_host_rule_path_matcher" {
  description = "(Required) The name of the PathMatcher to use to match the path portion of the URL if the
...
variable "compute_url_map_weighted_backend_services_backend_service" {
  description = "(Required) The default BackendService resource. Before
...
variable "compute_url_map_url_redirect_strip_query" {
  description = "(Required) If set to true, any accompanying query portion of the original URL is
...
/*variable "compute_url_map_route_rules_service" {
  description = "(Optional) The backend service resource to which traffic is
...
/*variable "compute_url_map_url_redirect_https_redirect" {
  description = "(Optional) If set to true, the URL scheme in the redirected request is set to https. If set
...
/*variable "compute_url_map_url_redirect_strip_query" {
  description = "(Optional) If set to true, any accompanying query portion of the original URL is removed
