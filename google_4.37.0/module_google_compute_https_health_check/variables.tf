...
/*variable "compute_https_health_check_check_interval_sec" {
  description = "(Optional)" #How often (in seconds) to send a health check. The default value is 5 seconds.
  type = number
}*/

/*variable "compute_https_health_check_description" {
  description = "(Optional)" #An optional description of this resource. Provide this property when you create the resource.
  type = string
}*/

/*variable "compute_https_health_check_healthy_threshold" {
...
/*variable "compute_https_health_check_host" {
...
/*variable "compute_https_health_check_unhealthy_threshold" {
...
/*variable "compute_https_health_check_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "compute_https_health_check_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "compute_https_health_check_timeouts_update" {
