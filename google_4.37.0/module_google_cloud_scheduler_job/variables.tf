...
variable "cloud_scheduler_job_app_engine_http_target_relative_uri" {
  description = "(Required) The relative URI.
...
/*variable "cloud_scheduler_job_app_engine_routing_instance" {
  description = "(Optional) App instance.
...
/*variable "cloud_scheduler_job_http_target_headers" {
  description = "(Optional) This map contains the header field names and values. 
...
/*variable "cloud_scheduler_job_oauth_token_scope" {
  description = "(Optional) OAuth scope to be used for generating OAuth access token. If not specified,
"https://www.googleapis.com/auth/cloud-platform" will be used."
  type = string
}*/

variable "cloud_scheduler_job_oauth_token_service_account_email" {
  description = "(Required) Service account email to be used for generating OAuth token.
The service account must be within the same project as the job."
  type = string
}

/*variable "cloud_scheduler_job_oidc_token_audience" {
  description = "(Optional) Audience to be used when generating OIDC token. If not specified,
...
/*variable "cloud_scheduler_job_pubsub_target_attributes" {
  description = "(Optional) Attributes for PubsubMessage.
Pubsub message must contain either non-empty data, or at least one attribute."
  type = map
}*/

/*variable "cloud_scheduler_job_pubsub_target_data" {
  description = "(Optional) The message payload for PubsubMessage.
Pubsub message must contain either non-empty data, or at least one attribute.
...
variable "cloud_scheduler_job_pubsub_target_topic_name" {
  description = "(Required) The full resource name for the Cloud Pub/Sub topic to which
