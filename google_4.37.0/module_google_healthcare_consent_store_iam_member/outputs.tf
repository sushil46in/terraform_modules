...
output "healthcare_consent_store_iam_member_condition_expression" {
  value = google_healthcare_consent_store_iam_member.resname.condition_expression
}

output "healthcare_consent_store_iam_member_condition_title" {
  value = google_healthcare_consent_store_iam_member.resname.condition_title
}
