...
output "identity_authentication_policy_network_policy_network_source_ids" {
  value = oci_identity_authentication_policy.resname.network_policy_network_source_ids
}

output "identity_authentication_policy_password_policy_is_lowercase_characters_required" {
  value = oci_identity_authentication_policy.resname.password_policy_is_lowercase_characters_required
}

output "identity_authentication_policy_password_policy_is_numeric_characters_required" {
  value = oci_identity_authentication_policy.resname.password_policy_is_numeric_characters_required
}

output "identity_authentication_policy_password_policy_is_special_characters_required" {
  value = oci_identity_authentication_policy.resname.password_policy_is_special_characters_required
}

output "identity_authentication_policy_password_policy_is_uppercase_characters_required" {
  value = oci_identity_authentication_policy.resname.password_policy_is_uppercase_characters_required
}

output "identity_authentication_policy_password_policy_is_username_containment_allowed" {
  value = oci_identity_authentication_policy.resname.password_policy_is_username_containment_allowed
}

output "identity_authentication_policy_password_policy_minimum_password_length" {
  value = oci_identity_authentication_policy.resname.password_policy_minimum_password_length
}
