...
/*variable "file_storage_mount_target_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "file_storage_mount_target_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "file_storage_mount_target_timeouts_update" {
