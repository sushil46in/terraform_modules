...
output "kms_generated_key_key_shape_algorithm" {
  value = oci_kms_generated_key.resname.key_shape_algorithm
}

output "kms_generated_key_key_shape_curve_id" {
  value = oci_kms_generated_key.resname.key_shape_curve_id
}

output "kms_generated_key_key_shape_length" {
  value = oci_kms_generated_key.resname.key_shape_length
}
