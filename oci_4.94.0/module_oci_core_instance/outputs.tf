...
output "core_instance_agent_config_are_all_plugins_disabled" {
  value = oci_core_instance.resname.agent_config_are_all_plugins_disabled
}

output "core_instance_agent_config_is_management_disabled" {
  value = oci_core_instance.resname.agent_config_is_management_disabled
}

output "core_instance_agent_config_is_monitoring_disabled" {
  value = oci_core_instance.resname.agent_config_is_monitoring_disabled
}

output "core_instance_plugins_config_desired_state" {
  value = oci_core_instance.resname.plugins_config_desired_state
}

output "core_instance_plugins_config_name" {
  value = oci_core_instance.resname.plugins_config_name
}

output "core_instance_availability_config_is_live_migration_preferred" {
  value = oci_core_instance.resname.availability_config_is_live_migration_preferred
}

output "core_instance_availability_config_recovery_action" {
  value = oci_core_instance.resname.availability_config_recovery_action
}

output "core_instance_create_vnic_details_defined_tags" {
  value = oci_core_instance.resname.create_vnic_details_defined_tags
}

output "core_instance_create_vnic_details_display_name" {
  value = oci_core_instance.resname.create_vnic_details_display_name
}

output "core_instance_create_vnic_details_freeform_tags" {
  value = oci_core_instance.resname.create_vnic_details_freeform_tags
}

output "core_instance_create_vnic_details_hostname_label" {
  value = oci_core_instance.resname.create_vnic_details_hostname_label
}

output "core_instance_create_vnic_details_private_ip" {
  value = oci_core_instance.resname.create_vnic_details_private_ip
}

output "core_instance_create_vnic_details_skip_source_dest_check" {
  value = oci_core_instance.resname.create_vnic_details_skip_source_dest_check
}

output "core_instance_create_vnic_details_subnet_id" {
  value = oci_core_instance.resname.create_vnic_details_subnet_id
}

output "core_instance_create_vnic_details_vlan_id" {
  value = oci_core_instance.resname.create_vnic_details_vlan_id
}

output "core_instance_instance_options_are_legacy_imds_endpoints_disabled" {
  value = oci_core_instance.resname.instance_options_are_legacy_imds_endpoints_disabled
}

output "core_instance_launch_options_boot_volume_type" {
  value = oci_core_instance.resname.launch_options_boot_volume_type
}

output "core_instance_launch_options_firmware" {
  value = oci_core_instance.resname.launch_options_firmware
}

output "core_instance_launch_options_is_consistent_volume_naming_enabled" {
  value = oci_core_instance.resname.launch_options_is_consistent_volume_naming_enabled
}

output "core_instance_launch_options_is_pv_encryption_in_transit_enabled" {
  value = oci_core_instance.resname.launch_options_is_pv_encryption_in_transit_enabled
}

output "core_instance_launch_options_network_type" {
  value = oci_core_instance.resname.launch_options_network_type
}

output "core_instance_launch_options_remote_data_volume_type" {
  value = oci_core_instance.resname.launch_options_remote_data_volume_type
}

output "core_instance_platform_config_are_virtual_instructions_enabled" {
  value = oci_core_instance.resname.platform_config_are_virtual_instructions_enabled
}

output "core_instance_platform_config_is_access_control_service_enabled" {
  value = oci_core_instance.resname.platform_config_is_access_control_service_enabled
}

output "core_instance_platform_config_is_input_output_memory_management_unit_enabled" {
  value = oci_core_instance.resname.platform_config_is_input_output_memory_management_unit_enabled
}

output "core_instance_platform_config_is_measured_boot_enabled" {
  value = oci_core_instance.resname.platform_config_is_measured_boot_enabled
}

output "core_instance_platform_config_is_secure_boot_enabled" {
  value = oci_core_instance.resname.platform_config_is_secure_boot_enabled
}

output "core_instance_platform_config_is_symmetric_multi_threading_enabled" {
  value = oci_core_instance.resname.platform_config_is_symmetric_multi_threading_enabled
}

output "core_instance_platform_config_is_trusted_platform_module_enabled" {
  value = oci_core_instance.resname.platform_config_is_trusted_platform_module_enabled
}

output "core_instance_platform_config_numa_nodes_per_socket" {
  value = oci_core_instance.resname.platform_config_numa_nodes_per_socket
}

output "core_instance_platform_config_percentage_of_cores_enabled" {
  value = oci_core_instance.resname.platform_config_percentage_of_cores_enabled
}

output "core_instance_platform_config_type" {
  value = oci_core_instance.resname.platform_config_type
}

output "core_instance_preemption_action_preserve_boot_volume" {
  value = oci_core_instance.resname.preemption_action_preserve_boot_volume
}

output "core_instance_preemption_action_type" {
  value = oci_core_instance.resname.preemption_action_type
}

output "core_instance_shape_config_baseline_ocpu_utilization" {
  value = oci_core_instance.resname.shape_config_baseline_ocpu_utilization
}

output "core_instance_shape_config_gpu_description" {
  value = oci_core_instance.resname.shape_config_gpu_description
}

output "core_instance_shape_config_gpus" {
  value = oci_core_instance.resname.shape_config_gpus
}

output "core_instance_shape_config_local_disk_description" {
  value = oci_core_instance.resname.shape_config_local_disk_description
}

output "core_instance_shape_config_local_disks" {
  value = oci_core_instance.resname.shape_config_local_disks
}

output "core_instance_shape_config_local_disks_total_size_in_gbs" {
  value = oci_core_instance.resname.shape_config_local_disks_total_size_in_gbs
}

output "core_instance_shape_config_max_vnic_attachments" {
  value = oci_core_instance.resname.shape_config_max_vnic_attachments
}

output "core_instance_shape_config_memory_in_gbs" {
  value = oci_core_instance.resname.shape_config_memory_in_gbs
}

output "core_instance_shape_config_networking_bandwidth_in_gbps" {
  value = oci_core_instance.resname.shape_config_networking_bandwidth_in_gbps
}

output "core_instance_shape_config_nvmes" {
  value = oci_core_instance.resname.shape_config_nvmes
}

output "core_instance_shape_config_ocpus" {
  value = oci_core_instance.resname.shape_config_ocpus
}

output "core_instance_shape_config_processor_description" {
  value = oci_core_instance.resname.shape_config_processor_description
}

output "core_instance_source_details_boot_volume_size_in_gbs" {
  value = oci_core_instance.resname.source_details_boot_volume_size_in_gbs
}

output "core_instance_source_details_boot_volume_vpus_per_gb" {
  value = oci_core_instance.resname.source_details_boot_volume_vpus_per_gb
}

output "core_instance_source_details_kms_key_id" {
  value = oci_core_instance.resname.source_details_kms_key_id
}

output "core_instance_source_details_source_id" {
  value = oci_core_instance.resname.source_details_source_id
}

output "core_instance_source_details_source_type" {
  value = oci_core_instance.resname.source_details_source_type
}
