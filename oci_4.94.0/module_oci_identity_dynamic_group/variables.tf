...
variable "identity_dynamic_group_matching_rule" {
  description = "(Required)" #The value for matching_rule
  type = string
}
...
/*variable "identity_dynamic_group_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "identity_dynamic_group_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "identity_dynamic_group_timeouts_update" {
