...
output "dns_zone_soa_record_email" {
  value = azurestack_dns_zone.resname.soa_record_email
}

output "dns_zone_soa_record_fqdn" {
  value = azurestack_dns_zone.resname.soa_record_fqdn
}

output "dns_zone_soa_record_host_name" {
  value = azurestack_dns_zone.resname.soa_record_host_name
}
