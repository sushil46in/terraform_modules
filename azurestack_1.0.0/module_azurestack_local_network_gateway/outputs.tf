...
output "local_network_gateway_bgp_settings_asn" {
  value = azurestack_local_network_gateway.resname.bgp_settings_asn
}

output "local_network_gateway_bgp_settings_bgp_peering_address" {
  value = azurestack_local_network_gateway.resname.bgp_settings_bgp_peering_address
}

output "local_network_gateway_bgp_settings_peer_weight" {
  value = azurestack_local_network_gateway.resname.bgp_settings_peer_weight
}
