...
output "lb_frontend_ip_configuration_id" {
  value = azurestack_lb.resname.frontend_ip_configuration_id
}

output "lb_frontend_ip_configuration_inbound_nat_rules" {
  value = azurestack_lb.resname.frontend_ip_configuration_inbound_nat_rules
}

output "lb_frontend_ip_configuration_load_balancer_rules" {
  value = azurestack_lb.resname.frontend_ip_configuration_load_balancer_rules
}

output "lb_frontend_ip_configuration_name" {
  value = azurestack_lb.resname.frontend_ip_configuration_name
}

output "lb_frontend_ip_configuration_private_ip_address" {
  value = azurestack_lb.resname.frontend_ip_configuration_private_ip_address
}

output "lb_frontend_ip_configuration_private_ip_address_allocation" {
  value = azurestack_lb.resname.frontend_ip_configuration_private_ip_address_allocation
}

output "lb_frontend_ip_configuration_public_ip_address_id" {
  value = azurestack_lb.resname.frontend_ip_configuration_public_ip_address_id
}

output "lb_frontend_ip_configuration_subnet_id" {
  value = azurestack_lb.resname.frontend_ip_configuration_subnet_id
}
