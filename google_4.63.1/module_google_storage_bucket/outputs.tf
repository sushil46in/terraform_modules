...
output "storage_bucket_public_access_prevention" {
  value = google_storage_bucket.resname.public_access_prevention
}
...
output "storage_bucket_autoclass" {
  value = google_storage_bucket.resname.autoclass
}

output "storage_bucket_custom_placement_config" {
  value = google_storage_bucket.resname.custom_placement_config
}
