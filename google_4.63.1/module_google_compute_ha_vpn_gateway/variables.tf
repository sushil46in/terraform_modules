...
/*variable "compute_ha_vpn_gateway_stack_type" {
  description = "(Optional)" #The stack type for this VPN gateway to identify the IP protocols that are enabled. If not specified, IPV4_ONLY will be used. Default value: "IPV4_ONLY" Possible values: ["IPV4_ONLY", "IPV4_IPV6"]
  type = string
}*/
