...
/*variable "privateca_certificate_authority_deletion_protection" {
  description = "(Optional)" #Whether or not to allow Terraform to destroy the CertificateAuthority. Unless this field is set to false in Terraform state, a 'terraform destroy' or 'terraform apply' that would delete the instance will fail.
  type = bool
}*/

/*variable "privateca_certificate_authority_desired_state" {
  description = "(Optional)" #Desired state of the CertificateAuthority. Set this field to 'STAGED' to create a 'STAGED' root CA.
  type = string
}*/
...
/*variable "privateca_certificate_authority_skip_grace_period" {
...
variable "privateca_certificate_authority_name_constraints_critical" {
  description = "(Required)" #Indicates whether or not the name constraints are marked critical.
  type = bool
}

/*variable "privateca_certificate_authority_name_constraints_excluded_dns_names" {
...
/*variable "privateca_certificate_authority_name_constraints_excluded_email_addresses" {
...
/*variable "privateca_certificate_authority_name_constraints_excluded_ip_ranges" {
...
/*variable "privateca_certificate_authority_name_constraints_excluded_uris" {
  description = "(Optional)" #Contains the excluded URIs that apply to the host part of the name. The value can be a hostname or a domain with a leading period (like '.example.com')
  type = list
}*/

/*variable "privateca_certificate_authority_name_constraints_permitted_dns_names" {
...
/*variable "privateca_certificate_authority_name_constraints_permitted_email_addresses" {
...
/*variable "privateca_certificate_authority_name_constraints_permitted_ip_ranges" {
...
/*variable "privateca_certificate_authority_name_constraints_permitted_uris" {
