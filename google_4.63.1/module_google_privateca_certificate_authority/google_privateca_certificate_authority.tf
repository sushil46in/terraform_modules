...
resource "google_privateca_certificate_authority" "resname" {
  ...
  #skip_grace_period = var.privateca_certificate_authority_skip_grace_period
  ...
  config {
    ...
    x509_config {
      ...
      name_constraints {
        critical = var.privateca_certificate_authority_name_constraints_critical
        #excluded_dns_names = var.privateca_certificate_authority_name_constraints_excluded_dns_names
        #excluded_email_addresses = var.privateca_certificate_authority_name_constraints_excluded_email_addresses
        #excluded_ip_ranges = var.privateca_certificate_authority_name_constraints_excluded_ip_ranges
        #excluded_uris = var.privateca_certificate_authority_name_constraints_excluded_uris
        #permitted_dns_names = var.privateca_certificate_authority_name_constraints_permitted_dns_names
        #permitted_email_addresses = var.privateca_certificate_authority_name_constraints_permitted_email_addresses
        #permitted_ip_ranges = var.privateca_certificate_authority_name_constraints_permitted_ip_ranges
        #permitted_uris = var.privateca_certificate_authority_name_constraints_permitted_uris
      }
      policy_ids {
