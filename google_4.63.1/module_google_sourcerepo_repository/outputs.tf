...
output "sourcerepo_repository_pubsub_configs_service_account_email" {
  value = google_sourcerepo_repository.resname.service_account_email
}

output "sourcerepo_repository_pubsub_configs" {
  value = google_sourcerepo_repository.resname.pubsub_configs
}
