...
resource "google_compute_security_policy" "resname" {
  ...
  recaptcha_options_config {
    redirect_site_key = var.compute_security_policy_recaptcha_options_config_redirect_site_key
  }
  ...
  rule {
    ...
    header_action {
      request_headers_to_adds {
        header_name = var.compute_security_policy_request_headers_to_adds_header_name
        #header_value = var.compute_security_policy_request_headers_to_adds_header_value
      }
    }
    match {
