...
variable "compute_security_policy_json_custom_config_content_types" {
  description = "(Required)" #A list of custom Content-Type header values to apply the JSON parsing.
  type = set
}

variable "compute_security_policy_recaptcha_options_config_redirect_site_key" {
...
variable "compute_security_policy_request_headers_to_adds_header_name" {
  description = "(Required)" #The name of the header to set.
  type = string
}

/*variable "compute_security_policy_request_headers_to_adds_header_value" {
  description = "(Optional)" #The value to set the named header to.
  type = string
}*/
