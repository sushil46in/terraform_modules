...
/*variable "compute_instance_template_resource_policies" {
...
/*variable "compute_instance_template_advanced_machine_features_visible_core_count" {
...
/*variable "compute_instance_template_disk_source_snapshot" {
  description = "(Optional)" #The source snapshot to create this disk. When creating a new instance, one of initializeParams.sourceSnapshot, initializeParams.sourceImage, or disks.source is required except for local SSD.
  type = string
}*/
...
variable "compute_instance_template_source_image_encryption_key_kms_key_self_link" {
  description = "(Required)" #The self link of the encryption key that is stored in Google Cloud KMS.
  type = string
}

/*variable "compute_instance_template_source_image_encryption_key_kms_key_service_account" {
...
variable "compute_instance_template_source_snapshot_encryption_key_kms_key_self_link" {
  description = "(Required)" #The self link of the encryption key that is stored in Google Cloud KMS.
  type = string
}

/*variable "compute_instance_template_source_snapshot_encryption_key_kms_key_service_account" {
  description = "(Optional)" #The service account being used for the encryption request for the given KMS key. If absent, the Compute Engine default service account is used.
  type = string
}*/
