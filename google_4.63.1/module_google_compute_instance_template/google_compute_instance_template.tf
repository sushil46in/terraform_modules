...
resource "google_compute_instance_template" "resname" {
  ...
  #resource_policies = var.compute_instance_template_resource_policies
  ...
  advanced_machine_features {
    ...
    #visible_core_count = var.compute_instance_template_advanced_machine_features_visible_core_count
  }
  ...
  disk {
    ...
    #source_snapshot = var.compute_instance_template_disk_source_snapshot
    disk_encryption_key {
      kms_key_self_link = var.compute_instance_template_disk_encryption_key_kms_key_self_link
    }
    source_image_encryption_key {
      kms_key_self_link = var.compute_instance_template_source_image_encryption_key_kms_key_self_link
      #kms_key_service_account = var.compute_instance_template_source_image_encryption_key_kms_key_service_account
    }
    source_snapshot_encryption_key {
      kms_key_self_link = var.compute_instance_template_source_snapshot_encryption_key_kms_key_self_link
      #kms_key_service_account = var.compute_instance_template_source_snapshot_encryption_key_kms_key_service_account
    }
  }
