...
resource "google_compute_backend_service" "resname" {
  ...
  #compression_mode = var.compute_backend_service_compression_mode
  ...
  #edge_security_policy = var.compute_backend_service_edge_security_policy
  ...
  cdn_policy {
    ...
    cache_key_policy {
      ...
      #include_http_headers = var.compute_backend_service_cache_key_policy_include_http_headers
  ...
  locality_lb_policies {
    custom_policy {
      #data = var.compute_backend_service_custom_policy_data
      name = var.compute_backend_service_custom_policy_name
    }
    policy {
      name = var.compute_backend_service_policy_name
    }
  }
