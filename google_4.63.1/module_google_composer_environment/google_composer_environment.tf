  ...
  config {
    ...
    recovery_config {
      scheduled_snapshots_config {
        enabled = var.composer_environment_scheduled_snapshots_config_enabled
        #snapshot_creation_schedule = var.composer_environment_scheduled_snapshots_config_snapshot_creation_schedule
        #snapshot_location = var.composer_environment_scheduled_snapshots_config_snapshot_location
        #time_zone = var.composer_environment_scheduled_snapshots_config_time_zone
      }
    }
    software_config {
