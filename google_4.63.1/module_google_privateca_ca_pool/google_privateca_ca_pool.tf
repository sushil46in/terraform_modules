...
resource "google_privateca_ca_pool" "resname" {
  ...
  issuance_policy {
    ...
    baseline_values {
      ...
      name_constraints {
        critical = var.privateca_ca_pool_name_constraints_critical
        #excluded_dns_names = var.privateca_ca_pool_name_constraints_excluded_dns_names
        #excluded_email_addresses = var.privateca_ca_pool_name_constraints_excluded_email_addresses
        #excluded_ip_ranges = var.privateca_ca_pool_name_constraints_excluded_ip_ranges
        #excluded_uris = var.privateca_ca_pool_name_constraints_excluded_uris
        #permitted_dns_names = var.privateca_ca_pool_name_constraints_permitted_dns_names
        #permitted_email_addresses = var.privateca_ca_pool_name_constraints_permitted_email_addresses
        #permitted_ip_ranges = var.privateca_ca_pool_name_constraints_permitted_ip_ranges
        #permitted_uris = var.privateca_ca_pool_name_constraints_permitted_uris
      }
      policy_ids {
