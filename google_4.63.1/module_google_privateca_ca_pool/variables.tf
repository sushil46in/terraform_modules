...
variable "privateca_ca_pool_name_constraints_critical" {
  description = "(Required)" #Indicates whether or not the name constraints are marked critical.
  type = bool
}

/*variable "privateca_ca_pool_name_constraints_excluded_dns_names" {
...
/*variable "privateca_ca_pool_name_constraints_excluded_email_addresses" {
...
/*variable "privateca_ca_pool_name_constraints_excluded_ip_ranges" {
...
/*variable "privateca_ca_pool_name_constraints_excluded_uris" {
...
/*variable "privateca_ca_pool_name_constraints_permitted_dns_names" {
...
/*variable "privateca_ca_pool_name_constraints_permitted_email_addresses" {
...
/*variable "privateca_ca_pool_name_constraints_permitted_ip_ranges" {
...
/*variable "privateca_ca_pool_name_constraints_permitted_uris" {
