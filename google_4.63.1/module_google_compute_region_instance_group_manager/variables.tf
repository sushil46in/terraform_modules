...
variable "compute_region_instance_group_manager_base_instance_name" {
...
/*variable "compute_region_instance_group_manager_description" {
  description = "(Optional)" #An optional textual description of the instance group manager.
  type = string
}*/

/*variable "compute_region_instance_group_manager_list_managed_instances_results" {
  description = "(Optional)" #Pagination behavior of the listManagedInstances API method for this managed instance group. Valid values are: "PAGELESS", "PAGINATED". If PAGELESS (default), Pagination is disabled for the group's listManagedInstances API method. maxResults and pageToken query parameters are ignored and all instances are returned in a single response. If PAGINATED, pagination is enabled, maxResults and pageToken query parameters are respected.
  type = string
}*/

variable "compute_region_instance_group_manager_name" {
...
/*variable "compute_region_instance_group_manager_target_pools" {
...
/*variable "compute_region_instance_group_manager_wait_for_instances" {
...
/*variable "compute_region_instance_group_manager_wait_for_instances_status" {
...
variable "compute_region_instance_group_manager_auto_healing_policies_health_check" {
  description = "(Required)" #The health check resource that signals autohealing.
  type = string
}

variable "compute_region_instance_group_manager_auto_healing_policies_initial_delay_sec" {
...
variable "compute_region_instance_group_manager_named_port_name" {
  description = "(Required)" #The name of the port.
  type = string
}

variable "compute_region_instance_group_manager_named_port_port" {
  description = "(Required)" #The port number.
  type = number
}

/*variable "compute_region_instance_group_manager_stateful_disk_delete_rule" {
  description = "(Optional)" #A value that prescribes what should happen to the stateful disk when the VM instance is deleted. The available options are NEVER and ON_PERMANENT_INSTANCE_DELETION. NEVER - detach the disk when the VM is deleted, but do not delete the disk. ON_PERMANENT_INSTANCE_DELETION will delete the stateful disk when the VM is permanently deleted from the instance group. The default is NEVER.
  type = string
}*/

variable "compute_region_instance_group_manager_stateful_disk_device_name" {
  description = "(Required)" #The device name of the disk to be attached.
  type = string
}

/*variable "compute_region_instance_group_manager_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "compute_region_instance_group_manager_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "compute_region_instance_group_manager_timeouts_update" {
  description = "(Optional)" #The value for timeouts_update
  type = string
}*/

/*variable "compute_region_instance_group_manager_update_policy_instance_redistribution_type" {
...
/*variable "compute_region_instance_group_manager_update_policy_max_surge_percent" {
...
/*variable "compute_region_instance_group_manager_update_policy_max_unavailable_percent" {
...
variable "compute_region_instance_group_manager_update_policy_minimal_action" {
...
/*variable "compute_region_instance_group_manager_update_policy_most_disruptive_allowed_action" {
  description = "(Optional)" #Most disruptive action that is allowed to be taken on an instance. You can specify either NONE to forbid any actions, REFRESH to allow actions that do not need instance restart, RESTART to allow actions that can be applied without instance replacing or REPLACE to allow all possible actions. If the Updater determines that the minimal update action needed is more disruptive than most disruptive allowed action you specify it will not perform the update at all.
  type = string
}*/

/*variable "compute_region_instance_group_manager_update_policy_replacement_method" {
  description = "(Optional)" #The instance replacement method for regional managed instance groups. Valid values are: "RECREATE", "SUBSTITUTE". If SUBSTITUTE (default), the group replaces VM instances with new instances that have randomly generated names. If RECREATE, instance names are preserved.  You must also set max_unavailable_fixed or max_unavailable_percent to be greater than 0.
  type = string
}*/

variable "compute_region_instance_group_manager_update_policy_type" {
  description = "(Required)" #The type of update process. You can specify either PROACTIVE so that the instance group manager proactively executes actions in order to bring instances to their target versions or OPPORTUNISTIC so that no action is proactively executed but the update will be performed as part of other actions (for example, resizes or recreateInstances calls).
  type = string
}

variable "compute_region_instance_group_manager_version_instance_template" {
  description = "(Required)" #The full URL to an instance template from which all new instances of this version will be created.
  type = string
}

/*variable "compute_region_instance_group_manager_version_name" {
  description = "(Optional)" #Version name.
  type = string
}*/

/*variable "compute_region_instance_group_manager_target_size_fixed" {
  description = "(Optional)" #The number of instances which are managed for this version. Conflicts with percent.
  type = number
}*/

/*variable "compute_region_instance_group_manager_target_size_percent" {
