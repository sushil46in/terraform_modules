...
/*variable "app_engine_standard_app_version_delete_service_on_destroy" {
  description = "(Optional)" #If set to 'true', the service will be deleted if it is the last version.
  type = bool
}*/
...
/*variable "app_engine_standard_app_version_vpc_access_connector_egress_setting" {
  description = "(Optional)" #The egress setting for the connector, controlling what traffic is diverted through it.
  type = string
}*/
