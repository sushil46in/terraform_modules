...
/*variable "compute_external_vpn_gateway_labels" {
  description = "(Optional)" #Labels for the external VPN gateway resource.
  type = map
}*/
...
/*variable "compute_external_vpn_gateway_interface_id" {
  description = "(Optional)" #The numeric ID for this interface. Allowed values are based on the redundancy type of this external VPN gateway  '0 - SINGLE_IP_INTERNALLY_REDUNDANT'  '0, 1 - TWO_IPS_REDUNDANCY'  '0, 1, 2, 3 - FOUR_IPS_REDUNDANCY'
  type = number
}*/
