...
variable "dataplex_zone_iam_member_dataplex_zone" {
  description = "(Required)" #The value for dataplex_zone
  type = string
}

variable "dataplex_zone_iam_member_lake" {
  description = "(Required)" #The value for lake
  type = string
}

variable "dataplex_zone_iam_member_member" {
  description = "(Required)" #The value for member
  type = string
}

variable "dataplex_zone_iam_member_role" {
  description = "(Required)" #The value for role
  type = string
}

/*variable "dataplex_zone_iam_member_condition_description" {
  description = "(Optional)" #The value for condition_description
  type = string
}*/

variable "dataplex_zone_iam_member_condition_expression" {
  description = "(Required)" #The value for condition_expression
  type = string
}

variable "dataplex_zone_iam_member_condition_title" {
