...
resource "google_bigquery_table" "resname" {
  ...
  external_data_configuration {
    ...
    #reference_file_schema_uri = var.bigquery_table_external_data_configuration_reference_file_schema_uri
    ...
    avro_options {
      use_avro_logical_types = var.bigquery_table_avro_options_use_avro_logical_types
    }
    csv_options {
