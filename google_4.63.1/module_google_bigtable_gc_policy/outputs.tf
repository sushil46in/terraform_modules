...
output "bigtable_gc_policy_max_age_days" {
  value = google_bigtable_gc_policy.resname.days
}

output "bigtable_gc_policy_max_age_duration" {
  value = google_bigtable_gc_policy.resname.duration
}

output "bigtable_gc_policy_max_age" {
  value = google_bigtable_gc_policy.resname.max_age
}

output "bigtable_gc_policy_max_version" {
  value = google_bigtable_gc_policy.resname.max_version
}
