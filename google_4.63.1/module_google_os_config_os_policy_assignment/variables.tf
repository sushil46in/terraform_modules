...
/*variable "os_config_os_policy_assignment_skip_await_rollout" {
  description = "(Optional)" #Set to true to skip awaiting rollout during resource creation and update.
  type = bool
}*/
