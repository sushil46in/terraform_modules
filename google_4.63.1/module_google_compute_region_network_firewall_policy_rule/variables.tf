...
variable "compute_region_network_firewall_policy_rule_action" {
...
/*variable "compute_region_network_firewall_policy_rule_description" {
  description = "(Optional)" #An optional description for this resource.
  type = string
}*/

variable "compute_region_network_firewall_policy_rule_direction" {
  description = "(Required)" #The direction in which this rule applies. Possible values: INGRESS, EGRESS
  type = string
}

/*variable "compute_region_network_firewall_policy_rule_disabled" {
...
/*variable "compute_region_network_firewall_policy_rule_enable_logging" {
...
variable "compute_region_network_firewall_policy_rule_firewall_policy" {
  description = "(Required)" #The firewall policy of the resource.
  type = string
}

variable "compute_region_network_firewall_policy_rule_priority" {
...
/*variable "compute_region_network_firewall_policy_rule_layer4_configs_ports" {
...
variable "compute_region_network_firewall_policy_rule_src_secure_tags_name" {
  description = "(Required)" #Name of the secure tag, created with TagManager's TagValue API. @pattern tagValues/[0-9]+
  type = string
}

variable "compute_region_network_firewall_policy_rule_target_secure_tags_name" {
  description = "(Required)" #Name of the secure tag, created with TagManager's TagValue API. @pattern tagValues/[0-9]+
  type = string
}

/*variable "compute_region_network_firewall_policy_rule_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "compute_region_network_firewall_policy_rule_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "compute_region_network_firewall_policy_rule_timeouts_update" {
