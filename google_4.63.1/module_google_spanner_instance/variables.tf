...
/*variable "spanner_instance_force_destroy" {
  description = "(Optional)" #When deleting a spanner instance, this boolean option will delete all backups of this instance. This must be set to true if you created a backup manually in the console.
  type = bool
}*/
