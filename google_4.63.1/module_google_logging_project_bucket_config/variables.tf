...
variable "logging_project_bucket_config_bucket_id" {
  description = "(Required)" #The name of the logging bucket. Logging automatically creates two log buckets: _Required and _Default.
  type = string
}

/*variable "logging_project_bucket_config_enable_analytics" {
  description = "(Optional)" #Enable log analytics for the bucket. Cannot be disabled once enabled.
  type = bool
}*/

variable "logging_project_bucket_config_location" {
  description = "(Required)" #The location of the bucket.
  type = string
}

variable "logging_project_bucket_config_project" {
  description = "(Required)" #The parent project that contains the logging bucket.
  type = string
}

/*variable "logging_project_bucket_config_retention_days" {
...
variable "logging_project_bucket_config_cmek_settings_kms_key_name" {
