...
/*variable "compute_instance_advanced_machine_features_visible_core_count" {
...
/*variable "compute_instance_scratch_disk_size" {
  description = "(Optional)" #The size of the disk in gigabytes. One of 375 or 3000.
  type = number
}*/
