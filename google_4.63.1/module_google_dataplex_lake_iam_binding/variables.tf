...
variable "dataplex_lake_iam_binding_lake" {
  description = "(Required)" #The value for lake
  type = string
}

variable "dataplex_lake_iam_binding_members" {
  description = "(Required)" #The value for members
  type = set
}

variable "dataplex_lake_iam_binding_role" {
  description = "(Required)" #The value for role
  type = string
}

/*variable "dataplex_lake_iam_binding_condition_description" {
  description = "(Optional)" #The value for condition_description
  type = string
}*/

variable "dataplex_lake_iam_binding_condition_expression" {
  description = "(Required)" #The value for condition_expression
  type = string
}

variable "dataplex_lake_iam_binding_condition_title" {
