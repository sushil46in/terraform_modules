...
output "bigquery_reservation_autoscale_current_slots" {
  value = google_bigquery_reservation.resname.current_slots
}

output "bigquery_reservation_autoscale" {
  value = google_bigquery_reservation.resname.autoscale
}
