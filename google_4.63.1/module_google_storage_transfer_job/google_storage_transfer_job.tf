...
resource "google_storage_transfer_job" "resname" {
  ...
  notification_config {
    #event_types = var.storage_transfer_job_notification_config_event_types
    payload_format = var.storage_transfer_job_notification_config_payload_format
    pubsub_topic = var.storage_transfer_job_notification_config_pubsub_topic
  }
  ...
  transfer_spec {
    ...
    object_conditions {
      ...
      #last_modified_before = var.storage_transfer_job_object_conditions_last_modified_before
      #last_modified_since = var.storage_transfer_job_object_conditions_last_modified_since
    ...
    transfer_options {
      ...
      #overwrite_when = var.storage_transfer_job_transfer_options_overwrite_when
    }
  }
