...
resource "google_bigquery_dataset" "resname" {
  ...
  access {
    ...
    routine {
      dataset_id = var.bigquery_dataset_routine_dataset_id
      project_id = var.bigquery_dataset_routine_project_id
      routine_id = var.bigquery_dataset_routine_routine_id
    }
    view {
