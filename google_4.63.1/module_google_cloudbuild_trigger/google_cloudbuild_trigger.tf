...
resource "google_cloudbuild_trigger" "resname" {
  ...
  bitbucket_server_trigger_config {
    bitbucket_server_config_resource = var.cloudbuild_trigger_bitbucket_server_trigger_config_bitbucket_server_config_resource
    project_key = var.cloudbuild_trigger_bitbucket_server_trigger_config_project_key
    repo_slug = var.cloudbuild_trigger_bitbucket_server_trigger_config_repo_slug
    pull_request {
  ...
  build {
    ...
    step {
      ...
      #script = var.cloudbuild_trigger_step_script
  ...
  git_file_source {
    #github_enterprise_config = var.cloudbuild_trigger_git_file_source_github_enterprise_config
  ...
  github {
    #enterprise_config_resource_name = var.cloudbuild_trigger_github_enterprise_config_resource_name
  ...
  source_to_build {
    #github_enterprise_config = var.cloudbuild_trigger_source_to_build_github_enterprise_config
