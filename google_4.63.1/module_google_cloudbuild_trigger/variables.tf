...
variable "cloudbuild_trigger_bitbucket_server_trigger_config_bitbucket_server_config_resource" {
  description = "(Required)" #The Bitbucket server config resource that this trigger config maps to.
  type = string
}

variable "cloudbuild_trigger_bitbucket_server_trigger_config_project_key" {
...
variable "cloudbuild_trigger_bitbucket_server_trigger_config_repo_slug" {
...
/*variable "cloudbuild_trigger_pull_request_comment_control" {
  description = "(Optional)" #Configure builds to run whether a repository owner or collaborator need to comment /gcbrun. Possible values: ["COMMENTS_DISABLED", "COMMENTS_ENABLED", "COMMENTS_ENABLED_FOR_EXTERNAL_CONTRIBUTORS_ONLY"]
  type = string
}*/
...
/*variable "cloudbuild_trigger_step_script" {
...
/*variable "cloudbuild_trigger_git_file_source_github_enterprise_config" {
...
variable "cloudbuild_trigger_git_file_source_repo_type" {
  description = "(Required)" #The type of the repo, since it may not be explicit from the repo field (e.g from a URL).  Values can be UNKNOWN, CLOUD_SOURCE_REPOSITORIES, GITHUB, BITBUCKET_SERVER Possible values: ["UNKNOWN", "CLOUD_SOURCE_REPOSITORIES", "GITHUB", "BITBUCKET_SERVER"]
  type = string
}
...
/*variable "cloudbuild_trigger_github_enterprise_config_resource_name" {
  description = "(Optional)" #The resource name of the github enterprise config that should be applied to this installation. For example: "projects/{$projectId}/locations/{$locationId}/githubEnterpriseConfigs/{$configId}"
  type = string
}*/
...
/*variable "cloudbuild_trigger_source_to_build_github_enterprise_config" {
  description = "(Optional)" #The full resource name of the github enterprise config. Format: projects/{project}/locations/{location}/githubEnterpriseConfigs/{id}. projects/{project}/githubEnterpriseConfigs/{id}.
  type = string
}*/
