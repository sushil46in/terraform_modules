...
resource "google_bigquery_connection" "resname" {
  ...
  azure {
    ...
    #federated_application_client_id = var.bigquery_connection_azure_federated_application_client_id
  }
  ...
  cloud_spanner {
    ...
    #use_serverless_analytics = var.bigquery_connection_cloud_spanner_use_serverless_analytics
  }
