...
variable "bigquery_dataset_access_routine_dataset_id" {
  description = "(Required)" #The ID of the dataset containing this table.
  type = string
}

variable "bigquery_dataset_access_routine_project_id" {
  description = "(Required)" #The ID of the project containing this table.
  type = string
}

variable "bigquery_dataset_access_routine_routine_id" {
