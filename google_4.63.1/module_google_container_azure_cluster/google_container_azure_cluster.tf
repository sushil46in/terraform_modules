...
resource "google_container_azure_cluster" "resname" {
  ...
  azure_services_authentication {
    application_id = var.container_azure_cluster_azure_services_authentication_application_id
    tenant_id = var.container_azure_cluster_azure_services_authentication_tenant_id
  }
