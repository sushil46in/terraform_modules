...
/*variable "compute_region_url_map_cors_policy_disabled" {
  description = "(Optional)" #If true, the setting specifies the CORS policy is disabled. The default value of false, which indicates that the CORS policy is in effect.
  type = bool
}*/
...
/*variable "compute_region_url_map_url_rewrite_host_rewrite" {
  description = "(Optional)" #Before forwarding the request to the selected service, the request's host header is replaced with contents of hostRewrite. The value must be from 1 to 255 characters.
  type = string
}*/
...
/*variable "compute_region_url_map_request_headers_to_add_replace" {
  description = "(Optional)" #If false, headerValue is appended to any values that already exist for the header. If true, headerValue is set for the header, discarding any values that were set for that header. The default value is false.
  type = bool
}*/
...
/*variable "compute_region_url_map_url_redirect_strip_query" {
  description = "(Optional)" #If set to true, any accompanying query portion of the original URL is removed prior to redirecting the request. If set to false, the query portion of the original URL is retained. The default value is false.
  type = bool
}*/
