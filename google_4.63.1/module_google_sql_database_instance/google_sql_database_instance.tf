...
resource "google_sql_database_instance" "resname" {
  ...
  clone {
    ...
    #database_names = var.sql_database_instance_clone_database_names
  ...
  settings {
    ...
    #deletion_protection_enabled = var.sql_database_instance_settings_deletion_protection_enabled
    ...
    #time_zone = var.sql_database_instance_settings_time_zone
    ...
    deny_maintenance_period {
      end_date = var.sql_database_instance_deny_maintenance_period_end_date
      start_date = var.sql_database_instance_deny_maintenance_period_start_date
      time = var.sql_database_instance_deny_maintenance_period_time
    }
    insights_config {
    ...
    ip_configuration {
      ...
      #enable_private_path_for_google_cloud_services = var.sql_database_instance_ip_configuration_enable_private_path_for_google_cloud_services
