...
/*variable "sql_database_instance_deletion_protection" {
  description = "(Optional)" #Used to block Terraform from deleting a SQL Instance. Defaults to true.
  type = bool
}*/
...
/*variable "sql_database_instance_clone_database_names" {
  description = "(Optional)" #(SQL Server only, use with point_in_time) clone only the specified databases from the source instance. Clone all databases if empty.
  type = list
}*/
...
/*variable "sql_database_instance_replica_configuration_connect_retry_interval" {
  description = "(Optional)" #The number of seconds between connect retries. MySQL's default is 60 seconds.
  type = number
}*/
...
/*variable "sql_database_instance_settings_deletion_protection_enabled" {
  description = "(Optional)" #Configuration to protect against accidental instance deletion.
  type = bool
}*/
...
/*variable "sql_database_instance_settings_time_zone" {
  description = "(Optional)" #The time_zone to be used by the database engine (supported only for SQL Server), in SQL Server timezone format.
  type = string
}*/
...
variable "sql_database_instance_deny_maintenance_period_end_date" {
  description = "(Required)" #End date before which maintenance will not take place. The date is in format yyyy-mm-dd i.e., 2020-11-01, or mm-dd, i.e., 11-01
  type = string
}

variable "sql_database_instance_deny_maintenance_period_start_date" {
  description = "(Required)" #Start date after which maintenance will not take place. The date is in format yyyy-mm-dd i.e., 2020-11-01, or mm-dd, i.e., 11-01
  type = string
}

variable "sql_database_instance_deny_maintenance_period_time" {
  description = "(Required)" #Time in UTC when the "deny maintenance period" starts on start_date and ends on end_date. The time is in format: HH:mm:SS, i.e., 00:00:00
  type = string
}
...
/*variable "sql_database_instance_ip_configuration_enable_private_path_for_google_cloud_services" {
...
/*variable "sql_database_instance_sql_server_audit_config_bucket" {
  description = "(Optional)" #The name of the destination bucket (e.g., gs://mybucket).
  type = string
}*/
