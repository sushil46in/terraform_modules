...
/*variable "dataproc_cluster_metrics_metric_overrides" {
  description = "(Optional)" #Specify one or more [available OSS metrics] (https://cloud.google.com/dataproc/docs/guides/monitoring#available_oss_metrics) to collect.
  type = set
}*/

variable "dataproc_cluster_metrics_metric_source" {
  description = "(Required)" #A source for the collection of Dataproc OSS metrics (see [available OSS metrics] (https://cloud.google.com//dataproc/docs/guides/monitoring#available_oss_metrics)).
  type = string
}
...
variable "dataproc_cluster_node_group_affinity_node_group_uri" {
  description = "(Required)" #The URI of a sole-tenant that the cluster will be created on.
  type = string
}

/*variable "dataproc_cluster_reservation_affinity_consume_reservation_type" {
  description = "(Optional)" #Type of reservation to consume.
  type = string
}*/

/*variable "dataproc_cluster_reservation_affinity_key" {
  description = "(Optional)" #Corresponds to the label key of reservation resource.
  type = string
}*/

/*variable "dataproc_cluster_reservation_affinity_values" {
