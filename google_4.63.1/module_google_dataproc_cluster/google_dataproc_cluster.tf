...
resource "google_dataproc_cluster" "resname" {
  ...
  cluster_config {
    ...
    dataproc_metric_config {
      metrics {
        #metric_overrides = var.dataproc_cluster_metrics_metric_overrides
        metric_source = var.dataproc_cluster_metrics_metric_source
      }
    }
    encryption_config {
    ...
    gce_cluster_config {
      ...
      node_group_affinity {
        node_group_uri = var.dataproc_cluster_node_group_affinity_node_group_uri
      }
      reservation_affinity {
        #consume_reservation_type = var.dataproc_cluster_reservation_affinity_consume_reservation_type
        #key = var.dataproc_cluster_reservation_affinity_key
        #values = var.dataproc_cluster_reservation_affinity_values
      }
