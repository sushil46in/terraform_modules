...
/*variable "certificate_manager_certificate_self_managed_certificate_pem" {
  description = "(Optional)" #Deprecated The certificate chain in PEM-encoded form.  Leaf certificate comes first, followed by intermediate ones if any.
  type = string
}*/

/*variable "certificate_manager_certificate_self_managed_pem_certificate" {
...
/*variable "certificate_manager_certificate_self_managed_pem_private_key" {
  description = "(Optional)" #The private key of the leaf certificate in PEM-encoded form.
  type = string
}*/

/*variable "certificate_manager_certificate_self_managed_private_key_pem" {
  description = "(Optional)" #Deprecated The private key of the leaf certificate in PEM-encoded form.
  type = string
}*/
