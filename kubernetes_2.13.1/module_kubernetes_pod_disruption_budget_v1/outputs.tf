...
output "pod_disruption_budget_v1_metadata_generation" {
  value = kubernetes_pod_disruption_budget_v1.resname.metadata_generation
}

output "pod_disruption_budget_v1_metadata_name" {
  value = kubernetes_pod_disruption_budget_v1.resname.metadata_name
}

output "pod_disruption_budget_v1_metadata_resource_version" {
  value = kubernetes_pod_disruption_budget_v1.resname.metadata_resource_version
}

output "pod_disruption_budget_v1_metadata_uid" {
  value = kubernetes_pod_disruption_budget_v1.resname.metadata_uid
}
