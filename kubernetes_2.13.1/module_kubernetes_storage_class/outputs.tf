...
output "storage_class_metadata_generation" {
  value = kubernetes_storage_class.resname.metadata_generation
}

output "storage_class_metadata_name" {
  value = kubernetes_storage_class.resname.metadata_name
}

output "storage_class_metadata_resource_version" {
  value = kubernetes_storage_class.resname.metadata_resource_version
}

output "storage_class_metadata_uid" {
  value = kubernetes_storage_class.resname.metadata_uid
}
