...
/*variable "network_policy_metadata_annotations" {
...
/*variable "network_policy_metadata_generate_name" {
...
/*variable "network_policy_metadata_labels" {
...
/*variable "network_policy_ports_port" {
...
/*variable "network_policy_namespace_selector_match_labels" {
...
/*variable "network_policy_pod_selector_match_labels" {
  description = "(Optional)" #A map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of `match_expressions`, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
  type = map
}*/
