...
variable "priority_class_v1_value" {
...
/*variable "priority_class_v1_metadata_annotations" {
...
/*variable "priority_class_v1_metadata_generate_name" {
...
/*variable "priority_class_v1_metadata_labels" {
