...
output "priority_class_v1_metadata_generation" {
  value = kubernetes_priority_class_v1.resname.generation
}

output "priority_class_v1_metadata_name" {
  value = kubernetes_priority_class_v1.resname.name
}

output "priority_class_v1_metadata_resource_version" {
  value = kubernetes_priority_class_v1.resname.resource_version
}

output "priority_class_v1_metadata_uid" {
  value = kubernetes_priority_class_v1.resname.uid
}

output "priority_class_v1_metadata" {
  value = kubernetes_priority_class_v1.resname.metadata
}
