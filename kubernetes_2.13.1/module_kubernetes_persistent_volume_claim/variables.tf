...
/*variable "persistent_volume_claim_metadata_generate_name" {
...
/*variable "persistent_volume_claim_metadata_labels" {
...
/*variable "persistent_volume_claim_resources_limits" {
...
/*variable "persistent_volume_claim_resources_requests" {
...
/*variable "persistent_volume_claim_selector_match_labels" {
...
/*variable "persistent_volume_claim_timeouts_create" {
