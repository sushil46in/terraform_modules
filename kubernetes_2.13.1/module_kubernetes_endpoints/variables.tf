...
/*variable "endpoints_metadata_annotations" {
...
/*variable "endpoints_metadata_generate_name" {
...
/*variable "endpoints_metadata_labels" {
...
/*variable "endpoints_address_node_name" {
  description = "(Optional)" #Node hosting this endpoint. This can be used to determine endpoints local to a node.
  type = string
}*/

/*variable "endpoints_not_ready_address_hostname" {
  description = "(Optional)" #The Hostname of this endpoint.
  type = string
}*/

variable "endpoints_not_ready_address_ip" {
  description = "(Required)" #The IP of this endpoint. May not be loopback (127.0.0.0/8), link-local (169.254.0.0/16), or link-local multicast ((224.0.0.0/24).
  type = string
}

/*variable "endpoints_not_ready_address_node_name" {
  description = "(Optional)" #Node hosting this endpoint. This can be used to determine endpoints local to a node.
  type = string
}*/

/*variable "endpoints_port_name" {
