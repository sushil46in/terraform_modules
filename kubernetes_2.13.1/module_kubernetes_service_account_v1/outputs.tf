...
output "service_account_v1_metadata_generation" {
  value = kubernetes_service_account_v1.resname.metadata_generation
}

output "service_account_v1_metadata_name" {
  value = kubernetes_service_account_v1.resname.metadata_name
}

output "service_account_v1_metadata_resource_version" {
  value = kubernetes_service_account_v1.resname.metadata_resource_version
}

output "service_account_v1_metadata_uid" {
  value = kubernetes_service_account_v1.resname.metadata_uid
}
