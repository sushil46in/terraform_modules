...
/*variable "pod_security_policy_metadata_annotations" {
...
/*variable "pod_security_policy_metadata_labels" {
...
/*variable "pod_security_policy_spec_allowed_proc_mount_types" {
...
/*variable "pod_security_policy_spec_allowed_unsafe_sysctls" {
...
/*variable "pod_security_policy_spec_default_add_capabilities" {
  description = "(Optional)" #defaultAddCapabilities is the default set of capabilities that will be added to the container unless the pod spec specifically drops the capability.  You may not list a capability in both defaultAddCapabilities and requiredDropCapabilities. Capabilities added here are implicitly allowed, and need not be included in the allowedCapabilities list.
  type = list
}*/

/*variable "pod_security_policy_spec_forbidden_sysctls" {
...
variable "pod_security_policy_allowed_flex_volumes_driver" {
  description = "(Required)" #driver is the name of the Flexvolume driver.
  type = string
}

variable "pod_security_policy_allowed_host_paths_path_prefix" {
...
/*variable "pod_security_policy_allowed_host_paths_read_only" {
...
variable "pod_security_policy_fs_group_rule" {
  description = "(Required)" #rule is the strategy that will dictate what FSGroup is used in the SecurityContext.
  type = string
}

variable "pod_security_policy_range_max" {
  description = "(Required)" #max is the end of the range, inclusive.
  type = number
}

variable "pod_security_policy_range_min" {
  description = "(Required)" #min is the start of the range, inclusive.
  type = number
}

variable "pod_security_policy_host_ports_max" {
  description = "(Required)" #max is the end of the range, inclusive.
  type = number
}

variable "pod_security_policy_host_ports_min" {
  description = "(Required)" #min is the start of the range, inclusive.
  type = number
}

variable "pod_security_policy_run_as_group_rule" {
...
variable "pod_security_policy_run_as_user_rule" {
