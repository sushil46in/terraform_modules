...
/*variable "horizontal_pod_autoscaler_metadata_annotations" {
...
/*variable "horizontal_pod_autoscaler_metadata_generate_name" {
...
/*variable "horizontal_pod_autoscaler_metadata_labels" {
...
variable "horizontal_pod_autoscaler_policy_period_seconds" {
...
variable "horizontal_pod_autoscaler_policy_type" {
  description = "(Required)" #Type is used to specify the scaling policy: Percent or Pods
  type = string
}

variable "horizontal_pod_autoscaler_policy_value" {
  description = "(Required)" #Value contains the amount of change which is permitted by the policy. It must be greater than zero.
  type = number
}

/*variable "horizontal_pod_autoscaler_scale_up_select_policy" {
  description = "(Optional)" #Used to specify which policy should be used. If not set, the default value Max is used.
  type = string
}*/

/*variable "horizontal_pod_autoscaler_scale_up_stabilization_window_seconds" {
  description = "(Optional)" #Number of seconds for which past recommendations should be considered while scaling up or scaling down. This value must be greater than or equal to zero and less than or equal to 3600 (one hour). If not set, use the default values: - For scale up: 0 (i.e. no stabilization is done). - For scale down: 300 (i.e. the stabilization window is 300 seconds long).
  type = number
}*/
...
variable "horizontal_pod_autoscaler_metric_type" {
...
variable "horizontal_pod_autoscaler_container_resource_container" {
  description = "(Required)" #name of the container in the pods of the scaling target
  type = string
}

variable "horizontal_pod_autoscaler_container_resource_name" {
  description = "(Required)" #name of the resource in question
  type = string
}

/*variable "horizontal_pod_autoscaler_target_average_utilization" {
...
/*variable "horizontal_pod_autoscaler_target_average_value" {
...
/*variable "horizontal_pod_autoscaler_match_expressions_key" {
  description = "(Optional)" #The label key that the selector applies to.
  type = string
}*/

/*variable "horizontal_pod_autoscaler_match_expressions_operator" {
  description = "(Optional)" #A key's relationship to a set of values. Valid operators ard `In`, `NotIn`, `Exists` and `DoesNotExist`.
  type = string
}*/

/*variable "horizontal_pod_autoscaler_match_expressions_values" {
...
variable "horizontal_pod_autoscaler_described_object_api_version" {
  description = "(Required)" #API version of the referent
  type = string
}

variable "horizontal_pod_autoscaler_described_object_kind" {
...
variable "horizontal_pod_autoscaler_described_object_name" {
...
variable "horizontal_pod_autoscaler_resource_name" {
...
/*variable "horizontal_pod_autoscaler_scale_target_ref_api_version" {
  description = "(Optional)" #API version of the referent
  type = string
}*/

variable "horizontal_pod_autoscaler_scale_target_ref_kind" {
...
variable "horizontal_pod_autoscaler_scale_target_ref_name" {
  description = "(Required)" #Name of the referent. More info: http://kubernetes.io/docs/user-guide/identifiers#names
  type = string
}
