...
output "secret_v1_metadata_generation" {
  value = kubernetes_secret_v1.resname.metadata_generation
}

output "secret_v1_metadata_name" {
  value = kubernetes_secret_v1.resname.metadata_name
}

output "secret_v1_metadata_resource_version" {
  value = kubernetes_secret_v1.resname.metadata_resource_version
}

output "secret_v1_metadata_uid" {
  value = kubernetes_secret_v1.resname.metadata_uid
}
