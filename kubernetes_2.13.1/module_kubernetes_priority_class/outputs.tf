...
output "priority_class_metadata_generation" {
  value = kubernetes_priority_class.resname.generation
}

output "priority_class_metadata_name" {
  value = kubernetes_priority_class.resname.name
}

output "priority_class_metadata_resource_version" {
  value = kubernetes_priority_class.resname.resource_version
}

output "priority_class_metadata_uid" {
  value = kubernetes_priority_class.resname.uid
}

output "priority_class_metadata" {
  value = kubernetes_priority_class.resname.metadata
}
