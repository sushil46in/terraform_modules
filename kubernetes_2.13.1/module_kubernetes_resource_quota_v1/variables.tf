...
/*variable "resource_quota_v1_metadata_annotations" {
...
/*variable "resource_quota_v1_metadata_generate_name" {
...
/*variable "resource_quota_v1_metadata_labels" {
...
/*variable "resource_quota_v1_spec_scopes" {
...
variable "resource_quota_v1_match_expression_operator" {
  description = "(Required)" #Represents a scope's relationship to a set of values.
  type = string
}

variable "resource_quota_v1_match_expression_scope_name" {
  description = "(Required)" #The name of the scope that the selector applies to.
  type = string
}

/*variable "resource_quota_v1_match_expression_values" {
  description = "(Optional)" #A list of scope selector requirements by scope of the resources.
  type = set
}*/

/*variable "resource_quota_v1_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "resource_quota_v1_timeouts_update" {
