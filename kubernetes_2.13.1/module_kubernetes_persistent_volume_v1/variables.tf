...
/*variable "persistent_volume_v1_metadata_annotations" {
...
/*variable "persistent_volume_v1_metadata_labels" {
...
variable "persistent_volume_v1_spec_access_modes" {
...
variable "persistent_volume_v1_spec_capacity" {
...
/*variable "persistent_volume_v1_spec_mount_options" {
  description = "(Optional)" #A list of mount options, e.g. ["ro", "soft"]. Not validated - mount will simply fail if one is invalid.
  type = set
}*/

/*variable "persistent_volume_v1_spec_persistent_volume_reclaim_policy" {
...
/*variable "persistent_volume_v1_spec_storage_class_name" {
...
/*variable "persistent_volume_v1_spec_volume_mode" {
...
variable "persistent_volume_v1_match_fields_key" {
  description = "(Required)" #The label key that the selector applies to.
  type = string
}

variable "persistent_volume_v1_match_fields_operator" {
  description = "(Required)" #A key's relationship to a set of values. Valid operators ard `In`, `NotIn`, `Exists`, `DoesNotExist`, `Gt`, and `Lt`.
  type = string
}

/*variable "persistent_volume_v1_match_fields_values" {
  description = "(Optional)" #An array of string values. If the operator is `In` or `NotIn`, the values array must be non-empty. If the operator is `Exists` or `DoesNotExist`, the values array must be empty. This array is replaced during a strategic merge patch.
  type = set
}*/

/*variable "persistent_volume_v1_aws_elastic_block_store_fs_type" {
...
/*variable "persistent_volume_v1_aws_elastic_block_store_partition" {
...
/*variable "persistent_volume_v1_aws_elastic_block_store_read_only" {
...
variable "persistent_volume_v1_aws_elastic_block_store_volume_id" {
...
variable "persistent_volume_v1_azure_disk_caching_mode" {
  description = "(Required)" #Host Caching mode: None, Read Only, Read Write.
  type = string
}

variable "persistent_volume_v1_azure_disk_data_disk_uri" {
  description = "(Required)" #The URI the data disk in the blob storage
  type = string
}

variable "persistent_volume_v1_azure_disk_disk_name" {
  description = "(Required)" #The Name of the data disk in the blob storage
  type = string
}

/*variable "persistent_volume_v1_azure_disk_fs_type" {
...
/*variable "persistent_volume_v1_azure_disk_read_only" {
  description = "(Optional)" #Whether to force the read-only setting in VolumeMounts. Defaults to false (read/write).
  type = bool
}*/

/*variable "persistent_volume_v1_azure_file_read_only" {
  description = "(Optional)" #Whether to force the read-only setting in VolumeMounts. Defaults to false (read/write).
  type = bool
}*/

variable "persistent_volume_v1_azure_file_secret_name" {
  description = "(Required)" #The name of secret that contains Azure Storage Account Name and Key
  type = string
}

/*variable "persistent_volume_v1_azure_file_secret_namespace" {
...
variable "persistent_volume_v1_azure_file_share_name" {
  description = "(Required)" #Share Name
  type = string
}

variable "persistent_volume_v1_ceph_fs_monitors" {
...
/*variable "persistent_volume_v1_ceph_fs_path" {
  description = "(Optional)" #Used as the mounted root, rather than the full Ceph tree, default is /
  type = string
}*/

/*variable "persistent_volume_v1_ceph_fs_read_only" {
...
/*variable "persistent_volume_v1_ceph_fs_secret_file" {
...
/*variable "persistent_volume_v1_ceph_fs_user" {
...
/*variable "persistent_volume_v1_cinder_read_only" {
...
variable "persistent_volume_v1_cinder_volume_id" {
...
variable "persistent_volume_v1_csi_driver" {
...
/*variable "persistent_volume_v1_csi_fs_type" {
  description = "(Optional)" #Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
  type = string
}*/

/*variable "persistent_volume_v1_csi_read_only" {
...
/*variable "persistent_volume_v1_csi_volume_attributes" {
  description = "(Optional)" #Attributes of the volume to publish.
  type = map
}*/

variable "persistent_volume_v1_csi_volume_handle" {
...
/*variable "persistent_volume_v1_controller_expand_secret_ref_name" {
  description = "(Optional)" #Name of the referent. More info: http://kubernetes.io/docs/user-guide/identifiers#names
  type = string
}*/

/*variable "persistent_volume_v1_controller_publish_secret_ref_name" {
  description = "(Optional)" #Name of the referent. More info: http://kubernetes.io/docs/user-guide/identifiers#names
  type = string
}*/

/*variable "persistent_volume_v1_node_publish_secret_ref_name" {
  description = "(Optional)" #Name of the referent. More info: http://kubernetes.io/docs/user-guide/identifiers#names
  type = string
}*/

/*variable "persistent_volume_v1_node_stage_secret_ref_name" {
  description = "(Optional)" #Name of the referent. More info: http://kubernetes.io/docs/user-guide/identifiers#names
  type = string
}*/

/*variable "persistent_volume_v1_fc_fs_type" {
  description = "(Optional)" #Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
  type = string
}*/

variable "persistent_volume_v1_fc_lun" {
  description = "(Required)" #FC target lun number
  type = number
}

/*variable "persistent_volume_v1_fc_read_only" {
  description = "(Optional)" #Whether to force the read-only setting in VolumeMounts. Defaults to false (read/write).
  type = bool
}*/

variable "persistent_volume_v1_fc_target_ww_ns" {
  description = "(Required)" #FC target worldwide names (WWNs)
  type = set
}

variable "persistent_volume_v1_flex_volume_driver" {
  description = "(Required)" #Driver is the name of the driver to use for this volume.
  type = string
}

/*variable "persistent_volume_v1_flex_volume_fs_type" {
...
/*variable "persistent_volume_v1_flex_volume_options" {
  description = "(Optional)" #Extra command options if any.
  type = map
}*/

/*variable "persistent_volume_v1_flex_volume_read_only" {
...
/*variable "persistent_volume_v1_flocker_dataset_name" {
...
/*variable "persistent_volume_v1_flocker_dataset_uuid" {
  description = "(Optional)" #UUID of the dataset. This is unique identifier of a Flocker dataset
  type = string
}*/

/*variable "persistent_volume_v1_gce_persistent_disk_fs_type" {
...
/*variable "persistent_volume_v1_gce_persistent_disk_partition" {
  description = "(Optional)" #The partition in the volume that you want to mount. If omitted, the default is to mount by volume name. Examples: For volume /dev/sda1, you specify the partition as "1". Similarly, the volume partition for /dev/sda is "0" (or you can leave the property empty). More info: http://kubernetes.io/docs/user-guide/volumes#gcepersistentdisk
  type = number
}*/

variable "persistent_volume_v1_gce_persistent_disk_pd_name" {
...
/*variable "persistent_volume_v1_gce_persistent_disk_read_only" {
...
variable "persistent_volume_v1_glusterfs_endpoints_name" {
...
variable "persistent_volume_v1_glusterfs_path" {
...
/*variable "persistent_volume_v1_glusterfs_read_only" {
...
/*variable "persistent_volume_v1_iscsi_fs_type" {
...
variable "persistent_volume_v1_nfs_server" {
...
/*variable "persistent_volume_v1_rbd_fs_type" {
...
/*variable "persistent_volume_v1_rbd_rados_user" {
...
variable "persistent_volume_v1_rbd_rbd_image" {
...
/*variable "persistent_volume_v1_rbd_rbd_pool" {
...
/*variable "persistent_volume_v1_rbd_read_only" {
...
/*variable "persistent_volume_v1_vsphere_volume_fs_type" {
  description = "(Optional)" #Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
  type = string
}*/

variable "persistent_volume_v1_vsphere_volume_volume_path" {
  description = "(Required)" #Path that identifies vSphere volume vmdk
  type = string
}

/*variable "persistent_volume_v1_timeouts_create" {
