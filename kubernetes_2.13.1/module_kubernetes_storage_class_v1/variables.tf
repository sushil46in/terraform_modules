...
/*variable "storage_class_v1_allow_volume_expansion" {
  description = "(Optional)" #Indicates whether the storage class allow volume expand
  type = bool
}*/

/*variable "storage_class_v1_mount_options" {
...
/*variable "storage_class_v1_metadata_generate_name" {
...
/*variable "storage_class_v1_metadata_labels" {
