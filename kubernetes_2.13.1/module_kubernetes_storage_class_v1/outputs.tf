...
output "storage_class_v1_metadata_generation" {
  value = kubernetes_storage_class_v1.resname.generation
}

output "storage_class_v1_metadata_name" {
  value = kubernetes_storage_class_v1.resname.name
}

output "storage_class_v1_metadata_resource_version" {
  value = kubernetes_storage_class_v1.resname.resource_version
}

output "storage_class_v1_metadata_uid" {
  value = kubernetes_storage_class_v1.resname.uid
}

output "storage_class_v1_metadata" {
  value = kubernetes_storage_class_v1.resname.metadata
}
