...
/*variable "csi_driver_metadata_annotations" {
...
/*variable "csi_driver_metadata_generate_name" {
...
/*variable "csi_driver_metadata_labels" {
...
/*variable "csi_driver_spec_volume_lifecycle_modes" {
