...
output "default_service_account_metadata_generation" {
  value = kubernetes_default_service_account.resname.generation
}

output "default_service_account_metadata_resource_version" {
  value = kubernetes_default_service_account.resname.resource_version
}

output "default_service_account_metadata_uid" {
  value = kubernetes_default_service_account.resname.uid
}

output "default_service_account_metadata" {
  value = kubernetes_default_service_account.resname.metadata
}
