...
/*variable "pod_disruption_budget_metadata_annotations" {
...
/*variable "pod_disruption_budget_metadata_generate_name" {
...
/*variable "pod_disruption_budget_metadata_labels" {
