...
/*variable "api_service_v1_metadata_annotations" {
...
/*variable "api_service_v1_metadata_generate_name" {
...
/*variable "api_service_v1_metadata_labels" {
...
/*variable "api_service_v1_spec_ca_bundle" {
...
variable "api_service_v1_spec_group" {
  description = "(Required)" #Group is the API group name this server hosts.
  type = string
}

variable "api_service_v1_spec_group_priority_minimum" {
...
/*variable "api_service_v1_spec_insecure_skip_tls_verify" {
...
variable "api_service_v1_spec_version" {
  description = "(Required)" #Version is the API version this server hosts. For example, `v1`.
  type = string
}

variable "api_service_v1_spec_version_priority" {
