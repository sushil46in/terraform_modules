...
output "service_account_metadata_generation" {
  value = kubernetes_service_account.resname.metadata_generation
}

output "service_account_metadata_name" {
  value = kubernetes_service_account.resname.metadata_name
}

output "service_account_metadata_resource_version" {
  value = kubernetes_service_account.resname.metadata_resource_version
}

output "service_account_metadata_uid" {
  value = kubernetes_service_account.resname.metadata_uid
}
