...
/*variable "linux_virtual_machine_bypass_platform_safety_checks_on_user_schedule_enabled" {
  description = "(Optional)" #The value for bypass_platform_safety_checks_on_user_schedule_enabled
  type = bool
}*/
...
/*variable "linux_virtual_machine_reboot_setting" {
  description = "(Optional)" #The value for reboot_setting
  type = string
}*/
...
/*variable "linux_virtual_machine_gallery_application_configuration_blob_uri" {
  description = "(Optional)" #The value for gallery_application_configuration_blob_uri
  type = string
}*/

/*variable "linux_virtual_machine_gallery_application_order" {
  description = "(Optional)" #The value for gallery_application_order
  type = number
}*/

/*variable "linux_virtual_machine_gallery_application_tag" {
  description = "(Optional)" #The value for gallery_application_tag
  type = string
}*/

variable "linux_virtual_machine_gallery_application_version_id" {
