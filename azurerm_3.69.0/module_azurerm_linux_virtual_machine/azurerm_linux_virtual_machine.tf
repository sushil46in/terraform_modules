...
resource "azurerm_linux_virtual_machine" "resname" {
  ...
  #bypass_platform_safety_checks_on_user_schedule_enabled = var.linux_virtual_machine_bypass_platform_safety_checks_on_user_schedule_enabled
  ...
  #reboot_setting = var.linux_virtual_machine_reboot_setting
