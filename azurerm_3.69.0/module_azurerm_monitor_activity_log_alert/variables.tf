...
/*variable "monitor_activity_log_alert_criteria_levels" {
  description = "(Optional)" #The value for criteria_levels
  type = list
}*/
...
/*variable "monitor_activity_log_alert_criteria_resource_groups" {
  description = "(Optional)" #The value for criteria_resource_groups
  type = list
}*/
...
/*variable "monitor_activity_log_alert_criteria_resource_ids" {
  description = "(Optional)" #The value for criteria_resource_ids
  type = list
}*/
...
/*variable "monitor_activity_log_alert_criteria_resource_providers" {
  description = "(Optional)" #The value for criteria_resource_providers
  type = list
}*/
...
/*variable "monitor_activity_log_alert_criteria_resource_types" {
  description = "(Optional)" #The value for criteria_resource_types
  type = list
}*/
...
/*variable "monitor_activity_log_alert_criteria_statuses" {
  description = "(Optional)" #The value for criteria_statuses
  type = list
}*/
...
/*variable "monitor_activity_log_alert_criteria_sub_statuses" {
  description = "(Optional)" #The value for criteria_sub_statuses
  type = list
}*/
