...
/*variable "monitor_autoscale_setting_predictive_look_ahead_time" {
  description = "(Optional)" #The value for predictive_look_ahead_time
  type = string
}*/

variable "monitor_autoscale_setting_predictive_scale_mode" {
  description = "(Required)" #The value for predictive_scale_mode
  type = string
}
