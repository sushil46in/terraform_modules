...
resource "azurerm_sentinel_alert_rule_scheduled" "resname" {
  ...
  alert_details_override {
    ...
    dynamic_property {
      name = var.sentinel_alert_rule_scheduled_dynamic_property_name
      value = var.sentinel_alert_rule_scheduled_dynamic_property_value
    }
  }
  ...
  sentinel_entity_mapping {
    column_name = var.sentinel_alert_rule_scheduled_sentinel_entity_mapping_column_name
  }
