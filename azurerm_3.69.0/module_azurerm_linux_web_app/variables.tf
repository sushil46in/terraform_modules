...
/*variable "linux_web_app_public_network_access_enabled" {
...
/*variable "linux_web_app_tags" {
  description = "(Optional)" #The value for tags
  type = map
}*/

/*variable "linux_web_app_virtual_network_subnet_id" {
  description = "(Optional)" #The value for virtual_network_subnet_id
  type = string
}*/

/*variable "linux_web_app_auth_settings_additional_login_parameters" {
...
/*variable "linux_web_app_auth_settings_token_store_enabled" {
...
/*variable "linux_web_app_active_directory_allowed_audiences" {
...
variable "linux_web_app_facebook_app_id" {
  description = "(Required)" #The App ID of the Facebook app used for login.
  type = string
}

/*variable "linux_web_app_facebook_app_secret" {
...
/*variable "linux_web_app_facebook_app_secret_setting_name" {
...
/*variable "linux_web_app_github_client_secret_setting_name" {
...
/*variable "linux_web_app_google_client_secret_setting_name" {
...
/*variable "linux_web_app_google_oauth_scopes" {
...
/*variable "linux_web_app_microsoft_client_secret_setting_name" {
...
/*variable "linux_web_app_microsoft_oauth_scopes" {
...
/*variable "linux_web_app_twitter_consumer_secret_setting_name" {
...
/*variable "linux_web_app_auth_settings_v2_excluded_paths" {
...
/*variable "linux_web_app_auth_settings_v2_forward_proxy_convention" {
...
/*variable "linux_web_app_active_directory_v2_allowed_applications" {
  description = "(Optional)" #The list of allowed Applications for the Default Authorisation Policy.
  type = list
}*/

/*variable "linux_web_app_active_directory_v2_allowed_audiences" {
  description = "(Optional)" #Specifies a list of Allowed audience values to consider when validating JWTs issued by Azure Active Directory.
  type = list
}*/

/*variable "linux_web_app_active_directory_v2_allowed_groups" {
  description = "(Optional)" #The list of allowed Group Names for the Default Authorisation Policy.
  type = list
}*/

/*variable "linux_web_app_active_directory_v2_allowed_identities" {
  description = "(Optional)" #The list of allowed Identities for the Default Authorisation Policy.
  type = list
}*/

variable "linux_web_app_active_directory_v2_client_id" {
  description = "(Required)" #The ID of the Client to use to authenticate with Azure Active Directory.
  type = string
}

/*variable "linux_web_app_active_directory_v2_client_secret_certificate_thumbprint" {
  description = "(Optional)" #The thumbprint of the certificate used for signing purposes.
  type = string
}*/

/*variable "linux_web_app_active_directory_v2_client_secret_setting_name" {
  description = "(Optional)" #The App Setting name that contains the client secret of the Client.
  type = string
}*/

/*variable "linux_web_app_active_directory_v2_jwt_allowed_client_applications" {
  description = "(Optional)" #A list of Allowed Client Applications in the JWT Claim.
  type = list
}*/

/*variable "linux_web_app_active_directory_v2_jwt_allowed_groups" {
  description = "(Optional)" #A list of Allowed Groups in the JWT Claim.
  type = list
}*/

/*variable "linux_web_app_active_directory_v2_login_parameters" {
  description = "(Optional)" #A map of key-value pairs to send to the Authorisation Endpoint when a user logs in.
  type = map
}*/

variable "linux_web_app_active_directory_v2_tenant_auth_endpoint" {
...
/*variable "linux_web_app_login_cookie_expiration_convention" {
...
variable "linux_web_app_microsoft_v2_client_id" {
  description = "(Required)" #The OAuth 2.0 client ID that was created for the app used for authentication.
  type = string
}

variable "linux_web_app_microsoft_v2_client_secret_setting_name" {
...
/*variable "linux_web_app_microsoft_v2_login_scopes" {
  description = "(Optional)" #The list of Login scopes that will be requested as part of Microsoft Account authentication.
  type = list
}*/

variable "linux_web_app_twitter_v2_consumer_key" {
  description = "(Required)" #The OAuth 1.0a consumer key of the Twitter application used for sign-in.
  type = string
}

variable "linux_web_app_twitter_v2_consumer_secret_setting_name" {
...
/*variable "linux_web_app_backup_enabled" {
  description = "(Optional)" #Should this backup job be enabled?
  type = bool
}*/

variable "linux_web_app_backup_name" {
  description = "(Required)" #The name which should be used for this Backup.
  type = string
}

variable "linux_web_app_backup_storage_account_url" {
  description = "(Required)" #The SAS URL to the container.
  type = string
}

variable "linux_web_app_schedule_frequency_interval" {
...
/*variable "linux_web_app_ip_restriction_priority" {
  description = "(Optional)" #The priority value of this `ip_restriction`.
  type = number
}*/

/*variable "linux_web_app_ip_restriction_service_tag" {
  description = "(Optional)" #The Service Tag used for this IP Restriction.
  type = string
}*/

/*variable "linux_web_app_ip_restriction_virtual_network_subnet_id" {
  description = "(Optional)" #The Virtual Network Subnet ID used for this IP Restriction.
  type = string
}*/

/*variable "linux_web_app_scm_ip_restriction_action" {
  description = "(Optional)" #The action to take. Possible values are `Allow` or `Deny`.
  type = string
}*/

/*variable "linux_web_app_scm_ip_restriction_headers" {
  description = "(Optional)" #The value for scm_ip_restriction_headers
  type = list
}*/

/*variable "linux_web_app_scm_ip_restriction_ip_address" {
  description = "(Optional)" #The CIDR notation of the IP or IP Range to match. For example: `10.0.0.0/24` or `192.168.10.1/32` or `fe80::/64` or `13.107.6.152/31,13.107.128.0/22`
  type = string
}*/

/*variable "linux_web_app_scm_ip_restriction_priority" {
  description = "(Optional)" #The priority value of this `ip_restriction`.
  type = number
}*/

/*variable "linux_web_app_scm_ip_restriction_service_tag" {
  description = "(Optional)" #The Service Tag used for this IP Restriction.
  type = string
}*/

/*variable "linux_web_app_scm_ip_restriction_virtual_network_subnet_id" {
  description = "(Optional)" #The Virtual Network Subnet ID used for this IP Restriction.
  type = string
}*/

/*variable "linux_web_app_sticky_settings_app_setting_names" {
  description = "(Optional)" #The value for sticky_settings_app_setting_names
  type = list
}*/

/*variable "linux_web_app_sticky_settings_connection_string_names" {
  description = "(Optional)" #The value for sticky_settings_connection_string_names
  type = list
}*/

variable "linux_web_app_storage_account_access_key" {
  description = "(Required)" #The value for storage_account_access_key
  type = string
}

variable "linux_web_app_storage_account_account_name" {
  description = "(Required)" #The value for storage_account_account_name
  type = string
}

/*variable "linux_web_app_storage_account_mount_path" {
  description = "(Optional)" #The value for storage_account_mount_path
  type = string
}*/

variable "linux_web_app_storage_account_name" {
  description = "(Required)" #The value for storage_account_name
  type = string
}

variable "linux_web_app_storage_account_share_name" {
  description = "(Required)" #The value for storage_account_share_name
  type = string
}

variable "linux_web_app_storage_account_type" {
  description = "(Required)" #The value for storage_account_type
  type = string
}

/*variable "linux_web_app_timeouts_create" {
  description = "(Optional)" #The value for timeouts_create
  type = string
}*/

/*variable "linux_web_app_timeouts_delete" {
  description = "(Optional)" #The value for timeouts_delete
  type = string
}*/

/*variable "linux_web_app_timeouts_read" {
  description = "(Optional)" #The value for timeouts_read
  type = string
}*/

/*variable "linux_web_app_timeouts_update" {
