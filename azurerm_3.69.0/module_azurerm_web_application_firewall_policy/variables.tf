...
/*variable "web_application_firewall_policy_match_conditions_match_values" {
  description = "(Optional)" #The value for match_conditions_match_values
  type = list
}*/
...
/*variable "web_application_firewall_policy_rule_action" {
  description = "(Optional)" #The value for rule_action
  type = string
}*/

/*variable "web_application_firewall_policy_rule_enabled" {
  description = "(Optional)" #The value for rule_enabled
  type = bool
}*/

variable "web_application_firewall_policy_rule_id" {
...
/*variable "web_application_firewall_policy_log_scrubbing_enabled" {
  description = "(Optional)" #The value for log_scrubbing_enabled
  type = bool
}*/
...
variable "web_application_firewall_policy_rule_match_variable" {
  description = "(Required)" #The value for rule_match_variable
  type = string
}

/*variable "web_application_firewall_policy_rule_selector" {
  description = "(Optional)" #When matchVariable is a collection, operator used to specify which elements in the collection this rule applies to.
  type = string
}*/

/*variable "web_application_firewall_policy_rule_selector_match_operator" {
  description = "(Optional)" #The value for rule_selector_match_operator
  type = string
}*/
