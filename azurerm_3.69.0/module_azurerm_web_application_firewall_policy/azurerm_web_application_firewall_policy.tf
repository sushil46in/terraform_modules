...
resource "azurerm_web_application_firewall_policy" "resname" {
  ...
  policy_settings {
    ...
    log_scrubbing {
      #enabled = var.web_application_firewall_policy_log_scrubbing_enabled
      rule {
        #enabled = var.web_application_firewall_policy_rule_enabled
        match_variable = var.web_application_firewall_policy_rule_match_variable
        #selector = var.web_application_firewall_policy_rule_selector
        #selector_match_operator = var.web_application_firewall_policy_rule_selector_match_operator
      }
    }
  }
