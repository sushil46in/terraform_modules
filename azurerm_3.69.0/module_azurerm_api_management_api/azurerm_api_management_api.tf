...
resource "azurerm_api_management_api" "resname" {
  ...
  #terms_of_service_url = var.api_management_api_terms_of_service_url
  #version_description = var.api_management_api_version_description

  contact {
    #email = var.api_management_api_contact_email
    #name = var.api_management_api_contact_name
    #url = var.api_management_api_contact_url
  }
  ...
  license {
    #name = var.api_management_api_license_name
    #url = var.api_management_api_license_url
  }
