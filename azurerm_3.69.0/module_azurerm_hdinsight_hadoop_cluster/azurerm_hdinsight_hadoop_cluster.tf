...
resource "azurerm_hdinsight_hadoop_cluster" "resname" {
  ...
  compute_isolation {
    #compute_isolation_enabled = var.hdinsight_hadoop_cluster_compute_isolation_compute_isolation_enabled
    #host_sku = var.hdinsight_hadoop_cluster_compute_isolation_host_sku
  }
  ...
  roles {
    ...
    head_node {
      ...
      script_actions {
        name = var.hdinsight_hadoop_cluster_script_actions_name
        #parameters = var.hdinsight_hadoop_cluster_script_actions_parameters
        uri = var.hdinsight_hadoop_cluster_script_actions_uri
      }
    }
    worker_node {
