...
resource "azurerm_windows_virtual_machine_scale_set" "resname" {
  ...
  extension {
    ...
    protected_settings_from_key_vault {
      secret_url = var.windows_virtual_machine_scale_set_protected_settings_from_key_vault_secret_url
      source_vault_id = var.windows_virtual_machine_scale_set_protected_settings_from_key_vault_source_vault_id
    }
  }

  gallery_application {
    #configuration_blob_uri = var.windows_virtual_machine_scale_set_gallery_application_configuration_blob_uri
    #order = var.windows_virtual_machine_scale_set_gallery_application_order
    #tag = var.windows_virtual_machine_scale_set_gallery_application_tag
    version_id = var.windows_virtual_machine_scale_set_gallery_application_version_id
  }
