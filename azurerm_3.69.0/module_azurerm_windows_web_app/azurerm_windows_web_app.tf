...
resource "azurerm_windows_web_app" "resname" {
  ...
  #client_certificate_exclusion_paths = var.windows_web_app_client_certificate_exclusion_paths
  ...
  #public_network_access_enabled = var.windows_web_app_public_network_access_enabled
  ...
  auth_settings_v2 {
    #auth_enabled = var.windows_web_app_auth_settings_v2_auth_enabled
    #config_file_path = var.windows_web_app_auth_settings_v2_config_file_path
    #default_provider = var.windows_web_app_auth_settings_v2_default_provider
    #excluded_paths = var.windows_web_app_auth_settings_v2_excluded_paths
    #forward_proxy_convention = var.windows_web_app_auth_settings_v2_forward_proxy_convention
    #forward_proxy_custom_host_header_name = var.windows_web_app_auth_settings_v2_forward_proxy_custom_host_header_name
    #forward_proxy_custom_scheme_header_name = var.windows_web_app_auth_settings_v2_forward_proxy_custom_scheme_header_name
    #http_route_api_prefix = var.windows_web_app_auth_settings_v2_http_route_api_prefix
    #require_authentication = var.windows_web_app_auth_settings_v2_require_authentication
    #require_https = var.windows_web_app_auth_settings_v2_require_https
    #runtime_version = var.windows_web_app_auth_settings_v2_runtime_version
    #unauthenticated_action = var.windows_web_app_auth_settings_v2_unauthenticated_action
    active_directory_v2 {
      #allowed_applications = var.windows_web_app_active_directory_v2_allowed_applications
      #allowed_audiences = var.windows_web_app_active_directory_v2_allowed_audiences
      #allowed_groups = var.windows_web_app_active_directory_v2_allowed_groups
      #allowed_identities = var.windows_web_app_active_directory_v2_allowed_identities
      client_id = var.windows_web_app_active_directory_v2_client_id
      #client_secret_certificate_thumbprint = var.windows_web_app_active_directory_v2_client_secret_certificate_thumbprint
      #client_secret_setting_name = var.windows_web_app_active_directory_v2_client_secret_setting_name
      #jwt_allowed_client_applications = var.windows_web_app_active_directory_v2_jwt_allowed_client_applications
      #jwt_allowed_groups = var.windows_web_app_active_directory_v2_jwt_allowed_groups
      #login_parameters = var.windows_web_app_active_directory_v2_login_parameters
      tenant_auth_endpoint = var.windows_web_app_active_directory_v2_tenant_auth_endpoint
      #www_authentication_disabled = var.windows_web_app_active_directory_v2_www_authentication_disabled
    }
    apple_v2 {
      client_id = var.windows_web_app_apple_v2_client_id
      client_secret_setting_name = var.windows_web_app_apple_v2_client_secret_setting_name
    }
    azure_static_web_app_v2 {
      client_id = var.windows_web_app_azure_static_web_app_v2_client_id
    }
    custom_oidc_v2 {
      client_id = var.windows_web_app_custom_oidc_v2_client_id
      name = var.windows_web_app_custom_oidc_v2_name
      #name_claim_type = var.windows_web_app_custom_oidc_v2_name_claim_type
      openid_configuration_endpoint = var.windows_web_app_custom_oidc_v2_openid_configuration_endpoint
      #scopes = var.windows_web_app_custom_oidc_v2_scopes
    }
    facebook_v2 {
      app_id = var.windows_web_app_facebook_v2_app_id
      app_secret_setting_name = var.windows_web_app_facebook_v2_app_secret_setting_name
      #login_scopes = var.windows_web_app_facebook_v2_login_scopes
    }
    github_v2 {
      client_id = var.windows_web_app_github_v2_client_id
      client_secret_setting_name = var.windows_web_app_github_v2_client_secret_setting_name
      #login_scopes = var.windows_web_app_github_v2_login_scopes
    }
    google_v2 {
      #allowed_audiences = var.windows_web_app_google_v2_allowed_audiences
      client_id = var.windows_web_app_google_v2_client_id
      client_secret_setting_name = var.windows_web_app_google_v2_client_secret_setting_name
      #login_scopes = var.windows_web_app_google_v2_login_scopes
    }
    login {
      #allowed_external_redirect_urls = var.windows_web_app_login_allowed_external_redirect_urls
      #cookie_expiration_convention = var.windows_web_app_login_cookie_expiration_convention
      #cookie_expiration_time = var.windows_web_app_login_cookie_expiration_time
      #logout_endpoint = var.windows_web_app_login_logout_endpoint
      #nonce_expiration_time = var.windows_web_app_login_nonce_expiration_time
      #preserve_url_fragments_for_logins = var.windows_web_app_login_preserve_url_fragments_for_logins
      #token_refresh_extension_time = var.windows_web_app_login_token_refresh_extension_time
      #token_store_enabled = var.windows_web_app_login_token_store_enabled
      #token_store_path = var.windows_web_app_login_token_store_path
      #token_store_sas_setting_name = var.windows_web_app_login_token_store_sas_setting_name
      #validate_nonce = var.windows_web_app_login_validate_nonce
    }
    microsoft_v2 {
      #allowed_audiences = var.windows_web_app_microsoft_v2_allowed_audiences
      client_id = var.windows_web_app_microsoft_v2_client_id
      client_secret_setting_name = var.windows_web_app_microsoft_v2_client_secret_setting_name
      #login_scopes = var.windows_web_app_microsoft_v2_login_scopes
    }
    twitter_v2 {
      consumer_key = var.windows_web_app_twitter_v2_consumer_key
      consumer_secret_setting_name = var.windows_web_app_twitter_v2_consumer_secret_setting_name
    }
  }
  ...
  site_config {
    ...
    application_stack {
      ...
      #docker_image_name = var.windows_web_app_application_stack_docker_image_name
      #dotnet_core_version = var.windows_web_app_application_stack_dotnet_core_version
      ...
      #python = var.windows_web_app_application_stack_python
      #tomcat_version = var.windows_web_app_application_stack_tomcat_version
    }
    auto_heal_setting {
      action {
    ...
    ip_restriction {
      #action = var.windows_web_app_ip_restriction_action
      #headers = var.windows_web_app_ip_restriction_headers
      #ip_address = var.windows_web_app_ip_restriction_ip_address
      #priority = var.windows_web_app_ip_restriction_priority
      #service_tag = var.windows_web_app_ip_restriction_service_tag
      #virtual_network_subnet_id = var.windows_web_app_ip_restriction_virtual_network_subnet_id
    }
    scm_ip_restriction {
      #action = var.windows_web_app_scm_ip_restriction_action
      #headers = var.windows_web_app_scm_ip_restriction_headers
      #ip_address = var.windows_web_app_scm_ip_restriction_ip_address
      #priority = var.windows_web_app_scm_ip_restriction_priority
      #service_tag = var.windows_web_app_scm_ip_restriction_service_tag
      #virtual_network_subnet_id = var.windows_web_app_scm_ip_restriction_virtual_network_subnet_id
    }
    virtual_application {
