...
/*variable "batch_account_account_access_default_action" {
  description = "(Optional)" #The value for account_access_default_action
  type = string
}*/

/*variable "batch_account_ip_rule_action" {
  description = "(Optional)" #The value for ip_rule_action
  type = string
}*/

variable "batch_account_ip_rule_ip_range" {
  description = "(Required)" #The value for ip_rule_ip_range
  type = string
}

/*variable "batch_account_node_management_access_default_action" {
  description = "(Optional)" #The value for node_management_access_default_action
  type = string
}*/
