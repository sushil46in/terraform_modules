...
resource "azurerm_batch_pool" "resname" {
  ...
  #target_node_communication_mode = var.batch_pool_target_node_communication_mode
  ...
  fixed_scale {
    #node_deallocation_method = var.batch_pool_fixed_scale_node_deallocation_method
  ...
  network_configuration {
    #dynamic_vnet_assignment_scope = var.batch_pool_network_configuration_dynamic_vnet_assignment_scope
  ...
  start_task {
    ...
    container {
      image_name = var.batch_pool_container_image_name
      #run_options = var.batch_pool_container_run_options
      #working_directory = var.batch_pool_container_working_directory
      registry {
        #password = var.batch_pool_registry_password
        registry_server = var.batch_pool_registry_registry_server
        #user_assigned_identity_id = var.batch_pool_registry_user_assigned_identity_id
        #user_name = var.batch_pool_registry_user_name
      }
    }
    resource_file {
