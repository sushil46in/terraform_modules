...
/*variable "media_transform_custom_preset_experimental_options" {
  description = "(Optional)" #The value for custom_preset_experimental_options
  type = map
}*/
...
/*variable "media_transform_jpg_image_key_frame_interval" {
  description = "(Optional)" #The value for jpg_image_key_frame_interval
  type = string
}*/

/*variable "media_transform_jpg_image_label" {
  description = "(Optional)" #The value for jpg_image_label
  type = string
}*/

/*variable "media_transform_jpg_image_range" {
  description = "(Optional)" #The value for jpg_image_range
  type = string
}*/

/*variable "media_transform_jpg_image_sprite_column" {
  description = "(Optional)" #The value for jpg_image_sprite_column
  type = number
}*/

variable "media_transform_jpg_image_start" {
  description = "(Required)" #The value for jpg_image_start
  type = string
}

/*variable "media_transform_jpg_image_step" {
  description = "(Optional)" #The value for jpg_image_step
  type = string
}*/

/*variable "media_transform_jpg_image_stretch_mode" {
  description = "(Optional)" #The value for jpg_image_stretch_mode
  type = string
}*/

/*variable "media_transform_jpg_image_sync_mode" {
  description = "(Optional)" #The value for jpg_image_sync_mode
  type = string
}*/

/*variable "media_transform_layer_height" {
  description = "(Optional)" #The value for layer_height
  type = string
}*/
...
/*variable "media_transform_layer_quality" {
  description = "(Optional)" #The value for layer_quality
  type = number
}*/

/*variable "media_transform_layer_width" {
  description = "(Optional)" #The value for layer_width
  type = string
}*/

/*variable "media_transform_png_image_key_frame_interval" {
  description = "(Optional)" #The value for png_image_key_frame_interval
  type = string
}*/

/*variable "media_transform_png_image_label" {
  description = "(Optional)" #The value for png_image_label
  type = string
}*/

/*variable "media_transform_png_image_range" {
  description = "(Optional)" #The value for png_image_range
  type = string
}*/

variable "media_transform_png_image_start" {
  description = "(Required)" #The value for png_image_start
  type = string
}

/*variable "media_transform_png_image_step" {
  description = "(Optional)" #The value for png_image_step
  type = string
}*/

/*variable "media_transform_png_image_stretch_mode" {
  description = "(Optional)" #The value for png_image_stretch_mode
  type = string
}*/

/*variable "media_transform_png_image_sync_mode" {
  description = "(Optional)" #The value for png_image_sync_mode
  type = string
}*/
...
variable "media_transform_jpg_filename_pattern" {
  description = "(Required)" #The value for jpg_filename_pattern
  type = string
}
...
variable "media_transform_png_filename_pattern" {
  description = "(Required)" #The value for png_filename_pattern
  type = string
}
