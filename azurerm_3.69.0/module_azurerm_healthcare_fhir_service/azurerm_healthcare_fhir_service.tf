...
resource "azurerm_healthcare_fhir_service" "resname" {
  ...
  identity {
    #identity_ids = var.healthcare_fhir_service_identity_identity_ids
    type = var.healthcare_fhir_service_identity_type
  }

  oci_artifact {
    #digest = var.healthcare_fhir_service_oci_artifact_digest
    #image_name = var.healthcare_fhir_service_oci_artifact_image_name
    login_server = var.healthcare_fhir_service_oci_artifact_login_server
  }
