...
/*variable "container_group_dns_name_label_reuse_policy" {
  description = "(Optional)" #The value for dns_name_label_reuse_policy
  type = string
}*/
...
/*variable "container_group_subnet_ids" {
...
/*variable "container_group_zones" {
...
/*variable "container_group_image_registry_credential_user_assigned_identity_id" {
...
/*variable "container_group_image_registry_credential_username" {
  description = "(Optional)" #The value for image_registry_credential_username
  type = string
}*/
