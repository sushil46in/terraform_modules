...
resource "azurerm_container_group" "resname" {
  ...
  #dns_name_label_reuse_policy = var.container_group_dns_name_label_reuse_policy
  ...
  #subnet_ids = var.container_group_subnet_ids
  #tags = var.container_group_tags
  #zones = var.container_group_zones
  ...
  image_registry_credential {
    ...
    #user_assigned_identity_id = var.container_group_image_registry_credential_user_assigned_identity_id
