...
resource "azurerm_windows_virtual_machine" "resname" {
  ...
  #bypass_platform_safety_checks_on_user_schedule_enabled = var.windows_virtual_machine_bypass_platform_safety_checks_on_user_schedule_enabled
  ...
  #reboot_setting = var.windows_virtual_machine_reboot_setting
