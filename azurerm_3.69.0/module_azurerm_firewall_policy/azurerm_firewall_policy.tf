...
resource "azurerm_firewall_policy" "resname" {
  ...
  explicit_proxy {
    #enable_pac_file = var.firewall_policy_explicit_proxy_enable_pac_file
    #enabled = var.firewall_policy_explicit_proxy_enabled
    #http_port = var.firewall_policy_explicit_proxy_http_port
    #https_port = var.firewall_policy_explicit_proxy_https_port
    #pac_file = var.firewall_policy_explicit_proxy_pac_file
    #pac_file_port = var.firewall_policy_explicit_proxy_pac_file_port
  }
