...
variable "virtual_machine_scale_set_extension_protected_settings_from_key_vault_secret_url" {
  description = "(Required)" #The value for protected_settings_from_key_vault_secret_url
  type = string
}

variable "virtual_machine_scale_set_extension_protected_settings_from_key_vault_source_vault_id" {
