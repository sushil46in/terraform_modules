...
resource "azurerm_dedicated_hardware_security_module" "resname" {
  ...
  management_network_profile {
    network_interface_private_ip_addresses = var.dedicated_hardware_security_module_management_network_profile_network_interface_private_ip_addresses
    subnet_id = var.dedicated_hardware_security_module_management_network_profile_subnet_id
  }
