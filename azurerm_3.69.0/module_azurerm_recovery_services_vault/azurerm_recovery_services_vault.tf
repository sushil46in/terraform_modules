...
resource "azurerm_recovery_services_vault" "resname" {
  ...
  monitoring {
    #alerts_for_all_job_failures_enabled = var.recovery_services_vault_monitoring_alerts_for_all_job_failures_enabled
    #alerts_for_critical_operation_failures_enabled = var.recovery_services_vault_monitoring_alerts_for_critical_operation_failures_enabled
  }
