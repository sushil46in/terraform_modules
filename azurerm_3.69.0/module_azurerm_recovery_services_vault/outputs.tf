...
output "recovery_services_vault_classic_vmware_replication_enabled" {
  value = azurerm_recovery_services_vault.resname.classic_vmware_replication_enabled
}
...
output "recovery_services_vault_immutability" {
  value = azurerm_recovery_services_vault.resname.immutability
}
