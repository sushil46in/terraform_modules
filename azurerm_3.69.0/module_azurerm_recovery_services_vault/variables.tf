...
/*variable "recovery_services_vault_encryption_user_assigned_identity_id" {
  description = "(Optional)" #The value for encryption_user_assigned_identity_id
  type = string
}*/

/*variable "recovery_services_vault_identity_identity_ids" {
...
/*variable "recovery_services_vault_monitoring_alerts_for_all_job_failures_enabled" {
  description = "(Optional)" #The value for monitoring_alerts_for_all_job_failures_enabled
  type = bool
}*/

/*variable "recovery_services_vault_monitoring_alerts_for_critical_operation_failures_enabled" {
  description = "(Optional)" #The value for monitoring_alerts_for_critical_operation_failures_enabled
  type = bool
}*/
