...
/*variable "vpn_gateway_connection_routing_inbound_route_map_id" {
  description = "(Optional)" #The value for routing_inbound_route_map_id
  type = string
}*/

/*variable "vpn_gateway_connection_routing_outbound_route_map_id" {
  description = "(Optional)" #The value for routing_outbound_route_map_id
  type = string
}*/
