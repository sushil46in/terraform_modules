...
/*variable "backup_policy_vm_retention_monthly_days" {
  description = "(Optional)" #The value for retention_monthly_days
  type = set
}*/

/*variable "backup_policy_vm_retention_monthly_include_last_days" {
...
/*variable "backup_policy_vm_retention_yearly_days" {
  description = "(Optional)" #The value for retention_yearly_days
  type = set
}*/

/*variable "backup_policy_vm_retention_yearly_include_last_days" {
