...
resource "azurerm_spring_cloud_app" "resname" {
  ...
  ingress_settings {
    #backend_protocol = var.spring_cloud_app_ingress_settings_backend_protocol
    #read_timeout_in_seconds = var.spring_cloud_app_ingress_settings_read_timeout_in_seconds
    #send_timeout_in_seconds = var.spring_cloud_app_ingress_settings_send_timeout_in_seconds
    #session_affinity = var.spring_cloud_app_ingress_settings_session_affinity
    #session_cookie_max_age = var.spring_cloud_app_ingress_settings_session_cookie_max_age
  }
