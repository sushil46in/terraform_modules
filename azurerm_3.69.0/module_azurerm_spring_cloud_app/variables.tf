...
/*variable "spring_cloud_app_ingress_settings_backend_protocol" {
  description = "(Optional)" #The value for ingress_settings_backend_protocol
  type = string
}*/

/*variable "spring_cloud_app_ingress_settings_read_timeout_in_seconds" {
  description = "(Optional)" #The value for ingress_settings_read_timeout_in_seconds
  type = number
}*/

/*variable "spring_cloud_app_ingress_settings_send_timeout_in_seconds" {
  description = "(Optional)" #The value for ingress_settings_send_timeout_in_seconds
  type = number
}*/

/*variable "spring_cloud_app_ingress_settings_session_affinity" {
  description = "(Optional)" #The value for ingress_settings_session_affinity
  type = string
}*/

/*variable "spring_cloud_app_ingress_settings_session_cookie_max_age" {
  description = "(Optional)" #The value for ingress_settings_session_cookie_max_age
  type = number
}*/
