...
resource "azurerm_databricks_workspace" "resname" {
  ...
  #managed_disk_cmk_key_vault_key_id = var.databricks_workspace_managed_disk_cmk_key_vault_key_id
  #managed_disk_cmk_rotation_to_latest_version_enabled = var.databricks_workspace_managed_disk_cmk_rotation_to_latest_version_enabled
