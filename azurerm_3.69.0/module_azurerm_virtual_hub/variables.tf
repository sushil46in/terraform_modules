...
/*variable "virtual_hub_hub_routing_preference" {
  description = "(Optional)" #The value for hub_routing_preference
  type = string
}*/
...
/*variable "virtual_hub_virtual_router_auto_scale_min_capacity" {
  description = "(Optional)" #The value for virtual_router_auto_scale_min_capacity
  type = number
}*/
